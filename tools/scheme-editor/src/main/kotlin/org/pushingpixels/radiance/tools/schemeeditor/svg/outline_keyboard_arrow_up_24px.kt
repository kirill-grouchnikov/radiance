...
generalPath!!.moveTo(7.41f, 15.41f)
generalPath!!.lineTo(12.0f, 10.83f)
generalPath!!.lineTo(16.59f, 15.41f)
generalPath!!.lineTo(18.0f, 14.0f)
generalPath!!.lineTo(12.0f, 8.0f)
generalPath!!.lineTo(6.0f, 14.0f)
generalPath!!.lineTo(7.41f, 15.41f)
...
g.fill(shape)
    ...
    companion object {
        ...
        fun uiResourceOf(width: Int, height: Int): RadianceIconUIResource {
            return RadianceIconUIResource(outline_keyboard_arrow_up_24px(width, height))
        }
         ...
         */
        fun factory(): Factory {
            return Factory { outline_keyboard_arrow_up_24px(getOrigWidth().toInt(), getOrigHeight().toInt()) }
        }
    }
