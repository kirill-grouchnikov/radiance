...
// _0_1_1
shape = GeneralPath()
(shape as GeneralPath).moveTo(7.41, 8.59)
(shape as GeneralPath).lineTo(12.0, 13.17)
(shape as GeneralPath).lineTo(16.59, 8.59)
(shape as GeneralPath).lineTo(18.0, 10.0)
(shape as GeneralPath).lineTo(12.0, 16.0)
(shape as GeneralPath).lineTo(6.0, 10.0)
(shape as GeneralPath).lineTo(7.41, 8.59)
