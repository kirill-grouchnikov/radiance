...
shape = GeneralPath()
shape.moveTo(7.41, 8.59)
shape.lineTo(12.0, 13.17)
shape.lineTo(16.59, 8.59)
shape.lineTo(18.0, 10.0)
shape.lineTo(12.0, 16.0)
shape.lineTo(6.0, 10.0)
shape.lineTo(7.41, 8.59)
shape.closePath()
g.paint = paint
g.fill(shape)
...
g.transform = defaultTransform_
    ...
    companion object {
         ...
         */
        fun factory(): Factory {
            return Factory { outline_keyboard_arrow_down_24px(16, 16) }
        }
    }
