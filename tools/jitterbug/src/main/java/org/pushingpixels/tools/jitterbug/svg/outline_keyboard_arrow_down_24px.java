 ...
 */
public class outline_keyboard_arrow_down_24px implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).moveTo(7.41, 8.59);
((GeneralPath)shape).lineTo(12.0, 13.17);
((GeneralPath)shape).lineTo(16.59, 8.59);
((GeneralPath)shape).lineTo(18.0, 10.0);
((GeneralPath)shape).lineTo(12.0, 16.0);
((GeneralPath)shape).lineTo(6.0, 10.0);
((GeneralPath)shape).lineTo(7.41, 8.59);
...
g.setTransform(defaultTransform_);
	 ...
	 */
	public outline_keyboard_arrow_down_24px() {
    ...
    public static NeonIcon of(int width, int height) {
       outline_keyboard_arrow_down_24px base = new outline_keyboard_arrow_down_24px();
       base.width = width;
       base.height = height;
