 ...
 */
public class outline_delete_24px implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).moveTo(16.0, 9.0);
...
((GeneralPath)shape).moveTo(14.5, 3.0);
...
((GeneralPath)shape).moveTo(18.0, 7.0);
...
g.setTransform(defaultTransform_);
    ...
    public static NeonIcon of(int width, int height) {
       outline_delete_24px base = new outline_delete_24px();
       base.width = width;
       base.height = height;
