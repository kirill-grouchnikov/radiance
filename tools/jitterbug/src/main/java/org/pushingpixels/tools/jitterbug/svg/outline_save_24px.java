 ...
 */
public class outline_save_24px implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(3.89, 3.0, 3.0, 3.9, 3.0, 5.0);
...
((GeneralPath)shape).moveTo(19.0, 19.0);
((GeneralPath)shape).lineTo(5.0, 19.0);
((GeneralPath)shape).lineTo(5.0, 5.0);
((GeneralPath)shape).lineTo(16.17, 5.0);
((GeneralPath)shape).lineTo(19.0, 7.83);
...
((GeneralPath)shape).curveTo(10.34, 12.0, 9.0, 13.34, 9.0, 15.0);
((GeneralPath)shape).curveTo(9.0, 16.66, 10.34, 18.0, 12.0, 18.0);
((GeneralPath)shape).curveTo(13.66, 18.0, 15.0, 16.66, 15.0, 15.0);
((GeneralPath)shape).curveTo(15.0, 13.34, 13.66, 12.0, 12.0, 12.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
// _0_1_0_2
paint = new Color(0, 0, 0, 255);
shape = new Rectangle2D.Double(6.0, 6.0, 9.0, 4.0);
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static NeonIcon of(int width, int height) {
       outline_save_24px base = new outline_save_24px();
       base.width = width;
       base.height = height;
