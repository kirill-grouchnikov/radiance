 ...
 */
class outline_delete_24px(private var width: Int, private var height: Int) : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): ResizableIcon {
            return outline_delete_24px(width, height)
        }
        ...
        fun uiResourceOf(width: Int, height: Int): ResizableIconUIResource {
            return ResizableIconUIResource(outline_delete_24px(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { outline_delete_24px(16, 16) }
        }
    }
