 ...
 */
class outline_keyboard_arrow_up_24px(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
shape = GeneralPath()
shape.moveTo(7.41, 15.41)
shape.lineTo(12.0, 10.83)
shape.lineTo(16.59, 15.41)
shape.lineTo(18.0, 14.0)
shape.lineTo(12.0, 8.0)
shape.lineTo(6.0, 14.0)
shape.lineTo(7.41, 15.41)
shape.closePath()
g.paint = paint
g.fill(shape)
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): NeonIcon {
            return NeonIcon(outline_keyboard_arrow_up_24px(width, height))
        }
        ...
        fun uiResourceOf(width: Int, height: Int): NeonIconUIResource {
            return NeonIconUIResource(outline_keyboard_arrow_up_24px(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(outline_keyboard_arrow_up_24px(16, 16)) }
        }
    }
