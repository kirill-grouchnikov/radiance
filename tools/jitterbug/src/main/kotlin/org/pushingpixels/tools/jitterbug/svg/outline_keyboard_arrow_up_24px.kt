 ...
 */
class outline_keyboard_arrow_up_24px(private var width: Int, private var height: Int) : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): ResizableIcon {
            return outline_keyboard_arrow_up_24px(width, height)
        }
        ...
        fun uiResourceOf(width: Int, height: Int): ResizableIconUIResource {
            return ResizableIconUIResource(outline_keyboard_arrow_up_24px(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { outline_keyboard_arrow_up_24px(16, 16) }
        }
    }
