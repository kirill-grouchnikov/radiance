 ...
 */
class outline_add_24px(private var width: Int, private var height: Int) : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): ResizableIcon {
            return outline_add_24px(width, height)
        }
        ...
        fun uiResourceOf(width: Int, height: Int): ResizableIconUIResource {
            return ResizableIconUIResource(outline_add_24px(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { outline_add_24px(16, 16) }
        }
    }
