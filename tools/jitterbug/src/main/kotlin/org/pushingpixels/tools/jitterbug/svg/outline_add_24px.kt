 ...
 */
class outline_add_24px(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
shape = GeneralPath()
shape.moveTo(19.0, 13.0)
shape.lineTo(13.0, 13.0)
shape.lineTo(13.0, 19.0)
shape.lineTo(11.0, 19.0)
shape.lineTo(11.0, 13.0)
shape.lineTo(5.0, 13.0)
shape.lineTo(5.0, 11.0)
shape.lineTo(11.0, 11.0)
shape.lineTo(11.0, 5.0)
shape.lineTo(13.0, 5.0)
shape.lineTo(13.0, 11.0)
shape.lineTo(19.0, 11.0)
shape.lineTo(19.0, 13.0)
shape.closePath()
g.paint = paint
g.fill(shape)
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): NeonIcon {
            return NeonIcon(outline_add_24px(width, height))
        }
        ...
        fun uiResourceOf(width: Int, height: Int): NeonIconUIResource {
            return NeonIconUIResource(outline_add_24px(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(outline_add_24px(16, 16)) }
        }
    }
