...
public class ColorWheelPanel extends RadianceColorChooserPanel implements
	...
	public ColorWheelPanel() {
        ...
        RadianceThemingCortex.ComponentOrParentScope.setBackgroundAppearanceStrategy(resetBtn,
				RadianceThemingSlices.BackgroundAppearanceStrategy.NEVER);
        RadianceThemingCortex.ComponentOrParentChainScope.setFocusKind(resetBtn,
                RadianceThemingSlices.FocusKind.NONE);
