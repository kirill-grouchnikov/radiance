...
the [Ephemeral](https://github.com/kirill-grouchnikov/ephemeral) design system. It is built with Java 17, and runs on Java 9 and later.
...
<img src="https://raw.githubusercontent.com/kirill-grouchnikov/radiance/sunshine/docs/images/component/walkthrough/ribbon/taskbar/taskbar-overflow-popup.png" width="1289" border=0/>
...
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-common/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-common/8.5.0)
`radiance-common` for [Common](docs/common/common.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-animation/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-animation/8.5.0) `radiance-animation` for [Animation](docs/animation/animation.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-theming/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-theming/8.5.0) `radiance-theming` for [Theming](docs/theming/overview.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-component/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-component/8.5.0) `radiance-component` for [Component](docs/component/overview.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-theming-extras/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-theming-extras/8.5.0) `radiance-theming-extras` for [Theming extras](docs/theming/extras.md)

### Kotlin extension artifacts
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-swing-ktx/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-swing-ktx/8.5.0) `radiance-swing-ktx` for [Swing Kotlin extensions](docs/kotlin-ext/swing/swing.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-animation-ktx/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-animation-ktx/8.5.0) `radiance-animation-ktx` for [Animation Kotlin extensions](docs/kotlin-ext/animation/animation-ktx.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-theming-ktx/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-theming-ktx/8.5.0) `radiance-theming-ktx` for [Theming Kotlin extensions](docs/kotlin-ext/theming/theming-ktx.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-component-ktx/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-component-ktx/8.5.0) `radiance-component-ktx` for [Component Kotlin extensions](docs/kotlin-ext/component/component-ktx.md)

### Tools artifacts

* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-svg-transcoder/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-svg-transcoder/8.5.0) `radiance-svg-transcoder` for [SVG transcoder](docs/tools/svg-transcoder/svg-transcoder.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-svg-transcoder-gradle-plugin/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-svg-transcoder-gradle-plugin/8.5.0) `radiance-svg-transcoder-gradle-plugin` for [SVG transcoder Gradle plugin](docs/tools/svg-transcoder/svg-transcoder-gradle-plugin.md)
* [![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-theming-debugger/badge.svg?style=plastic&version=8.5.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-theming-debugger/8.5.0) `radiance-theming-debugger` for [Theming debugger](docs/tools/theming-debugger/theming-debugger.md)
