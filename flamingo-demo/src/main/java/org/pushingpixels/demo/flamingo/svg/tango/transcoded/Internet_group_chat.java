 ...
 */
public class Internet_group_chat implements
...
((GeneralPath)shape).moveTo(31.64, 17.39);
((GeneralPath)shape).lineTo(31.64, 32.579998);
((GeneralPath)shape).curveTo(31.64, 33.639, 30.817, 34.477997, 29.778, 34.477997);
((GeneralPath)shape).lineTo(16.068, 34.477997);
((GeneralPath)shape).curveTo(15.237, 35.590996, 13.564001, 37.406, 9.641001, 38.887997);
((GeneralPath)shape).curveTo(11.366001, 36.822, 11.468, 35.428997, 11.273001, 34.477997);
((GeneralPath)shape).lineTo(8.464001, 34.477997);
((GeneralPath)shape).curveTo(7.4250007, 34.477997, 6.5710006, 33.638996, 6.5710006, 32.579998);
((GeneralPath)shape).lineTo(6.5710006, 17.39);
((GeneralPath)shape).curveTo(6.5710006, 16.331, 7.4250007, 15.459999, 8.464001, 15.459999);
((GeneralPath)shape).lineTo(29.784, 15.459999);
((GeneralPath)shape).curveTo(30.823, 15.459999, 31.646, 16.331, 31.646, 17.39);
...
stroke = new BasicStroke(0.99f,0,0,4.0f,null,0.0f);
shape = new GeneralPath();
((GeneralPath)shape).moveTo(30.62, 17.88);
((GeneralPath)shape).lineTo(30.62, 32.079998);
((GeneralPath)shape).curveTo(30.62, 33.039997, 30.378, 33.447998, 29.436, 33.447998);
((GeneralPath)shape).lineTo(15.536001, 33.447998);
((GeneralPath)shape).curveTo(14.783001, 34.457996, 13.468001, 36.044, 12.025002, 36.698997);
((GeneralPath)shape).curveTo(12.428001, 35.531998, 12.273002, 34.562996, 12.198002, 33.447998);
((GeneralPath)shape).lineTo(8.791002, 33.447998);
((GeneralPath)shape).curveTo(7.8490024, 33.447998, 7.5790024, 33.039997, 7.5790024, 32.079998);
((GeneralPath)shape).lineTo(7.5790024, 17.999998);
((GeneralPath)shape).curveTo(7.5790024, 17.039999, 7.8490024, 16.451998, 8.791002, 16.451998);
((GeneralPath)shape).lineTo(29.391003, 16.451998);
((GeneralPath)shape).curveTo(30.334003, 16.451998, 30.626003, 16.912998, 30.626003, 17.873999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static Internet_group_chat of(int width, int height) {
       Internet_group_chat result = new Internet_group_chat();
       result.width = width;
