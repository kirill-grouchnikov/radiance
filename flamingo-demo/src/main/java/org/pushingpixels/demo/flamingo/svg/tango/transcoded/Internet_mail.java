 ...
 */
public class Internet_mail implements
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(6.3334, 16.972);
((GeneralPath)shape).lineTo(6.3334, 41.482002);
((GeneralPath)shape).lineTo(43.3064, 41.482002);
((GeneralPath)shape).lineTo(43.2444, 17.090002);
((GeneralPath)shape).curveTo(43.2414, 15.712002, 31.3964, 2.4120016, 29.2114, 2.4120016);
((GeneralPath)shape).lineTo(20.659399, 2.4121015);
((GeneralPath)shape).curveTo(18.3624, 2.4121015, 6.333399, 15.674102, 6.333399, 16.972101);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(6.9231, 16.787);
((GeneralPath)shape).curveTo(6.525, 16.357, 18.8101, 3.0930004, 20.6671, 3.0930004);
((GeneralPath)shape).lineTo(29.043102, 3.0935004);
((GeneralPath)shape).curveTo(30.790102, 3.0935004, 43.0801, 16.2215, 42.4701, 16.9795);
((GeneralPath)shape).lineTo(31.6091, 30.474499);
((GeneralPath)shape).lineTo(19.295101, 30.156498);
((GeneralPath)shape).lineTo(6.9231014, 16.786499);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(19.078, 30.018);
((GeneralPath)shape).lineTo(11.744999, 21.272);
((GeneralPath)shape).lineTo(36.563, 14.3359995);
((GeneralPath)shape).lineTo(39.592, 20.552);
((GeneralPath)shape).lineTo(32.176, 29.992);
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(36.068, 14.232);
((GeneralPath)shape).lineTo(39.354, 20.825);
((GeneralPath)shape).lineTo(31.874, 29.932001);
g.setPaint(paint);
g.fill(shape);
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(20.488, 29.064);
((GeneralPath)shape).lineTo(7.092001, 40.036);
((GeneralPath)shape).lineTo(21.001001, 30.432);
((GeneralPath)shape).lineTo(30.019001, 30.432);
((GeneralPath)shape).lineTo(42.439003, 39.914);
((GeneralPath)shape).lineTo(30.575003, 29.064001);
((GeneralPath)shape).lineTo(20.488003, 29.064001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
paint = new LinearGradientPaint(new Point2D.Double(8.915599822998047, 37.196998596191406), new Point2D.Double(9.885499954223633, 52.090999603271484), new float[] {0.0f,1.0f}, new Color[] {new Color(154, 162, 154, 255),new Color(181, 190, 181, 255)}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(2.4547998905181885f, 0.0f, 0.0f, 0.7620000243186951f, 2.879499912261963f, 0.34299999475479126f));
shape = new GeneralPath();
((GeneralPath)shape).moveTo(6.9635, 16.885);
((GeneralPath)shape).lineTo(18.4795, 31.201);
((GeneralPath)shape).lineTo(19.5475, 30.347);
((GeneralPath)shape).lineTo(6.963501, 16.885);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(7.3077, 17.131);
((GeneralPath)shape).lineTo(7.3389, 40.342003);
((GeneralPath)shape).lineTo(42.2839, 40.342003);
((GeneralPath)shape).lineTo(42.2209, 17.258003);
((GeneralPath)shape).curveTo(42.218903, 16.508003, 31.004902, 3.4590034, 28.836903, 3.4590034);
((GeneralPath)shape).lineTo(20.941902, 3.4592035);
((GeneralPath)shape).curveTo(18.688902, 3.4592035, 7.306902, 16.351204, 7.3079023, 17.131203);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.setStroke(stroke);
g.draw(shape);
...
((GeneralPath)shape).lineTo(20.957, 30.453);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
((GeneralPath)shape).lineTo(19.334, 30.09);
((GeneralPath)shape).lineTo(20.531, 29.064);
((GeneralPath)shape).lineTo(30.618, 29.106998);
((GeneralPath)shape).lineTo(31.43, 29.833998);
((GeneralPath)shape).lineTo(35.405, 25.089998);
((GeneralPath)shape).curveTo(34.251, 23.678999, 13.307999, 23.635998, 13.307999, 23.635998);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
     ...
     */
    public static Internet_mail of(int width, int height) {
       Internet_mail result = new Internet_mail();
       result.width = width;
