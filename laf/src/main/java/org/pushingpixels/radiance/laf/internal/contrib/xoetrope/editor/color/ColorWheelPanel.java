package org.pushingpixels.radiance.laf.internal.contrib.xoetrope.editor.color;
...
import org.pushingpixels.radiance.laf.internal.contrib.randelshofer.quaqua.colorchooser.RadianceColorChooserPanel;
...
import org.pushingpixels.radiance.laf.internal.utils.border.RadianceTextComponentBorder;
 ...
 */
public class ColorWheelPanel extends RadianceColorChooserPanel implements
	...
	public ColorWheelPanel() {
        ...
        resetBtn.setIcon(new TransitionAwareIcon(resetBtn,
                scheme -> RadianceLafCortex.GlobalScope.getIconPack().getRefreshIcon(10, scheme),
                "Color wheel reset"));

		resetBtn.setToolTipText(getLabel("Xoetrope.reset",
				"Reset the color wheel saturation and brightness"));
        RadianceLafCortex.ComponentOrParentScope.setBackgroundAppearanceStrategy(resetBtn,
				RadianceLafSlices.BackgroundAppearanceStrategy.NEVER);
        RadianceLafCortex.ComponentOrParentChainScope.setFocusKind(resetBtn,
                RadianceLafSlices.FocusKind.NONE);
        ...
        baseColorEdit.setBorder(new CompoundBorder(
                new RadianceTextComponentBorder(baseColorEditInsets),
	...
	public RadianceIcon getHiDpiAwareIcon(int size, RadianceColorScheme colorScheme) {
        return RadianceLafCortex.GlobalScope.getIconPack().getColorChooserImagePalettesIcon(size,
                colorScheme);
	}
