 ...
 */
public class ic_zoom_out_black_24px implements Icon, IsResizable, IsHiDpiAware, UIResource {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(7.0, 9.0);
...
g.setTransform(defaultTransform_);
    ...
    public static SubstanceIcon of(int width, int height) {
       ic_zoom_out_black_24px base = new ic_zoom_out_black_24px();
       base.width = width;
       base.height = height;
