 ...
 */
public class ic_zoom_in_black_24px implements Icon, IsResizable, IsHiDpiAware, UIResource {
...
((GeneralPath)shape).lineTo(10.0, 7.0);
((GeneralPath)shape).lineTo(10.0, 9.0);
((GeneralPath)shape).lineTo(12.0, 9.0);
((GeneralPath)shape).lineTo(12.0, 10.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static SubstanceIcon of(int width, int height) {
       ic_zoom_in_black_24px base = new ic_zoom_in_black_24px();
       base.width = width;
       base.height = height;
