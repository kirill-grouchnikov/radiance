...
<img src="https://raw.githubusercontent.com/kirill-grouchnikov/radiance/sunshine/docs/images/laf/states/control-states-extended-mix.png"
width="275" height="279"/>
...
<img src="https://raw.githubusercontent.com/kirill-grouchnikov/radiance/sunshine/docs/images/laf/states/icon-no-theming.png"
...
The APIs are in the `RadianceLafCortex` class, one in the `GlobalScope` to apply on all icons in your app, and one in the `ComponentScope` to configure icon filtering (theming) for the specific control:

* `RadianceLafCortex.GlobalScope.setIconFilterStrategies` for global icon filtering
* `RadianceLafCortex.ComponentScope.setIconFilterStrategies` for per-component icon filtering
...
<img src="https://raw.githubusercontent.com/kirill-grouchnikov/radiance/sunshine/docs/images/laf/states/icon-theming-enabled.png"
width="757" height="550"/>
...
<img src="https://raw.githubusercontent.com/kirill-grouchnikov/radiance/sunshine/docs/images/laf/states/control-states-extended-themed.png"
width="275" height="279"/>
