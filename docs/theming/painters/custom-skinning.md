...
* Providing consistent painting for additional [Radiance Components](../../components/overview.md)
...
Components that require consistent painting of borders or contours can use the border painter with the matching contour. Here is an example of border tracing in the `JRibbon` component from [Radiance Components](../../components/overview.md) component library:
