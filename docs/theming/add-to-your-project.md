...
[![Sonatype Central](https://maven-badges.sml.io/sonatype-central/org.pushing-pixels/radiance-common/badge.svg?style=plastic&version=9.0.0)](https://central.sonatype.com/artifact/org.pushing-pixels/radiance-theming) `radiance-theming` for build instructions of the latest stable release.
...
* Also copy the `build/libs-core/ephemeral-chroma-java-X.Y.ZZ.jar` to the place that has your local dependencies.
