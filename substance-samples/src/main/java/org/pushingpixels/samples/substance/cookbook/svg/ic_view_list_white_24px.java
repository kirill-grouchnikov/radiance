 ...
 */
public class ic_view_list_white_24px implements
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ic_view_list_white_24px of(int width, int height) {
       ic_view_list_white_24px result = new ic_view_list_white_24px();
       result.width = width;
