 ...
 */
public class ic_star_border_white_24px implements
...
g.setTransform(defaultTransform_);
     ...
     */
    public static ic_star_border_white_24px of(int width, int height) {
       ic_star_border_white_24px result = new ic_star_border_white_24px();
       result.width = width;
