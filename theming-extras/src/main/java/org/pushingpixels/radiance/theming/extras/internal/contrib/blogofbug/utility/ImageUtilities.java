...
package org.pushingpixels.radiance.theming.extras.internal.contrib.blogofbug.utility;
...
public class ImageUtilities {
    ...
    public static BufferedImage createCompatibleImage(int width, int height) {
        ...
        //Create a buffered image which is the right (translucent) format for the current
        // graphics device, this
        //should ensure the fastest possible performance. Adding on some extra height to make
        // room for the reflection
    ...
    public static BufferedImage loadCompatibleImage(String imageURL) {
        ...
        //should ensure the fastest possible performance. Adding on some extra height to make
        // room for the reflection
        BufferedImage originalImage = configuration.createCompatibleImage(image.getWidth(null),
                image.getHeight(null), Transparency.TRANSLUCENT);

        //Blit the loaded image onto the optimized surface by creating a graphics context for the
        // new image
