 ...
 */
class Applications_multimedia(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
g.transform(AffineTransform(0.974405387304794f, -0.22479800086164992f, 0.22479800086164992f, 0.974405387304794f, 0.0f, 0.0f))
// _0_0_3_0
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): NeonIcon {
            return NeonIcon(Applications_multimedia(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(Applications_multimedia(16, 16)) }
        }
    }
