 ...
 */
class Format_justify_fill(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
shape = Rectangle2D.Double(-39.0, 10.0, 30.0, 2.0)
g.paint = paint
g.fill(shape)
...
// _0_0_3
paint = Color(153, 153, 153, 255)
shape = Rectangle2D.Double(-39.0, 16.0, 30.0, 2.0)
g.paint = paint
g.fill(shape)
...
// _0_0_4
paint = Color(153, 153, 153, 255)
shape = Rectangle2D.Double(-39.0, 22.0, 30.0, 2.0)
g.paint = paint
g.fill(shape)
...
// _0_0_5
paint = Color(153, 153, 153, 255)
shape = Rectangle2D.Double(-39.0, 28.0, 30.0, 2.0)
g.paint = paint
g.fill(shape)
...
// _0_0_6
paint = Color(153, 153, 153, 255)
shape = Rectangle2D.Double(-39.0, 34.0, 30.0, 2.0)
g.paint = paint
g.fill(shape)
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): NeonIcon {
            return NeonIcon(Format_justify_fill(width, height))
        }
        ...
        fun uiResourceOf(width: Int, height: Int): NeonIconUIResource {
            return NeonIconUIResource(Format_justify_fill(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(Format_justify_fill(16, 16)) }
        }
    }
