 ...
 */
class Format_justify_center(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): NeonIcon {
            return NeonIcon(Format_justify_center(width, height))
        }
        ...
        fun uiResourceOf(width: Int, height: Int): NeonIconUIResource {
            return NeonIconUIResource(Format_justify_center(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(Format_justify_center(16, 16)) }
        }
    }
