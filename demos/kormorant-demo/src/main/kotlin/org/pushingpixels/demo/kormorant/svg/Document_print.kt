 ...
 */
class Document_print(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
shape = GeneralPath()
shape.moveTo(21.02159, 20.989431)
shape.lineTo(27.989391, 20.989431)
shape.lineTo(27.989391, 16.064983)
shape.lineTo(31.0, 16.064983)
shape.lineTo(24.553757, 8.0)
shape.lineTo(17.435621, 15.986875)
shape.lineTo(21.023684, 15.986875)
shape.lineTo(21.02159, 20.989431)
shape.closePath()
g.paint = paint
g.fill(shape)
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(Document_print(16, 16)) }
        }
    }
