 ...
 */
class Document_new(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): NeonIcon {
            return NeonIcon(Document_new(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(Document_new(16, 16)) }
        }
    }
