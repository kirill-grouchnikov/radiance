 ...
 */
class Printer(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): NeonIcon {
            return NeonIcon(Printer(width, height))
        }
        ...
        fun uiResourceOf(width: Int, height: Int): NeonIconUIResource {
            return NeonIconUIResource(Printer(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(Printer(16, 16)) }
        }
    }
