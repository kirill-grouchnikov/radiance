 ...
 */
class Format_indent_less(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(Format_indent_less(16, 16)) }
        }
    }
