 ...
 */
class Format_indent_less(private var width: Int, private var height: Int) : ResizableIcon {
...
shape = GeneralPath()
shape.moveTo(35.851425, 26.743532)
shape.lineTo(35.851425, 38.610554)
shape.lineTo(22.739004, 38.610554)
shape.lineTo(22.739004, 44.458668)
shape.lineTo(9.0, 32.65186)
shape.lineTo(22.741562, 21.0)
shape.lineTo(22.741562, 26.747164)
shape.lineTo(35.851425, 26.743532)
shape.closePath()
g.paint = paint
g.fill(shape)
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun uiResourceOf(width: Int, height: Int): ResizableIconUIResource {
            return ResizableIconUIResource(Format_indent_less(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { Format_indent_less(16, 16) }
        }
    }
