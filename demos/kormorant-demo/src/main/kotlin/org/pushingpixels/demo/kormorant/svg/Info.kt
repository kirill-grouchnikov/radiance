 ...
 */
class Info(private var width: Int, private var height: Int) : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun uiResourceOf(width: Int, height: Int): ResizableIconUIResource {
            return ResizableIconUIResource(Info(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { Info(16, 16) }
        }
    }
