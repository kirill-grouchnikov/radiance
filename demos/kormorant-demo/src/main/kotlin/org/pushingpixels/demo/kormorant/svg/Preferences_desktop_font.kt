 ...
 */
class Preferences_desktop_font(private var width: Int, private var height: Int) : ResizableIcon, IsHiDpiAware {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): NeonIcon {
            return NeonIcon(Preferences_desktop_font(width, height))
        }
        ...
        fun uiResourceOf(width: Int, height: Int): NeonIconUIResource {
            return NeonIconUIResource(Preferences_desktop_font(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { NeonIcon(Preferences_desktop_font(16, 16)) }
        }
    }
