 ...
 */
class Preferences_desktop_screensaver(private var width: Int, private var height: Int) : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { Preferences_desktop_screensaver(16, 16) }
        }
    }
