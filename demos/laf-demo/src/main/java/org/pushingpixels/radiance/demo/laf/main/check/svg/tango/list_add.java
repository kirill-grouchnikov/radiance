 ...
 */
public class list_add implements RadianceIcon {
...
generalPath.closePath();
shape = generalPath;
paint = (colorFilter != null) ? colorFilter.filter(new Color(117, 161, 208, 255)) : new Color(117, 161, 208, 255);
g.setPaint(paint);
g.fill(shape);
