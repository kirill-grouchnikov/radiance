 ...
 */
public class ext_mkv implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(34.999996, 85.1);
((GeneralPath)shape).lineTo(34.999996, 91.1);
((GeneralPath)shape).lineTo(30.999996, 91.1);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(56.200005, 91.100006);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mkv());
    }
}
