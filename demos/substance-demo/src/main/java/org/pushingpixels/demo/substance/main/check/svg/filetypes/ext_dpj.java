 ...
 */
public class ext_dpj implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(10.7, 71.1);
((GeneralPath)shape).lineTo(18.1, 71.1);
((GeneralPath)shape).curveTo(19.800001, 71.1, 21.0, 71.2, 21.9, 71.5);
((GeneralPath)shape).curveTo(23.1, 71.8, 24.1, 72.5, 24.9, 73.3);
((GeneralPath)shape).curveTo(25.699999, 74.200005, 26.4, 75.200005, 26.8, 76.5);
((GeneralPath)shape).curveTo(27.199999, 77.799995, 27.5, 79.3, 27.5, 81.2);
((GeneralPath)shape).curveTo(27.5, 82.799995, 27.3, 84.2, 26.9, 85.399994);
((GeneralPath)shape).curveTo(26.4, 86.799995, 25.699999, 87.99999, 24.699999, 88.899994);
((GeneralPath)shape).curveTo(23.999998, 89.59999, 22.999998, 90.09999, 21.8, 90.49999);
((GeneralPath)shape).curveTo(20.9, 90.799995, 19.699999, 90.899994, 18.199999, 90.899994);
((GeneralPath)shape).lineTo(10.599998, 90.899994);
((GeneralPath)shape).lineTo(10.599998, 71.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(14.799999, 74.5);
((GeneralPath)shape).lineTo(14.799999, 87.6);
((GeneralPath)shape).lineTo(17.8, 87.6);
((GeneralPath)shape).curveTo(18.9, 87.6, 19.8, 87.5, 20.3, 87.4);
((GeneralPath)shape).curveTo(21.0, 87.200005, 21.5, 87.0, 21.9, 86.6);
((GeneralPath)shape).curveTo(22.3, 86.2, 22.699999, 85.6, 23.0, 84.7);
((GeneralPath)shape).curveTo(23.3, 83.799995, 23.4, 82.6, 23.4, 81.1);
((GeneralPath)shape).curveTo(23.4, 79.6, 23.3, 78.4, 23.0, 77.6);
((GeneralPath)shape).curveTo(22.7, 76.799995, 22.3, 76.1, 21.8, 75.7);
((GeneralPath)shape).curveTo(21.3, 75.2, 20.699999, 74.899994, 19.9, 74.799995);
((GeneralPath)shape).curveTo(19.3, 74.7, 18.199999, 74.6, 16.6, 74.6);
((GeneralPath)shape).lineTo(14.8, 74.6);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(31.0, 91.0);
((GeneralPath)shape).lineTo(31.0, 71.1);
((GeneralPath)shape).lineTo(37.5, 71.1);
((GeneralPath)shape).curveTo(40.0, 71.1, 41.6, 71.2, 42.3, 71.4);
((GeneralPath)shape).curveTo(43.5, 71.700005, 44.399998, 72.3, 45.2, 73.3);
((GeneralPath)shape).curveTo(46.0, 74.3, 46.4, 75.600006, 46.4, 77.200005);
((GeneralPath)shape).curveTo(46.4, 78.4, 46.2, 79.4, 45.7, 80.3);
((GeneralPath)shape).curveTo(45.3, 81.100006, 44.7, 81.8, 44.0, 82.3);
((GeneralPath)shape).curveTo(43.3, 82.8, 42.6, 83.100006, 41.9, 83.200005);
((GeneralPath)shape).curveTo(40.9, 83.4, 39.5, 83.50001, 37.7, 83.50001);
((GeneralPath)shape).lineTo(35.100002, 83.50001);
((GeneralPath)shape).lineTo(35.100002, 91.0);
((GeneralPath)shape).lineTo(31.0, 91.0);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(35.1, 74.5);
((GeneralPath)shape).lineTo(35.1, 80.1);
((GeneralPath)shape).lineTo(37.3, 80.1);
((GeneralPath)shape).curveTo(38.899998, 80.1, 40.0, 80.0, 40.5, 79.799995);
((GeneralPath)shape).curveTo(41.0, 79.6, 41.5, 79.299995, 41.8, 78.799995);
((GeneralPath)shape).curveTo(42.1, 78.399994, 42.3, 77.799995, 42.3, 77.299995);
((GeneralPath)shape).curveTo(42.3, 76.6, 42.1, 75.99999, 41.7, 75.49999);
((GeneralPath)shape).curveTo(41.3, 74.99999, 40.7, 74.69999, 40.100002, 74.59999);
((GeneralPath)shape).curveTo(39.600002, 74.49999, 38.600002, 74.49999, 37.2, 74.49999);
((GeneralPath)shape).lineTo(35.100002, 74.49999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(57.0, 71.1);
((GeneralPath)shape).lineTo(61.0, 71.1);
((GeneralPath)shape).lineTo(61.0, 83.7);
((GeneralPath)shape).curveTo(61.0, 85.299995, 60.9, 86.6, 60.6, 87.5);
((GeneralPath)shape).curveTo(60.199997, 88.7, 59.5, 89.6, 58.5, 90.3);
((GeneralPath)shape).curveTo(57.5, 91.0, 56.1, 91.3, 54.4, 91.3);
((GeneralPath)shape).curveTo(52.4, 91.3, 50.9, 90.8, 49.800003, 89.700005);
((GeneralPath)shape).curveTo(48.700005, 88.600006, 48.200005, 87.00001, 48.200005, 84.9);
((GeneralPath)shape).lineTo(52.000004, 84.5);
((GeneralPath)shape).curveTo(52.000004, 85.6, 52.200005, 86.4, 52.500004, 86.9);
((GeneralPath)shape).curveTo(52.900005, 87.6, 53.600002, 88.0, 54.500004, 88.0);
((GeneralPath)shape).curveTo(55.400005, 88.0, 56.000004, 87.7, 56.400005, 87.2);
((GeneralPath)shape).curveTo(56.800007, 86.7, 57.000004, 85.6, 57.000004, 84.0);
((GeneralPath)shape).lineTo(57.000004, 71.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_dpj());
    }
}
