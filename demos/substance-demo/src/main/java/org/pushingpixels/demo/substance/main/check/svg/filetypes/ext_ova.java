 ...
 */
public class ext_ova implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(65.3, 92.100006);
((GeneralPath)shape).lineTo(60.9, 92.100006);
((GeneralPath)shape).lineTo(59.100002, 87.600006);
((GeneralPath)shape).lineTo(51.100002, 87.600006);
((GeneralPath)shape).lineTo(49.4, 92.100006);
((GeneralPath)shape).lineTo(45.100002, 92.100006);
((GeneralPath)shape).lineTo(53.0, 72.2);
((GeneralPath)shape).lineTo(57.3, 72.2);
((GeneralPath)shape).lineTo(65.3, 92.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(57.9, 84.200005);
((GeneralPath)shape).lineTo(55.100002, 76.8);
((GeneralPath)shape).lineTo(52.4, 84.200005);
((GeneralPath)shape).lineTo(57.9, 84.200005);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_ova());
    }
}
