 ...
 */
public class ext_ogg implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(5.6000004, 87.0, 4.8, 84.5, 4.8, 81.299995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(8.9, 81.200005);
((GeneralPath)shape).curveTo(8.9, 83.50001, 9.4, 85.200005, 10.5, 86.3);
((GeneralPath)shape).curveTo(11.6, 87.5, 12.9, 88.0, 14.5, 88.0);
((GeneralPath)shape).curveTo(16.1, 88.0, 17.4, 87.4, 18.5, 86.3);
((GeneralPath)shape).curveTo(19.6, 85.200005, 20.1, 83.4, 20.1, 81.100006);
((GeneralPath)shape).curveTo(20.1, 78.8, 19.6, 77.100006, 18.6, 76.00001);
((GeneralPath)shape).curveTo(17.6, 74.90001, 16.2, 74.30001, 14.6, 74.30001);
((GeneralPath)shape).curveTo(13.0, 74.30001, 11.6, 74.90001, 10.6, 76.00001);
((GeneralPath)shape).curveTo(9.6, 77.100006, 8.900001, 78.90001, 8.900001, 81.200005);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(36.799995, 84.1);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(50.799995, 74.1, 52.1, 72.899994, 53.8, 72.0);
...
((GeneralPath)shape).lineTo(58.599995, 84.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_ogg());
    }
}
