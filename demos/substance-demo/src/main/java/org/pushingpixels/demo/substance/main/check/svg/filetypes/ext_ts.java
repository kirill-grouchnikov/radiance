 ...
 */
public class ext_ts implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(24.7, 91.5);
((GeneralPath)shape).lineTo(24.7, 74.9);
((GeneralPath)shape).lineTo(18.800001, 74.9);
((GeneralPath)shape).lineTo(18.800001, 71.5);
((GeneralPath)shape).lineTo(34.7, 71.5);
((GeneralPath)shape).lineTo(34.7, 74.9);
((GeneralPath)shape).lineTo(28.800001, 74.9);
((GeneralPath)shape).lineTo(28.800001, 91.600006);
((GeneralPath)shape).lineTo(24.7, 91.600006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(36.2, 85.0);
((GeneralPath)shape).lineTo(40.100002, 84.6);
((GeneralPath)shape).curveTo(40.300003, 85.9, 40.800003, 86.9, 41.500004, 87.5);
((GeneralPath)shape).curveTo(42.200005, 88.1, 43.200005, 88.4, 44.400005, 88.4);
((GeneralPath)shape).curveTo(45.700005, 88.4, 46.700005, 88.1, 47.300007, 87.6);
((GeneralPath)shape).curveTo(48.000008, 87.0, 48.300007, 86.4, 48.300007, 85.7);
((GeneralPath)shape).curveTo(48.300007, 85.2, 48.20001, 84.799995, 47.900005, 84.5);
((GeneralPath)shape).curveTo(47.600006, 84.2, 47.100006, 83.9, 46.400005, 83.6);
((GeneralPath)shape).curveTo(45.900005, 83.4, 44.800007, 83.1, 43.200005, 82.7);
((GeneralPath)shape).curveTo(41.000004, 82.2, 39.500004, 81.5, 38.600006, 80.7);
((GeneralPath)shape).curveTo(37.400005, 79.6, 36.800007, 78.299995, 36.800007, 76.7);
((GeneralPath)shape).curveTo(36.800007, 75.7, 37.100006, 74.7, 37.70001, 73.799995);
((GeneralPath)shape).curveTo(38.300007, 72.899994, 39.10001, 72.2, 40.20001, 71.799995);
((GeneralPath)shape).curveTo(41.300007, 71.299995, 42.60001, 71.1, 44.10001, 71.1);
((GeneralPath)shape).curveTo(46.60001, 71.1, 48.50001, 71.7, 49.80001, 72.799995);
((GeneralPath)shape).curveTo(51.10001, 73.899994, 51.700012, 75.399994, 51.80001, 77.2);
((GeneralPath)shape).lineTo(47.80001, 77.399994);
((GeneralPath)shape).curveTo(47.60001, 76.399994, 47.30001, 75.59999, 46.700012, 75.2);
((GeneralPath)shape).curveTo(46.100014, 74.7, 45.30001, 74.5, 44.100014, 74.5);
((GeneralPath)shape).curveTo(42.900013, 74.5, 42.000015, 74.7, 41.300014, 75.2);
((GeneralPath)shape).curveTo(40.900013, 75.5, 40.700016, 75.899994, 40.700016, 76.399994);
((GeneralPath)shape).curveTo(40.700016, 76.899994, 40.900017, 77.299995, 41.300014, 77.59999);
((GeneralPath)shape).curveTo(41.800014, 77.99999, 43.100014, 78.49999, 45.000015, 78.899994);
((GeneralPath)shape).curveTo(46.900017, 79.299995, 48.400017, 79.799995, 49.400017, 80.299995);
((GeneralPath)shape).curveTo(50.400017, 80.799995, 51.100018, 81.49999, 51.600018, 82.299995);
((GeneralPath)shape).curveTo(52.100018, 83.1, 52.400017, 84.2, 52.400017, 85.49999);
((GeneralPath)shape).curveTo(52.400017, 86.59999, 52.100018, 87.69999, 51.400017, 88.69999);
((GeneralPath)shape).curveTo(50.80002, 89.69999, 49.900017, 90.39999, 48.700016, 90.89999);
((GeneralPath)shape).curveTo(47.500015, 91.39999, 46.100018, 91.59998, 44.300014, 91.59998);
((GeneralPath)shape).curveTo(41.800014, 91.59998, 39.800014, 90.999985, 38.500015, 89.79998);
((GeneralPath)shape).curveTo(37.300014, 88.99998, 36.500015, 87.29998, 36.200016, 84.99998);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_ts());
    }
}
