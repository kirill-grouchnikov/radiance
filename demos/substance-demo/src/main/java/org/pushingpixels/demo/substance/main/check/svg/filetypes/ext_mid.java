 ...
 */
public class ext_mid implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(12.600001, 91.2);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(43.800003, 71.299995);
((GeneralPath)shape).lineTo(51.200005, 71.299995);
((GeneralPath)shape).curveTo(52.900005, 71.299995, 54.200005, 71.399994, 55.000004, 71.7);
((GeneralPath)shape).curveTo(56.200005, 72.0, 57.200005, 72.7, 58.000004, 73.5);
((GeneralPath)shape).curveTo(58.800003, 74.4, 59.500004, 75.5, 59.900005, 76.7);
((GeneralPath)shape).curveTo(60.300007, 78.0, 60.600006, 79.5, 60.600006, 81.399994);
((GeneralPath)shape).curveTo(60.600006, 82.99999, 60.400005, 84.399994, 60.000008, 85.59999);
((GeneralPath)shape).curveTo(59.500008, 86.99999, 58.800007, 88.19999, 57.800007, 89.09999);
((GeneralPath)shape).curveTo(57.100006, 89.79999, 56.100006, 90.29999, 54.900005, 90.69999);
((GeneralPath)shape).curveTo(54.000004, 90.99999, 52.800007, 91.09999, 51.300007, 91.09999);
((GeneralPath)shape).lineTo(43.70001, 91.09999);
((GeneralPath)shape).lineTo(43.70001, 71.3);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(47.899998, 74.799995);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mid());
    }
}
