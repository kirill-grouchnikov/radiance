 ...
 */
public class ext_tar implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(14.800001, 92.1);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(43.4, 92.100006);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(59.700005, 82.399994, 58.4, 82.99999, 56.600002, 83.2);
...
((GeneralPath)shape).lineTo(45.500004, 92.09999);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_tar());
    }
}
