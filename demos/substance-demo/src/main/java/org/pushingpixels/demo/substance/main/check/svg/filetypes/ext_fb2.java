 ...
 */
public class ext_fb2 implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(33.699993, 78.50001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(33.7, 84.799995);
...
((GeneralPath)shape).lineTo(33.700005, 84.90001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(56.0, 88.799995);
((GeneralPath)shape).lineTo(56.0, 91.6);
((GeneralPath)shape).lineTo(45.4, 91.6);
((GeneralPath)shape).curveTo(45.5, 90.6, 45.9, 89.6, 46.4, 88.6);
((GeneralPath)shape).curveTo(47.0, 87.7, 48.100002, 86.4, 49.800003, 84.9);
((GeneralPath)shape).curveTo(51.200005, 83.6, 52.000004, 82.8, 52.300003, 82.3);
((GeneralPath)shape).curveTo(52.700005, 81.700005, 52.9, 81.100006, 52.9, 80.5);
((GeneralPath)shape).curveTo(52.9, 79.8, 52.7, 79.3, 52.4, 79.0);
((GeneralPath)shape).curveTo(52.0, 78.6, 51.5, 78.5, 50.9, 78.5);
((GeneralPath)shape).curveTo(50.300003, 78.5, 49.800003, 78.7, 49.4, 79.1);
((GeneralPath)shape).curveTo(49.0, 79.5, 48.800003, 80.1, 48.800003, 81.0);
((GeneralPath)shape).lineTo(45.800003, 80.7);
((GeneralPath)shape).curveTo(46.000004, 79.1, 46.500004, 77.899994, 47.500004, 77.2);
((GeneralPath)shape).curveTo(48.500004, 76.5, 49.600002, 76.1, 51.100002, 76.1);
((GeneralPath)shape).curveTo(52.7, 76.1, 53.9, 76.5, 54.800003, 77.299995);
((GeneralPath)shape).curveTo(55.500004, 77.99999, 56.000004, 78.99999, 56.000004, 80.299995);
((GeneralPath)shape).curveTo(56.000004, 80.99999, 55.900005, 81.7, 55.600002, 82.299995);
((GeneralPath)shape).curveTo(55.300003, 82.899994, 54.9, 83.6, 54.4, 84.299995);
((GeneralPath)shape).curveTo(54.0, 84.799995, 53.4, 85.399994, 52.4, 86.299995);
((GeneralPath)shape).curveTo(51.4, 87.2, 50.800003, 87.7, 50.600002, 87.99999);
((GeneralPath)shape).curveTo(50.300003, 88.299995, 50.100002, 88.59999, 50.000004, 88.799995);
((GeneralPath)shape).lineTo(56.000004, 88.799995);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_fb2());
    }
}
