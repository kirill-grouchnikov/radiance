 ...
 */
public class ext_webm implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(8.200001, 91.100006);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(25.200005, 91.100006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(38.7, 76.799995);
((GeneralPath)shape).lineTo(44.5, 76.799995);
((GeneralPath)shape).curveTo(45.6, 76.799995, 46.5, 76.799995, 47.1, 76.899994);
((GeneralPath)shape).curveTo(47.699997, 76.99999, 48.199997, 77.2, 48.6, 77.49999);
((GeneralPath)shape).curveTo(49.0, 77.799995, 49.399998, 78.19999, 49.699997, 78.69999);
((GeneralPath)shape).curveTo(49.999996, 79.19999, 50.1, 79.79999, 50.1, 80.39999);
((GeneralPath)shape).curveTo(50.1, 81.09998, 49.899998, 81.69999, 49.6, 82.19999);
((GeneralPath)shape).curveTo(49.3, 82.69999, 48.699997, 83.19999, 48.1, 83.49999);
((GeneralPath)shape).curveTo(49.0, 83.799995, 49.699997, 84.19999, 50.1, 84.799995);
((GeneralPath)shape).curveTo(50.5, 85.4, 50.8, 86.1, 50.8, 86.99999);
((GeneralPath)shape).curveTo(50.8, 87.69999, 50.6, 88.299995, 50.3, 88.899994);
((GeneralPath)shape).curveTo(50.0, 89.49999, 49.6, 89.99999, 49.0, 90.399994);
((GeneralPath)shape).curveTo(48.4, 90.799995, 47.8, 90.99999, 47.0, 91.09999);
((GeneralPath)shape).curveTo(46.5, 91.19999, 45.3, 91.19999, 43.5, 91.19999);
((GeneralPath)shape).lineTo(38.6, 91.19999);
((GeneralPath)shape).lineTo(38.6, 76.8);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(41.600002, 79.1);
((GeneralPath)shape).lineTo(41.600002, 82.4);
((GeneralPath)shape).lineTo(45.600002, 82.4);
((GeneralPath)shape).curveTo(46.100002, 82.3, 46.500004, 82.200005, 46.800003, 81.9);
((GeneralPath)shape).curveTo(47.100002, 81.6, 47.200005, 81.200005, 47.200005, 80.8);
((GeneralPath)shape).curveTo(47.200005, 80.4, 47.100006, 80.0, 46.800003, 79.700005);
((GeneralPath)shape).curveTo(46.600002, 79.4, 46.200005, 79.3, 45.700005, 79.200005);
((GeneralPath)shape).lineTo(41.600006, 79.200005);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(41.600002, 84.799995);
((GeneralPath)shape).lineTo(41.600002, 88.6);
((GeneralPath)shape).lineTo(44.300003, 88.6);
((GeneralPath)shape).curveTo(45.4, 88.6, 46.000004, 88.6, 46.300003, 88.5);
((GeneralPath)shape).curveTo(46.700005, 88.4, 47.100002, 88.2, 47.4, 87.9);
((GeneralPath)shape).curveTo(47.7, 87.6, 47.800003, 87.200005, 47.800003, 86.700005);
((GeneralPath)shape).curveTo(47.800003, 86.3, 47.700005, 85.9, 47.500004, 85.600006);
((GeneralPath)shape).curveTo(47.300003, 85.3, 47.000004, 85.100006, 46.600002, 84.90001);
((GeneralPath)shape).curveTo(46.2, 84.70001, 45.300003, 84.70001, 44.000004, 84.70001);
((GeneralPath)shape).lineTo(41.600002, 84.70001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(53.200005, 91.1);
((GeneralPath)shape).lineTo(53.200005, 76.8);
((GeneralPath)shape).lineTo(57.600006, 76.8);
((GeneralPath)shape).lineTo(60.200005, 86.600006);
((GeneralPath)shape).lineTo(62.800003, 76.8);
((GeneralPath)shape).lineTo(67.200005, 76.8);
((GeneralPath)shape).lineTo(67.200005, 91.100006);
((GeneralPath)shape).lineTo(64.50001, 91.100006);
((GeneralPath)shape).lineTo(64.50001, 79.8);
((GeneralPath)shape).lineTo(61.600006, 91.100006);
((GeneralPath)shape).lineTo(58.800007, 91.100006);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_webm());
    }
}
