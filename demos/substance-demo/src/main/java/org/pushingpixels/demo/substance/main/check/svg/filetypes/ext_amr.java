 ...
 */
public class ext_amr implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(24.500002, 91.2);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(26.6, 91.200005);
...
((GeneralPath)shape).lineTo(26.599998, 91.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(50.1, 91.200005);
...
((GeneralPath)shape).lineTo(50.099995, 91.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(54.1, 79.700005);
((GeneralPath)shape).lineTo(57.1, 79.700005);
((GeneralPath)shape).curveTo(59.0, 79.700005, 60.3, 79.600006, 60.699997, 79.50001);
((GeneralPath)shape).curveTo(61.099995, 79.40001, 61.6, 79.100006, 61.799995, 78.700005);
((GeneralPath)shape).curveTo(62.099995, 78.3, 62.199997, 77.8, 62.199997, 77.200005);
((GeneralPath)shape).curveTo(62.199997, 76.50001, 61.999996, 76.00001, 61.699997, 75.600006);
((GeneralPath)shape).curveTo(61.299995, 75.200005, 60.799995, 74.90001, 60.199997, 74.8);
((GeneralPath)shape).curveTo(59.899998, 74.8, 58.899998, 74.700005, 57.199997, 74.700005);
((GeneralPath)shape).lineTo(54.0, 74.700005);
((GeneralPath)shape).lineTo(54.0, 79.700005);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_amr());
    }
}
