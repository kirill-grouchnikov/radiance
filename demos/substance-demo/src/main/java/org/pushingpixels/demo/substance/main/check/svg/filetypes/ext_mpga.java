 ...
 */
public class ext_mpga implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(26.699999, 91.0);
((GeneralPath)shape).lineTo(23.499998, 91.0);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(26.700003, 78.200005);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(45.800003, 85.4);
((GeneralPath)shape).lineTo(45.800003, 82.700005);
((GeneralPath)shape).lineTo(52.700005, 82.700005);
((GeneralPath)shape).lineTo(52.700005, 89.0);
((GeneralPath)shape).curveTo(52.000004, 89.6, 51.100006, 90.2, 49.800003, 90.7);
((GeneralPath)shape).curveTo(48.500004, 91.2, 47.200005, 91.399994, 45.9, 91.399994);
((GeneralPath)shape).curveTo(44.2, 91.399994, 42.800003, 91.09999, 41.5, 90.399994);
((GeneralPath)shape).curveTo(40.3, 89.7, 39.3, 88.7, 38.7, 87.399994);
((GeneralPath)shape).curveTo(38.100002, 86.09999, 37.8, 84.7, 37.8, 83.2);
((GeneralPath)shape).curveTo(37.8, 81.6, 38.1, 80.1, 38.8, 78.799995);
((GeneralPath)shape).curveTo(39.5, 77.49999, 40.5, 76.49999, 41.899998, 75.899994);
((GeneralPath)shape).curveTo(42.899998, 75.399994, 44.199997, 75.09999, 45.699997, 75.09999);
((GeneralPath)shape).curveTo(47.699997, 75.09999, 49.199997, 75.49999, 50.299995, 76.29999);
((GeneralPath)shape).curveTo(51.399994, 77.09999, 52.099995, 78.29999, 52.399994, 79.69999);
((GeneralPath)shape).lineTo(49.199993, 80.29999);
((GeneralPath)shape).curveTo(48.999992, 79.499985, 48.599995, 78.89999, 47.899994, 78.499985);
((GeneralPath)shape).curveTo(47.299995, 78.09998, 46.499992, 77.79999, 45.599995, 77.79999);
((GeneralPath)shape).curveTo(44.199993, 77.79999, 43.099995, 78.19999, 42.199993, 79.09999);
((GeneralPath)shape).curveTo(41.399994, 79.99999, 40.999992, 81.29999, 40.999992, 82.99999);
((GeneralPath)shape).curveTo(40.999992, 84.899994, 41.399994, 86.299995, 42.29999, 87.19999);
((GeneralPath)shape).curveTo(43.09999, 88.09999, 44.199993, 88.59999, 45.59999, 88.59999);
((GeneralPath)shape).curveTo(46.29999, 88.59999, 46.89999, 88.49999, 47.59999, 88.19999);
((GeneralPath)shape).curveTo(48.29999, 87.89999, 48.89999, 87.59999, 49.29999, 87.19999);
((GeneralPath)shape).lineTo(49.29999, 85.19999);
((GeneralPath)shape).lineTo(45.79999, 85.19999);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(64.1, 84.899994);
((GeneralPath)shape).lineTo(61.899998, 79.09999);
((GeneralPath)shape).lineTo(59.699997, 84.899994);
((GeneralPath)shape).lineTo(64.1, 84.899994);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mpga());
    }
}
