 ...
 */
public class ext_pptx implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(11.5, 78.200005);
((GeneralPath)shape).lineTo(11.5, 82.700005);
((GeneralPath)shape).lineTo(13.3, 82.700005);
((GeneralPath)shape).curveTo(14.6, 82.700005, 15.4, 82.600006, 15.8, 82.50001);
((GeneralPath)shape).curveTo(16.2, 82.30001, 16.6, 82.100006, 16.8, 81.700005);
((GeneralPath)shape).curveTo(17.0, 81.3, 17.199999, 80.9, 17.199999, 80.50001);
((GeneralPath)shape).curveTo(17.199999, 79.90001, 16.999998, 79.50001, 16.699999, 79.100006);
((GeneralPath)shape).curveTo(16.4, 78.700005, 15.899999, 78.50001, 15.399999, 78.40001);
((GeneralPath)shape).curveTo(14.999999, 78.30001, 14.299998, 78.30001, 13.099998, 78.30001);
((GeneralPath)shape).lineTo(11.499998, 78.30001);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(26.2, 78.200005);
((GeneralPath)shape).lineTo(26.2, 82.700005);
((GeneralPath)shape).lineTo(28.0, 82.700005);
((GeneralPath)shape).curveTo(29.3, 82.700005, 30.1, 82.600006, 30.5, 82.50001);
((GeneralPath)shape).curveTo(30.9, 82.30001, 31.3, 82.100006, 31.5, 81.700005);
((GeneralPath)shape).curveTo(31.7, 81.3, 31.9, 80.9, 31.9, 80.50001);
((GeneralPath)shape).curveTo(31.9, 79.90001, 31.699999, 79.50001, 31.4, 79.100006);
((GeneralPath)shape).curveTo(31.1, 78.700005, 30.6, 78.50001, 30.1, 78.40001);
((GeneralPath)shape).curveTo(29.7, 78.30001, 29.0, 78.30001, 27.800001, 78.30001);
((GeneralPath)shape).lineTo(26.2, 78.30001);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(59.0, 83.200005);
((GeneralPath)shape).lineTo(64.4, 91.3);
((GeneralPath)shape).lineTo(60.5, 91.3);
((GeneralPath)shape).lineTo(57.0, 85.9);
((GeneralPath)shape).lineTo(53.5, 91.3);
((GeneralPath)shape).lineTo(49.7, 91.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_pptx());
    }
}
