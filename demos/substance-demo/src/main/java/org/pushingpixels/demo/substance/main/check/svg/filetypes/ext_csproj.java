...
((GeneralPath)shape).curveTo(12.499999, 87.200005, 12.799999, 86.700005, 12.999999, 85.9);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(17.0, 88.399994, 16.6, 87.5, 16.4, 86.299995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(27.099998, 89.8);
((GeneralPath)shape).lineTo(27.099998, 79.1);
((GeneralPath)shape).lineTo(30.599998, 79.1);
((GeneralPath)shape).curveTo(31.899998, 79.1, 32.8, 79.2, 33.199997, 79.299995);
((GeneralPath)shape).curveTo(33.799995, 79.49999, 34.299995, 79.799995, 34.799995, 80.399994);
((GeneralPath)shape).curveTo(35.199997, 80.899994, 35.399994, 81.59999, 35.399994, 82.49999);
((GeneralPath)shape).curveTo(35.399994, 83.19999, 35.299995, 83.69999, 34.999992, 84.19999);
((GeneralPath)shape).curveTo(34.79999, 84.59999, 34.499992, 84.99999, 34.09999, 85.29999);
((GeneralPath)shape).curveTo(33.69999, 85.59999, 33.29999, 85.69999, 32.999992, 85.79999);
((GeneralPath)shape).curveTo(32.499992, 85.89999, 31.699993, 85.999985, 30.699993, 85.999985);
((GeneralPath)shape).lineTo(29.299994, 85.999985);
((GeneralPath)shape).lineTo(29.299994, 90.09998);
((GeneralPath)shape).lineTo(27.099993, 90.09998);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(32.600002, 81.1, 32.300003, 81.0, 31.900003, 81.0);
((GeneralPath)shape).curveTo(31.600004, 81.0, 31.100004, 80.9, 30.300003, 80.9);
((GeneralPath)shape).lineTo(29.300003, 80.9);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(39.4, 83.600006);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(47.7, 84.50001);
((GeneralPath)shape).curveTo(47.7, 83.40001, 47.9, 82.50001, 48.2, 81.700005);
((GeneralPath)shape).curveTo(48.4, 81.200005, 48.8, 80.700005, 49.2, 80.200005);
((GeneralPath)shape).curveTo(49.600002, 79.8, 50.100002, 79.4, 50.600002, 79.200005);
((GeneralPath)shape).curveTo(51.300003, 78.9, 52.100002, 78.8, 52.9, 78.8);
((GeneralPath)shape).curveTo(54.5, 78.8, 55.800003, 79.3, 56.7, 80.3);
((GeneralPath)shape).curveTo(57.7, 81.3, 58.100002, 82.600006, 58.100002, 84.4);
((GeneralPath)shape).curveTo(58.100002, 86.1, 57.600002, 87.5, 56.7, 88.5);
((GeneralPath)shape).curveTo(55.7, 89.5, 54.5, 90.0, 52.9, 90.0);
((GeneralPath)shape).curveTo(51.300003, 90.0, 50.0, 89.5, 49.100002, 88.5);
((GeneralPath)shape).curveTo(48.2, 87.6, 47.7, 86.2, 47.7, 84.5);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(49.9, 84.40001);
((GeneralPath)shape).curveTo(49.9, 85.600006, 50.2, 86.50001, 50.800003, 87.20001);
((GeneralPath)shape).curveTo(51.4, 87.80001, 52.100002, 88.10001, 53.000004, 88.10001);
((GeneralPath)shape).curveTo(53.900005, 88.10001, 54.600002, 87.80001, 55.100002, 87.20001);
((GeneralPath)shape).curveTo(55.7, 86.60001, 55.9, 85.60001, 55.9, 84.40001);
((GeneralPath)shape).curveTo(55.9, 83.20001, 55.600002, 82.30001, 55.100002, 81.600006);
((GeneralPath)shape).curveTo(54.600002, 81.00001, 53.800003, 80.700005, 52.9, 80.700005);
((GeneralPath)shape).curveTo(52.0, 80.700005, 51.300003, 81.00001, 50.7, 81.600006);
((GeneralPath)shape).curveTo(50.2, 82.3, 49.9, 83.200005, 49.9, 84.40001);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_csproj());
    }
}
