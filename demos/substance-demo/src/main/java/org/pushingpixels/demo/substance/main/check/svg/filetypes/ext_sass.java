 ...
 */
public class ext_sass implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(33.100002, 91.5);
((GeneralPath)shape).lineTo(31.700003, 87.8);
((GeneralPath)shape).lineTo(25.100002, 87.8);
((GeneralPath)shape).lineTo(23.700003, 91.5);
((GeneralPath)shape).lineTo(20.200003, 91.5);
((GeneralPath)shape).lineTo(26.6, 75.0);
((GeneralPath)shape).lineTo(30.1, 75.0);
((GeneralPath)shape).lineTo(36.7, 91.5);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(30.6, 85.0);
((GeneralPath)shape).lineTo(28.300001, 78.9);
((GeneralPath)shape).lineTo(26.1, 85.0);
((GeneralPath)shape).lineTo(30.6, 85.0);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(37.6, 86.2);
((GeneralPath)shape).lineTo(40.8, 85.899994);
((GeneralPath)shape).curveTo(41.0, 86.99999, 41.399998, 87.799995, 42.0, 88.299995);
((GeneralPath)shape).curveTo(42.600002, 88.799995, 43.4, 89.1, 44.4, 89.1);
((GeneralPath)shape).curveTo(45.5, 89.1, 46.300003, 88.9, 46.800003, 88.4);
((GeneralPath)shape).curveTo(47.300003, 87.9, 47.600002, 87.4, 47.600002, 86.8);
((GeneralPath)shape).curveTo(47.600002, 86.4, 47.500004, 86.100006, 47.300003, 85.8);
((GeneralPath)shape).curveTo(47.100002, 85.5, 46.700005, 85.3, 46.100002, 85.100006);
((GeneralPath)shape).curveTo(45.7, 85.00001, 44.800003, 84.700005, 43.4, 84.40001);
((GeneralPath)shape).curveTo(41.600002, 84.00001, 40.4, 83.40001, 39.600002, 82.80001);
((GeneralPath)shape).curveTo(38.600002, 81.90001, 38.100002, 80.80001, 38.100002, 79.50001);
((GeneralPath)shape).curveTo(38.100002, 78.700005, 38.300003, 77.90001, 38.800003, 77.100006);
((GeneralPath)shape).curveTo(39.300003, 76.40001, 40.000004, 75.8, 40.9, 75.40001);
((GeneralPath)shape).curveTo(41.800003, 75.00001, 42.9, 74.80001, 44.100002, 74.80001);
((GeneralPath)shape).curveTo(46.2, 74.80001, 47.7, 75.30001, 48.800003, 76.20001);
((GeneralPath)shape).curveTo(49.800003, 77.10001, 50.4, 78.30001, 50.4, 79.80001);
((GeneralPath)shape).lineTo(47.100002, 79.90001);
((GeneralPath)shape).curveTo(47.000004, 79.100006, 46.7, 78.40001, 46.2, 78.100006);
((GeneralPath)shape).curveTo(45.7, 77.700005, 45.0, 77.50001, 44.100002, 77.50001);
((GeneralPath)shape).curveTo(43.100002, 77.50001, 42.4, 77.700005, 41.800003, 78.100006);
((GeneralPath)shape).curveTo(41.4, 78.40001, 41.300003, 78.700005, 41.300003, 79.100006);
((GeneralPath)shape).curveTo(41.300003, 79.50001, 41.500004, 79.8, 41.800003, 80.100006);
((GeneralPath)shape).curveTo(42.200005, 80.50001, 43.200005, 80.8, 44.9, 81.200005);
((GeneralPath)shape).curveTo(46.5, 81.600006, 47.7, 82.00001, 48.5, 82.4);
((GeneralPath)shape).curveTo(49.3, 82.8, 49.9, 83.4, 50.3, 84.1);
((GeneralPath)shape).curveTo(50.7, 84.799995, 51.0, 85.7, 51.0, 86.7);
((GeneralPath)shape).curveTo(51.0, 87.6, 50.7, 88.5, 50.2, 89.399994);
((GeneralPath)shape).curveTo(49.7, 90.2, 48.9, 90.799995, 48.0, 91.2);
((GeneralPath)shape).curveTo(47.0, 91.6, 45.8, 91.799995, 44.4, 91.799995);
((GeneralPath)shape).curveTo(42.300003, 91.799995, 40.7, 91.299995, 39.600002, 90.399994);
((GeneralPath)shape).curveTo(38.500004, 89.399994, 37.800003, 87.99999, 37.600002, 86.2);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_sass());
    }
}
