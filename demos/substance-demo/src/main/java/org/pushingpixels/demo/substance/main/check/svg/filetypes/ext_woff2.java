 ...
 */
public class ext_woff2 implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(23.800001, 88.5, 23.300001, 87.0, 23.300001, 85.1);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(25.9, 82.5, 25.800001, 83.600006, 25.800001, 85.0);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(65.399994, 88.9);
((GeneralPath)shape).lineTo(65.399994, 91.1);
((GeneralPath)shape).lineTo(57.199993, 91.1);
((GeneralPath)shape).curveTo(57.29999, 90.299995, 57.599995, 89.5, 57.999992, 88.799995);
((GeneralPath)shape).curveTo(58.39999, 88.09999, 59.29999, 87.1, 60.59999, 85.899994);
((GeneralPath)shape).curveTo(61.69999, 84.899994, 62.29999, 84.299995, 62.499992, 83.899994);
((GeneralPath)shape).curveTo(62.79999, 83.399994, 62.999992, 82.899994, 62.999992, 82.49999);
((GeneralPath)shape).curveTo(62.999992, 81.99999, 62.899994, 81.59999, 62.59999, 81.299995);
((GeneralPath)shape).curveTo(62.29999, 80.99999, 61.89999, 80.899994, 61.39999, 80.899994);
((GeneralPath)shape).curveTo(60.89999, 80.899994, 60.49999, 80.99999, 60.19999, 81.299995);
((GeneralPath)shape).curveTo(59.89999, 81.6, 59.69999, 82.1, 59.69999, 82.799995);
((GeneralPath)shape).lineTo(57.39999, 82.6);
((GeneralPath)shape).curveTo(57.49999, 81.299995, 57.99999, 80.4, 58.69999, 79.799995);
((GeneralPath)shape).curveTo(59.39999, 79.2, 60.39999, 78.99999, 61.49999, 78.99999);
((GeneralPath)shape).curveTo(62.69999, 78.99999, 63.69999, 79.299995, 64.29999, 79.99999);
((GeneralPath)shape).curveTo(64.999985, 80.59999, 65.29999, 81.49999, 65.29999, 82.399994);
((GeneralPath)shape).curveTo(65.29999, 82.899994, 65.19999, 83.49999, 64.999985, 83.99999);
((GeneralPath)shape).curveTo(64.79999, 84.49999, 64.499985, 84.99999, 64.09998, 85.59999);
((GeneralPath)shape).curveTo(63.799984, 85.99999, 63.299984, 86.49999, 62.599983, 87.19999);
((GeneralPath)shape).curveTo(61.899982, 87.89999, 61.399982, 88.29999, 61.19998, 88.49999);
((GeneralPath)shape).curveTo(60.99998, 88.69999, 60.79998, 88.899994, 60.69998, 89.09999);
((GeneralPath)shape).lineTo(65.39998, 89.09999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_woff2());
    }
}
