 ...
 */
public class ext_tif implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(34.199997, 91.1);
((GeneralPath)shape).lineTo(34.199997, 71.2);
((GeneralPath)shape).lineTo(38.199997, 71.2);
((GeneralPath)shape).lineTo(38.199997, 91.0);
((GeneralPath)shape).lineTo(34.199997, 91.0);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_tif());
    }
}
