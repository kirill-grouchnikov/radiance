 ...
 */
public class ext_less implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(7.7, 75.2);
((GeneralPath)shape).lineTo(11.0, 75.2);
((GeneralPath)shape).lineTo(11.0, 88.799995);
((GeneralPath)shape).lineTo(19.3, 88.799995);
((GeneralPath)shape).lineTo(19.3, 91.6);
((GeneralPath)shape).lineTo(7.7, 91.6);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(21.7, 91.5);
((GeneralPath)shape).lineTo(21.7, 75.1);
((GeneralPath)shape).lineTo(33.9, 75.1);
((GeneralPath)shape).lineTo(33.9, 77.9);
((GeneralPath)shape).lineTo(25.0, 77.9);
((GeneralPath)shape).lineTo(25.0, 81.5);
((GeneralPath)shape).lineTo(33.3, 81.5);
((GeneralPath)shape).lineTo(33.3, 84.3);
((GeneralPath)shape).lineTo(25.0, 84.3);
((GeneralPath)shape).lineTo(25.0, 88.8);
((GeneralPath)shape).lineTo(34.2, 88.8);
((GeneralPath)shape).lineTo(34.2, 91.600006);
((GeneralPath)shape).lineTo(21.7, 91.600006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(36.2, 86.2);
((GeneralPath)shape).lineTo(39.4, 85.899994);
((GeneralPath)shape).curveTo(39.600002, 86.99999, 40.0, 87.799995, 40.600002, 88.299995);
((GeneralPath)shape).curveTo(41.200005, 88.799995, 42.000004, 88.99999, 43.000004, 88.99999);
((GeneralPath)shape).curveTo(44.100002, 88.99999, 44.900005, 88.799995, 45.400005, 88.299995);
((GeneralPath)shape).curveTo(45.900005, 87.799995, 46.200005, 87.299995, 46.200005, 86.7);
((GeneralPath)shape).curveTo(46.200005, 86.299995, 46.100006, 86.0, 45.900005, 85.7);
((GeneralPath)shape).curveTo(45.700005, 85.399994, 45.300007, 85.2, 44.700005, 85.0);
((GeneralPath)shape).curveTo(44.300003, 84.9, 43.400005, 84.6, 42.000004, 84.3);
((GeneralPath)shape).curveTo(40.200005, 83.9, 39.000004, 83.3, 38.200005, 82.700005);
((GeneralPath)shape).curveTo(37.200005, 81.8, 36.700005, 80.700005, 36.700005, 79.4);
((GeneralPath)shape).curveTo(36.700005, 78.6, 36.900005, 77.8, 37.400005, 77.0);
((GeneralPath)shape).curveTo(37.900005, 76.3, 38.600006, 75.7, 39.500004, 75.3);
((GeneralPath)shape).curveTo(40.400005, 74.9, 41.500004, 74.700005, 42.700005, 74.700005);
((GeneralPath)shape).curveTo(44.800003, 74.700005, 46.300003, 75.200005, 47.400005, 76.100006);
((GeneralPath)shape).curveTo(48.400005, 77.00001, 49.000004, 78.200005, 49.000004, 79.700005);
((GeneralPath)shape).lineTo(45.700005, 79.8);
((GeneralPath)shape).curveTo(45.600006, 79.0, 45.300003, 78.3, 44.800003, 78.0);
((GeneralPath)shape).curveTo(44.300003, 77.6, 43.600002, 77.4, 42.700005, 77.4);
((GeneralPath)shape).curveTo(41.700005, 77.4, 41.000004, 77.6, 40.400005, 78.0);
((GeneralPath)shape).curveTo(40.000004, 78.3, 39.900005, 78.6, 39.900005, 79.0);
((GeneralPath)shape).curveTo(39.900005, 79.4, 40.100006, 79.7, 40.400005, 80.0);
((GeneralPath)shape).curveTo(40.800007, 80.4, 41.800007, 80.7, 43.500004, 81.1);
((GeneralPath)shape).curveTo(45.100002, 81.5, 46.300003, 81.9, 47.100002, 82.299995);
((GeneralPath)shape).curveTo(47.9, 82.7, 48.500004, 83.299995, 48.9, 83.99999);
((GeneralPath)shape).curveTo(49.300003, 84.69999, 49.600002, 85.59999, 49.600002, 86.59999);
((GeneralPath)shape).curveTo(49.600002, 87.49999, 49.300003, 88.399994, 48.800003, 89.29999);
((GeneralPath)shape).curveTo(48.300003, 90.09999, 47.500004, 90.69999, 46.600002, 91.09999);
((GeneralPath)shape).curveTo(45.600002, 91.49999, 44.4, 91.69999, 43.000004, 91.69999);
((GeneralPath)shape).curveTo(40.900005, 91.69999, 39.300003, 91.19999, 38.200005, 90.29999);
((GeneralPath)shape).curveTo(37.100006, 89.39999, 36.400005, 87.999985, 36.200005, 86.19999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(51.5, 86.2);
((GeneralPath)shape).lineTo(54.7, 85.899994);
((GeneralPath)shape).curveTo(54.9, 86.99999, 55.3, 87.799995, 55.9, 88.299995);
((GeneralPath)shape).curveTo(56.500004, 88.799995, 57.300003, 89.1, 58.300003, 89.1);
((GeneralPath)shape).curveTo(59.4, 89.1, 60.200005, 88.9, 60.700005, 88.4);
((GeneralPath)shape).curveTo(61.200005, 87.9, 61.500004, 87.4, 61.500004, 86.8);
((GeneralPath)shape).curveTo(61.500004, 86.4, 61.400005, 86.100006, 61.200005, 85.8);
((GeneralPath)shape).curveTo(61.000004, 85.5, 60.600006, 85.3, 60.000004, 85.100006);
((GeneralPath)shape).curveTo(59.600002, 85.00001, 58.700005, 84.700005, 57.300003, 84.40001);
((GeneralPath)shape).curveTo(55.500004, 84.00001, 54.300003, 83.40001, 53.500004, 82.80001);
((GeneralPath)shape).curveTo(52.500004, 81.90001, 52.000004, 80.80001, 52.000004, 79.50001);
((GeneralPath)shape).curveTo(52.000004, 78.700005, 52.200005, 77.90001, 52.700005, 77.100006);
((GeneralPath)shape).curveTo(53.200005, 76.40001, 53.900005, 75.8, 54.800003, 75.40001);
((GeneralPath)shape).curveTo(55.700005, 75.00001, 56.800003, 74.80001, 58.000004, 74.80001);
((GeneralPath)shape).curveTo(60.100002, 74.80001, 61.600002, 75.30001, 62.700005, 76.20001);
((GeneralPath)shape).curveTo(63.700005, 77.10001, 64.3, 78.30001, 64.3, 79.80001);
((GeneralPath)shape).lineTo(61.000004, 79.90001);
((GeneralPath)shape).curveTo(60.900005, 79.100006, 60.600002, 78.40001, 60.100002, 78.100006);
((GeneralPath)shape).curveTo(59.600002, 77.700005, 58.9, 77.50001, 58.000004, 77.50001);
((GeneralPath)shape).curveTo(57.000004, 77.50001, 56.300003, 77.700005, 55.700005, 78.100006);
((GeneralPath)shape).curveTo(55.300003, 78.40001, 55.200005, 78.700005, 55.200005, 79.100006);
((GeneralPath)shape).curveTo(55.200005, 79.50001, 55.400005, 79.8, 55.700005, 80.100006);
((GeneralPath)shape).curveTo(56.100006, 80.50001, 57.100006, 80.8, 58.800003, 81.200005);
((GeneralPath)shape).curveTo(60.4, 81.600006, 61.600002, 82.00001, 62.4, 82.4);
((GeneralPath)shape).curveTo(63.2, 82.8, 63.800003, 83.4, 64.200005, 84.1);
((GeneralPath)shape).curveTo(64.600006, 84.799995, 64.9, 85.7, 64.9, 86.7);
((GeneralPath)shape).curveTo(64.9, 87.6, 64.6, 88.5, 64.1, 89.399994);
((GeneralPath)shape).curveTo(63.6, 90.2, 62.8, 90.799995, 61.899998, 91.2);
((GeneralPath)shape).curveTo(60.899998, 91.6, 59.699997, 91.799995, 58.3, 91.799995);
((GeneralPath)shape).curveTo(56.2, 91.799995, 54.6, 91.299995, 53.5, 90.399994);
((GeneralPath)shape).curveTo(52.4, 89.399994, 51.7, 87.99999, 51.5, 86.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_less());
    }
}
