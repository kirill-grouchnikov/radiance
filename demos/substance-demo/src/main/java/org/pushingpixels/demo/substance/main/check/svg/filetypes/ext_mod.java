 ...
 */
public class ext_mod implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(6.3, 90.8);
((GeneralPath)shape).lineTo(6.3, 71.6);
((GeneralPath)shape).lineTo(12.200001, 71.6);
((GeneralPath)shape).lineTo(15.700001, 84.7);
((GeneralPath)shape).lineTo(19.2, 71.6);
((GeneralPath)shape).lineTo(25.0, 71.6);
((GeneralPath)shape).lineTo(25.0, 90.8);
((GeneralPath)shape).lineTo(21.4, 90.8);
((GeneralPath)shape).lineTo(21.4, 75.7);
((GeneralPath)shape).lineTo(17.5, 90.799995);
((GeneralPath)shape).lineTo(13.7, 90.799995);
((GeneralPath)shape).lineTo(9.9, 75.7);
((GeneralPath)shape).lineTo(9.9, 90.799995);
((GeneralPath)shape).lineTo(6.3, 90.799995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(28.099998, 81.3);
((GeneralPath)shape).curveTo(28.099998, 79.3, 28.399998, 77.700005, 28.999998, 76.4);
((GeneralPath)shape).curveTo(29.399998, 75.4, 29.999998, 74.5, 30.799997, 73.8);
((GeneralPath)shape).curveTo(31.599997, 73.0, 32.399998, 72.4, 33.299995, 72.100006);
((GeneralPath)shape).curveTo(34.499996, 71.600006, 35.899994, 71.3, 37.499996, 71.3);
((GeneralPath)shape).curveTo(40.399998, 71.3, 42.599995, 72.200005, 44.399998, 73.9);
((GeneralPath)shape).curveTo(46.1, 75.700005, 46.999996, 78.1, 46.999996, 81.200005);
((GeneralPath)shape).curveTo(46.999996, 84.3, 46.099995, 86.700005, 44.399998, 88.50001);
((GeneralPath)shape).curveTo(42.699997, 90.30001, 40.399998, 91.100006, 37.6, 91.100006);
((GeneralPath)shape).curveTo(34.699997, 91.100006, 32.399998, 90.200005, 30.699999, 88.50001);
((GeneralPath)shape).curveTo(28.999998, 86.80001, 28.099998, 84.40001, 28.099998, 81.30001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(32.199997, 81.200005);
((GeneralPath)shape).curveTo(32.199997, 83.4, 32.699997, 85.00001, 33.699997, 86.100006);
((GeneralPath)shape).curveTo(34.699997, 87.200005, 35.999996, 87.8, 37.6, 87.8);
((GeneralPath)shape).curveTo(39.2, 87.8, 40.399998, 87.200005, 41.399998, 86.100006);
((GeneralPath)shape).curveTo(42.399998, 85.00001, 42.899998, 83.3, 42.899998, 81.100006);
((GeneralPath)shape).curveTo(42.899998, 78.90001, 42.399998, 77.3, 41.399998, 76.200005);
((GeneralPath)shape).curveTo(40.399998, 75.100006, 39.1, 74.600006, 37.499996, 74.600006);
((GeneralPath)shape).curveTo(35.899994, 74.600006, 34.599995, 75.100006, 33.599995, 76.200005);
((GeneralPath)shape).curveTo(32.699993, 77.3, 32.199993, 79.00001, 32.199993, 81.200005);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(50.0, 71.6);
((GeneralPath)shape).lineTo(57.2, 71.6);
((GeneralPath)shape).curveTo(58.8, 71.6, 60.0, 71.7, 60.9, 72.0);
((GeneralPath)shape).curveTo(62.0, 72.3, 63.0, 72.9, 63.800003, 73.8);
((GeneralPath)shape).curveTo(64.600006, 74.600006, 65.200005, 75.700005, 65.700005, 76.9);
((GeneralPath)shape).curveTo(66.100006, 78.1, 66.3, 79.6, 66.3, 81.4);
((GeneralPath)shape).curveTo(66.3, 83.0, 66.100006, 84.3, 65.700005, 85.5);
((GeneralPath)shape).curveTo(65.200005, 86.9, 64.50001, 88.0, 63.600006, 88.9);
((GeneralPath)shape).curveTo(62.900005, 89.6, 62.000008, 90.1, 60.800007, 90.4);
((GeneralPath)shape).curveTo(59.900005, 90.700005, 58.800007, 90.8, 57.300007, 90.8);
((GeneralPath)shape).lineTo(50.0, 90.8);
((GeneralPath)shape).lineTo(50.0, 71.6);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(53.9, 74.9);
((GeneralPath)shape).lineTo(53.9, 87.6);
((GeneralPath)shape).lineTo(56.800003, 87.6);
((GeneralPath)shape).curveTo(57.9, 87.6, 58.700005, 87.5, 59.200005, 87.4);
((GeneralPath)shape).curveTo(59.800003, 87.200005, 60.400005, 87.0, 60.800003, 86.6);
((GeneralPath)shape).curveTo(61.200005, 86.2, 61.600002, 85.6, 61.800003, 84.7);
((GeneralPath)shape).curveTo(62.100002, 83.799995, 62.200005, 82.7, 62.200005, 81.2);
((GeneralPath)shape).curveTo(62.200005, 79.7, 62.100006, 78.6, 61.800003, 77.799995);
((GeneralPath)shape).curveTo(61.500004, 76.99999, 61.200005, 76.399994, 60.700005, 75.899994);
((GeneralPath)shape).curveTo(60.200005, 75.49999, 59.600006, 75.2, 58.900005, 74.99999);
((GeneralPath)shape).curveTo(58.400005, 74.899994, 57.300007, 74.799995, 55.700005, 74.799995);
((GeneralPath)shape).lineTo(53.900005, 74.799995);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mod());
    }
}
