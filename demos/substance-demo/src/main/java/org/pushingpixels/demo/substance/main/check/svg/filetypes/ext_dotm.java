 ...
 */
public class ext_dotm implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(10.200001, 79.2);
((GeneralPath)shape).lineTo(10.200001, 88.7);
((GeneralPath)shape).lineTo(12.400001, 88.7);
((GeneralPath)shape).curveTo(13.200001, 88.7, 13.8, 88.7, 14.200001, 88.6);
((GeneralPath)shape).curveTo(14.700001, 88.5, 15.1, 88.299995, 15.400001, 88.0);
((GeneralPath)shape).curveTo(15.700001, 87.7, 16.0, 87.3, 16.2, 86.6);
((GeneralPath)shape).curveTo(16.400002, 86.0, 16.5, 85.1, 16.5, 84.0);
((GeneralPath)shape).curveTo(16.5, 82.9, 16.4, 82.0, 16.2, 81.5);
((GeneralPath)shape).curveTo(16.0, 80.9, 15.700001, 80.4, 15.400001, 80.1);
((GeneralPath)shape).curveTo(15.000001, 79.799995, 14.6, 79.5, 14.000001, 79.4);
((GeneralPath)shape).curveTo(13.600001, 79.3, 12.800001, 79.3, 11.6, 79.3);
((GeneralPath)shape).lineTo(10.200001, 79.3);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(21.899998, 88.1, 21.299997, 86.3, 21.299997, 84.0);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(24.699999, 81.00001, 24.3, 82.20001, 24.3, 83.90001);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(49.899998, 91.100006);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_dotm());
    }
}
