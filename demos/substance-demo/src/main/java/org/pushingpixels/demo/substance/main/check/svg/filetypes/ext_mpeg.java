 ...
 */
public class ext_mpeg implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(13.2, 86.0);
...
((GeneralPath)shape).lineTo(24.099997, 90.899994);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(30.800003, 78.00001, 30.000002, 78.00001, 28.800003, 78.00001);
((GeneralPath)shape).lineTo(27.300003, 78.00001);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(61.100002, 85.299995);
((GeneralPath)shape).lineTo(61.100002, 82.6);
((GeneralPath)shape).lineTo(68.0, 82.6);
((GeneralPath)shape).lineTo(68.0, 88.9);
((GeneralPath)shape).curveTo(67.3, 89.5, 66.4, 90.1, 65.1, 90.6);
((GeneralPath)shape).curveTo(63.8, 91.1, 62.5, 91.299995, 61.199997, 91.299995);
((GeneralPath)shape).curveTo(59.499996, 91.299995, 58.1, 90.99999, 56.799995, 90.299995);
((GeneralPath)shape).curveTo(55.599995, 89.6, 54.599995, 88.6, 53.999996, 87.299995);
((GeneralPath)shape).curveTo(53.399998, 85.99999, 53.099995, 84.6, 53.099995, 83.1);
((GeneralPath)shape).curveTo(53.099995, 81.5, 53.399994, 80.0, 54.099995, 78.7);
((GeneralPath)shape).curveTo(54.799995, 77.399994, 55.799995, 76.399994, 57.099995, 75.799995);
((GeneralPath)shape).curveTo(58.099995, 75.299995, 59.399994, 74.99999, 60.899994, 74.99999);
((GeneralPath)shape).curveTo(62.899994, 74.99999, 64.399994, 75.399994, 65.49999, 76.19999);
((GeneralPath)shape).curveTo(66.59999, 76.99999, 67.299995, 78.19999, 67.59999, 79.59999);
((GeneralPath)shape).lineTo(64.399994, 80.19999);
((GeneralPath)shape).curveTo(64.2, 79.39999, 63.799995, 78.79999, 63.099995, 78.39999);
((GeneralPath)shape).curveTo(62.499996, 77.999985, 61.699993, 77.69999, 60.799995, 77.69999);
((GeneralPath)shape).curveTo(59.399994, 77.69999, 58.299995, 78.09999, 57.499996, 78.99999);
((GeneralPath)shape).curveTo(56.699997, 79.899994, 56.299995, 81.19999, 56.299995, 82.899994);
((GeneralPath)shape).curveTo(56.299995, 84.799995, 56.699997, 86.2, 57.599995, 87.09999);
((GeneralPath)shape).curveTo(58.399994, 87.99999, 59.499996, 88.49999, 60.899994, 88.49999);
((GeneralPath)shape).curveTo(61.599995, 88.49999, 62.199993, 88.399994, 62.899994, 88.09999);
((GeneralPath)shape).curveTo(63.599995, 87.79999, 64.2, 87.49999, 64.59999, 87.09999);
((GeneralPath)shape).lineTo(64.59999, 85.09999);
((GeneralPath)shape).lineTo(61.09999, 85.09999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mpeg());
    }
}
