 ...
 */
public class ext_data implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(6.6, 74.4);
((GeneralPath)shape).lineTo(13.0, 74.4);
((GeneralPath)shape).curveTo(14.4, 74.4, 15.5, 74.5, 16.3, 74.700005);
((GeneralPath)shape).curveTo(17.3, 75.00001, 18.199999, 75.50001, 18.9, 76.3);
((GeneralPath)shape).curveTo(19.6, 77.1, 20.199999, 78.0, 20.5, 79.100006);
((GeneralPath)shape).curveTo(20.800001, 80.20001, 21.1, 81.600006, 21.1, 83.200005);
((GeneralPath)shape).curveTo(21.1, 84.600006, 20.9, 85.8, 20.6, 86.9);
((GeneralPath)shape).curveTo(20.2, 88.1, 19.6, 89.200005, 18.800001, 89.9);
((GeneralPath)shape).curveTo(18.2, 90.5, 17.400002, 90.9, 16.400002, 91.3);
((GeneralPath)shape).curveTo(15.600001, 91.5, 14.600001, 91.700005, 13.300001, 91.700005);
((GeneralPath)shape).lineTo(6.6, 91.700005);
((GeneralPath)shape).lineTo(6.6, 74.4);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(10.1, 77.3);
((GeneralPath)shape).lineTo(10.1, 88.700005);
((GeneralPath)shape).lineTo(12.700001, 88.700005);
((GeneralPath)shape).curveTo(13.700001, 88.700005, 14.400001, 88.600006, 14.800001, 88.50001);
((GeneralPath)shape).curveTo(15.400002, 88.40001, 15.800001, 88.100006, 16.2, 87.80001);
((GeneralPath)shape).curveTo(16.6, 87.500015, 16.900002, 86.90001, 17.1, 86.10001);
((GeneralPath)shape).curveTo(17.3, 85.30002, 17.5, 84.30001, 17.5, 83.000015);
((GeneralPath)shape).curveTo(17.5, 81.70002, 17.4, 80.70001, 17.1, 79.90002);
((GeneralPath)shape).curveTo(16.800001, 79.10002, 16.5, 78.60001, 16.1, 78.20002);
((GeneralPath)shape).curveTo(15.700001, 77.800026, 15.1, 77.50002, 14.5, 77.40002);
((GeneralPath)shape).curveTo(14.0, 77.30002, 13.1, 77.20002, 11.7, 77.20002);
((GeneralPath)shape).lineTo(10.099999, 77.20002);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(39.5, 91.5);
((GeneralPath)shape).lineTo(35.7, 91.5);
((GeneralPath)shape).lineTo(34.2, 87.6);
((GeneralPath)shape).lineTo(27.300001, 87.6);
((GeneralPath)shape).lineTo(25.900002, 91.5);
((GeneralPath)shape).lineTo(22.2, 91.5);
((GeneralPath)shape).lineTo(28.900002, 74.3);
((GeneralPath)shape).lineTo(32.600002, 74.3);
((GeneralPath)shape).lineTo(39.500004, 91.5);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(33.1, 84.7);
((GeneralPath)shape).lineTo(30.699999, 78.299995);
((GeneralPath)shape).lineTo(28.4, 84.7);
((GeneralPath)shape).lineTo(33.1, 84.7);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(43.399998, 91.5);
((GeneralPath)shape).lineTo(43.399998, 77.3);
((GeneralPath)shape).lineTo(38.3, 77.3);
((GeneralPath)shape).lineTo(38.3, 74.4);
((GeneralPath)shape).lineTo(52.0, 74.4);
((GeneralPath)shape).lineTo(52.0, 77.3);
((GeneralPath)shape).lineTo(46.9, 77.3);
((GeneralPath)shape).lineTo(46.9, 91.600006);
((GeneralPath)shape).lineTo(43.4, 91.600006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(67.899994, 91.5);
((GeneralPath)shape).lineTo(64.09999, 91.5);
((GeneralPath)shape).lineTo(62.59999, 87.6);
((GeneralPath)shape).lineTo(55.69999, 87.6);
((GeneralPath)shape).lineTo(54.299988, 91.5);
((GeneralPath)shape).lineTo(50.599987, 91.5);
((GeneralPath)shape).lineTo(57.299988, 74.3);
((GeneralPath)shape).lineTo(61.0, 74.3);
((GeneralPath)shape).lineTo(67.9, 91.5);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(61.499992, 84.7);
((GeneralPath)shape).lineTo(59.09999, 78.299995);
((GeneralPath)shape).lineTo(56.79999, 84.7);
((GeneralPath)shape).lineTo(61.499992, 84.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_data());
    }
}
