 ...
 */
public class ext_xcf implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(41.7, 83.799995);
((GeneralPath)shape).lineTo(45.600002, 84.99999);
((GeneralPath)shape).curveTo(45.000004, 87.19999, 44.000004, 88.799995, 42.600002, 89.799995);
((GeneralPath)shape).curveTo(41.2, 90.799995, 39.4, 91.399994, 37.300003, 91.399994);
((GeneralPath)shape).curveTo(34.600002, 91.399994, 32.500004, 90.49999, 30.800003, 88.7);
((GeneralPath)shape).curveTo(29.100002, 86.9, 28.200003, 84.399994, 28.200003, 81.299995);
((GeneralPath)shape).curveTo(28.200003, 77.99999, 29.100002, 75.399994, 30.800003, 73.6);
((GeneralPath)shape).curveTo(32.500004, 71.8, 34.800003, 70.9, 37.600002, 70.9);
((GeneralPath)shape).curveTo(40.000004, 70.9, 42.000004, 71.6, 43.600002, 73.1);
((GeneralPath)shape).curveTo(44.500004, 73.9, 45.2, 75.2, 45.600002, 76.799995);
((GeneralPath)shape).lineTo(41.600002, 77.7);
((GeneralPath)shape).curveTo(41.4, 76.7, 40.9, 75.899994, 40.100002, 75.299995);
((GeneralPath)shape).curveTo(39.300003, 74.7, 38.4, 74.399994, 37.4, 74.399994);
((GeneralPath)shape).curveTo(35.9, 74.399994, 34.7, 74.899994, 33.800003, 75.99999);
((GeneralPath)shape).curveTo(32.900005, 77.09999, 32.4, 78.799995, 32.4, 81.09999);
((GeneralPath)shape).curveTo(32.4, 83.59999, 32.9, 85.399994, 33.800003, 86.49999);
((GeneralPath)shape).curveTo(34.700005, 87.59999, 35.9, 88.09999, 37.300003, 88.09999);
((GeneralPath)shape).curveTo(38.4, 88.09999, 39.300003, 87.79999, 40.100002, 87.09999);
((GeneralPath)shape).curveTo(40.800003, 86.29999, 41.4, 85.19999, 41.7, 83.79999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(49.100002, 91.1);
((GeneralPath)shape).lineTo(49.100002, 71.2);
((GeneralPath)shape).lineTo(62.800003, 71.2);
((GeneralPath)shape).lineTo(62.800003, 74.6);
((GeneralPath)shape).lineTo(53.100002, 74.6);
((GeneralPath)shape).lineTo(53.100002, 79.299995);
((GeneralPath)shape).lineTo(61.4, 79.299995);
((GeneralPath)shape).lineTo(61.4, 82.7);
((GeneralPath)shape).lineTo(53.100002, 82.7);
((GeneralPath)shape).lineTo(53.100002, 91.1);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_xcf());
    }
}
