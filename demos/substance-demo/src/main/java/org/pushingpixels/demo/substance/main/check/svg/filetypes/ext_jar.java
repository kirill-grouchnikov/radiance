 ...
 */
public class ext_jar implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(9.000001, 89.80001, 8.500001, 88.100006, 8.500001, 86.00001);
((GeneralPath)shape).lineTo(12.300001, 85.600006);
((GeneralPath)shape).curveTo(12.300001, 86.700005, 12.500001, 87.50001, 12.800001, 88.00001);
((GeneralPath)shape).curveTo(13.200001, 88.700005, 13.900002, 89.100006, 14.800001, 89.100006);
((GeneralPath)shape).curveTo(15.700001, 89.100006, 16.300001, 88.8, 16.7, 88.3);
((GeneralPath)shape).curveTo(17.1, 87.8, 17.300001, 86.700005, 17.300001, 85.100006);
((GeneralPath)shape).lineTo(17.300001, 72.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(43.5, 92.200005);
((GeneralPath)shape).lineTo(39.1, 92.200005);
((GeneralPath)shape).lineTo(37.399998, 87.700005);
((GeneralPath)shape).lineTo(29.399998, 87.700005);
((GeneralPath)shape).lineTo(27.799997, 92.200005);
((GeneralPath)shape).lineTo(23.499996, 92.200005);
((GeneralPath)shape).lineTo(31.299995, 72.3);
((GeneralPath)shape).lineTo(35.499996, 72.3);
((GeneralPath)shape).lineTo(43.499996, 92.200005);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(45.6, 92.200005);
...
((GeneralPath)shape).curveTo(59.7, 82.5, 58.399998, 83.1, 56.699997, 83.3);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(49.6, 80.700005);
((GeneralPath)shape).lineTo(52.6, 80.700005);
((GeneralPath)shape).curveTo(54.5, 80.700005, 55.699997, 80.600006, 56.199997, 80.50001);
((GeneralPath)shape).curveTo(56.699997, 80.40001, 57.1, 80.100006, 57.299995, 79.700005);
((GeneralPath)shape).curveTo(57.599995, 79.3, 57.699997, 78.8, 57.699997, 78.200005);
((GeneralPath)shape).curveTo(57.699997, 77.50001, 57.499996, 77.00001, 57.199997, 76.600006);
((GeneralPath)shape).curveTo(56.799995, 76.200005, 56.299995, 75.90001, 55.699997, 75.8);
((GeneralPath)shape).curveTo(55.399998, 75.8, 54.399998, 75.700005, 52.799995, 75.700005);
((GeneralPath)shape).lineTo(49.699997, 75.700005);
((GeneralPath)shape).lineTo(49.699997, 80.700005);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_jar());
    }
}
