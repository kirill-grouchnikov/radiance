 ...
 */
public class ext_cue implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(20.0, 87.299995, 20.6, 86.2, 20.9, 84.799995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(28.3, 72.200005);
((GeneralPath)shape).lineTo(32.3, 72.200005);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(48.6, 92.100006);
...
((GeneralPath)shape).lineTo(63.8, 92.0);
((GeneralPath)shape).lineTo(48.6, 92.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_cue());
    }
}
