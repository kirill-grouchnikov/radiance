 ...
 */
public class ext_caf implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(13.400002, 77.0, 13.000002, 78.7, 13.000002, 81.1);
((GeneralPath)shape).curveTo(13.000002, 83.6, 13.500002, 85.4, 14.400002, 86.5);
((GeneralPath)shape).curveTo(15.300001, 87.6, 16.500002, 88.1, 18.000002, 88.1);
((GeneralPath)shape).curveTo(19.100002, 88.1, 20.000002, 87.799995, 20.800001, 87.1);
((GeneralPath)shape).curveTo(21.500002, 86.4, 22.000002, 85.299995, 22.400002, 83.9);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(47.9, 91.200005);
((GeneralPath)shape).lineTo(43.5, 91.200005);
((GeneralPath)shape).lineTo(41.7, 86.700005);
((GeneralPath)shape).lineTo(33.7, 86.700005);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(50.100002, 91.200005);
((GeneralPath)shape).lineTo(50.100002, 71.3);
((GeneralPath)shape).lineTo(63.9, 71.3);
((GeneralPath)shape).lineTo(63.9, 74.700005);
((GeneralPath)shape).lineTo(54.2, 74.700005);
((GeneralPath)shape).lineTo(54.2, 79.4);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_caf());
    }
}
