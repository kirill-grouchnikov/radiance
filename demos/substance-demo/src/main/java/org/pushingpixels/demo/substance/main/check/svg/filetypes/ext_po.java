 ...
 */
public class ext_po implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(36.700005, 88.3, 36.000004, 86.4, 36.000004, 83.9);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(39.699997, 80.600006, 39.299995, 82.00001, 39.299995, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_po());
    }
}
