 ...
 */
public class ext_fnt implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(16.5, 92.1);
((GeneralPath)shape).lineTo(16.5, 76.3);
((GeneralPath)shape).lineTo(27.4, 76.3);
((GeneralPath)shape).lineTo(27.4, 79.0);
((GeneralPath)shape).lineTo(19.7, 79.0);
((GeneralPath)shape).lineTo(19.7, 82.7);
((GeneralPath)shape).lineTo(26.300001, 82.7);
((GeneralPath)shape).lineTo(26.300001, 85.399994);
((GeneralPath)shape).lineTo(19.7, 85.399994);
((GeneralPath)shape).lineTo(19.7, 92.09999);
((GeneralPath)shape).lineTo(16.5, 92.09999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(30.0, 92.1);
((GeneralPath)shape).lineTo(30.0, 76.3);
((GeneralPath)shape).lineTo(33.1, 76.3);
((GeneralPath)shape).lineTo(39.6, 86.8);
((GeneralPath)shape).lineTo(39.6, 76.3);
((GeneralPath)shape).lineTo(42.6, 76.3);
((GeneralPath)shape).lineTo(42.6, 92.0);
((GeneralPath)shape).lineTo(39.399998, 92.0);
((GeneralPath)shape).lineTo(33.0, 81.8);
((GeneralPath)shape).lineTo(33.0, 92.100006);
((GeneralPath)shape).lineTo(30.0, 92.100006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(49.5, 92.1);
((GeneralPath)shape).lineTo(49.5, 79.0);
((GeneralPath)shape).lineTo(44.8, 79.0);
((GeneralPath)shape).lineTo(44.8, 76.3);
((GeneralPath)shape).lineTo(57.4, 76.3);
((GeneralPath)shape).lineTo(57.4, 79.0);
((GeneralPath)shape).lineTo(52.7, 79.0);
((GeneralPath)shape).lineTo(52.7, 92.1);
((GeneralPath)shape).lineTo(49.5, 92.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_fnt());
    }
}
