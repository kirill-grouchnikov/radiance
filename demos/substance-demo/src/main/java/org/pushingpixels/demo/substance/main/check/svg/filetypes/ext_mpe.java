 ...
 */
public class ext_mpe implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(31.700003, 91.100006);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(35.700005, 74.59999);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(65.6, 91.0);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mpe());
    }
}
