 ...
 */
public class ext_f4v implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(25.0, 79.299995);
((GeneralPath)shape).lineTo(25.0, 82.7);
((GeneralPath)shape).lineTo(16.6, 82.7);
((GeneralPath)shape).lineTo(16.6, 91.1);
...
((GeneralPath)shape).lineTo(52.9, 86.0);
((GeneralPath)shape).lineTo(57.800003, 71.3);
((GeneralPath)shape).lineTo(62.100002, 71.3);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_f4v());
    }
}
