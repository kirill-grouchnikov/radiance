 ...
 */
public class ext_vob implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(13.499999, 91.0);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(26.2, 81.299995);
((GeneralPath)shape).curveTo(26.2, 79.299995, 26.5, 77.6, 27.1, 76.2);
((GeneralPath)shape).curveTo(27.6, 75.2, 28.2, 74.299995, 29.0, 73.5);
((GeneralPath)shape).curveTo(29.8, 72.7, 30.7, 72.1, 31.6, 71.7);
((GeneralPath)shape).curveTo(32.8, 71.2, 34.3, 70.899994, 35.9, 70.899994);
((GeneralPath)shape).curveTo(38.9, 70.899994, 41.2, 71.799995, 43.0, 73.59999);
((GeneralPath)shape).curveTo(44.8, 75.399994, 45.7, 77.899994, 45.7, 81.19999);
((GeneralPath)shape).curveTo(45.7, 84.39999, 44.8, 86.89999, 43.100002, 88.69999);
((GeneralPath)shape).curveTo(41.400005, 90.49999, 39.0, 91.4, 36.0, 91.4);
((GeneralPath)shape).curveTo(33.0, 91.4, 30.6, 90.5, 28.9, 88.700005);
((GeneralPath)shape).curveTo(27.1, 86.9, 26.199999, 84.4, 26.199999, 81.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(30.400002, 81.1);
((GeneralPath)shape).curveTo(30.400002, 83.299995, 30.900002, 85.1, 32.0, 86.2);
...
((GeneralPath)shape).curveTo(30.899998, 77.1, 30.399998, 78.9, 30.399998, 81.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(48.800003, 71.2);
((GeneralPath)shape).lineTo(56.800003, 71.2);
((GeneralPath)shape).curveTo(58.4, 71.2, 59.600002, 71.299995, 60.300003, 71.399994);
((GeneralPath)shape).curveTo(61.100002, 71.49999, 61.800003, 71.799995, 62.4, 72.2);
((GeneralPath)shape).curveTo(63.0, 72.6, 63.5, 73.2, 63.9, 73.899994);
((GeneralPath)shape).curveTo(64.3, 74.59999, 64.5, 75.399994, 64.5, 76.2);
((GeneralPath)shape).curveTo(64.5, 77.1, 64.2, 78.0, 63.7, 78.799995);
((GeneralPath)shape).curveTo(63.200005, 79.59999, 62.5, 80.2, 61.600002, 80.49999);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_vob());
    }
}
