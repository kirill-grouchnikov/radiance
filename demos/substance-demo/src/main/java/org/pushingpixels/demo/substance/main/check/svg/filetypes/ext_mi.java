 ...
 */
public class ext_mi implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(22.9, 90.1);
((GeneralPath)shape).lineTo(22.9, 70.2);
((GeneralPath)shape).lineTo(29.0, 70.2);
((GeneralPath)shape).lineTo(32.6, 83.7);
((GeneralPath)shape).lineTo(36.199997, 70.2);
((GeneralPath)shape).lineTo(42.299995, 70.2);
((GeneralPath)shape).lineTo(42.299995, 90.0);
((GeneralPath)shape).lineTo(38.499996, 90.0);
((GeneralPath)shape).lineTo(38.499996, 74.5);
((GeneralPath)shape).lineTo(34.499996, 90.1);
((GeneralPath)shape).lineTo(30.599997, 90.1);
((GeneralPath)shape).lineTo(26.599997, 74.5);
((GeneralPath)shape).lineTo(26.599997, 90.1);
((GeneralPath)shape).lineTo(22.899996, 90.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(46.199997, 90.1);
((GeneralPath)shape).lineTo(46.199997, 70.2);
((GeneralPath)shape).lineTo(50.299995, 70.2);
((GeneralPath)shape).lineTo(50.299995, 90.0);
((GeneralPath)shape).lineTo(46.199997, 90.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mi());
    }
}
