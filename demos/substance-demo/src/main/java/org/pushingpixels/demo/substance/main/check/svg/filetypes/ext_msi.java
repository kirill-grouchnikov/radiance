 ...
 */
public class ext_msi implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(36.200012, 89.499985, 35.300014, 87.79999, 35.100014, 85.59998);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(54.699997, 92.1);
((GeneralPath)shape).lineTo(54.699997, 72.2);
((GeneralPath)shape).lineTo(58.699997, 72.2);
((GeneralPath)shape).lineTo(58.699997, 92.0);
((GeneralPath)shape).lineTo(54.699997, 92.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_msi());
    }
}
