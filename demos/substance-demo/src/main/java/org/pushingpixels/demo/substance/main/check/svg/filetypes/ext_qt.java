 ...
 */
public class ext_qt implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(37.1, 93.0);
((GeneralPath)shape).curveTo(36.5, 92.8, 35.899998, 92.6, 35.3, 92.3);
((GeneralPath)shape).curveTo(35.2, 92.200005, 34.3, 91.700005, 32.6, 90.5);
((GeneralPath)shape).curveTo(31.3, 91.1, 29.8, 91.4, 28.199999, 91.4);
((GeneralPath)shape).curveTo(25.099998, 91.4, 22.699999, 90.5, 21.0, 88.700005);
((GeneralPath)shape).curveTo(19.3, 86.9, 18.4, 84.4, 18.4, 81.100006);
((GeneralPath)shape).curveTo(18.4, 77.90001, 19.3, 75.3, 21.0, 73.50001);
((GeneralPath)shape).curveTo(22.7, 71.70001, 25.1, 70.80001, 28.1, 70.80001);
((GeneralPath)shape).curveTo(31.1, 70.80001, 33.4, 71.70001, 35.2, 73.50001);
((GeneralPath)shape).curveTo(36.9, 75.30001, 37.8, 77.80001, 37.8, 81.100006);
((GeneralPath)shape).curveTo(37.8, 82.8, 37.6, 84.3, 37.1, 85.600006);
((GeneralPath)shape).curveTo(36.8, 86.700005, 36.199997, 87.600006, 35.399998, 88.50001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(32.100002, 86.3);
((GeneralPath)shape).curveTo(32.600002, 85.700005, 33.000004, 85.0, 33.300003, 84.100006);
((GeneralPath)shape).curveTo(33.600002, 83.200005, 33.700005, 82.3, 33.700005, 81.100006);
((GeneralPath)shape).curveTo(33.700005, 78.8, 33.200005, 77.100006, 32.200005, 76.00001);
((GeneralPath)shape).curveTo(31.200005, 74.90001, 29.800005, 74.30001, 28.200005, 74.30001);
((GeneralPath)shape).curveTo(26.600004, 74.30001, 25.200005, 74.90001, 24.200005, 76.00001);
((GeneralPath)shape).curveTo(23.200005, 77.100006, 22.700005, 78.80001, 22.700005, 81.100006);
((GeneralPath)shape).curveTo(22.700005, 83.4, 23.200005, 85.200005, 24.200005, 86.3);
((GeneralPath)shape).curveTo(25.200005, 87.4, 26.500004, 88.0, 28.100004, 88.0);
((GeneralPath)shape).curveTo(28.700005, 88.0, 29.200005, 87.9, 29.800005, 87.7);
((GeneralPath)shape).curveTo(29.000006, 87.2, 28.100004, 86.799995, 27.300005, 86.5);
((GeneralPath)shape).lineTo(28.400005, 84.2);
((GeneralPath)shape).curveTo(29.700005, 84.7, 30.900005, 85.399994, 32.100006, 86.299995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(45.5, 91.100006);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_qt());
    }
}
