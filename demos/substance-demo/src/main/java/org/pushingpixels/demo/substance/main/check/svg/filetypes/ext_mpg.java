 ...
 */
public class ext_mpg implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(30.099998, 91.1);
((GeneralPath)shape).lineTo(30.099998, 71.2);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(34.199997, 74.6);
((GeneralPath)shape).lineTo(34.199997, 80.2);
((GeneralPath)shape).lineTo(36.399998, 80.2);
((GeneralPath)shape).curveTo(37.999996, 80.2, 39.1, 80.1, 39.6, 79.899994);
((GeneralPath)shape).curveTo(40.1, 79.7, 40.6, 79.399994, 40.899998, 78.899994);
((GeneralPath)shape).curveTo(41.199997, 78.49999, 41.399998, 77.899994, 41.399998, 77.399994);
((GeneralPath)shape).curveTo(41.399998, 76.7, 41.199997, 76.09999, 40.8, 75.59999);
((GeneralPath)shape).curveTo(40.399998, 75.09999, 39.8, 74.79999, 39.2, 74.69999);
((GeneralPath)shape).curveTo(38.7, 74.59999, 37.7, 74.59999, 36.3, 74.59999);
((GeneralPath)shape).lineTo(34.2, 74.59999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(58.1, 83.799995);
((GeneralPath)shape).lineTo(58.1, 80.49999);
((GeneralPath)shape).lineTo(66.799995, 80.49999);
((GeneralPath)shape).lineTo(66.799995, 88.399994);
((GeneralPath)shape).curveTo(65.99999, 89.2, 64.7, 89.899994, 63.099995, 90.49999);
((GeneralPath)shape).curveTo(61.499992, 91.09999, 59.899994, 91.399994, 58.199993, 91.399994);
((GeneralPath)shape).curveTo(56.099995, 91.399994, 54.29999, 90.99999, 52.699993, 90.09999);
((GeneralPath)shape).curveTo(51.099995, 89.19999, 50.0, 88.0, 49.2, 86.4);
((GeneralPath)shape).curveTo(48.4, 84.8, 48.0, 83.0, 48.0, 81.1);
((GeneralPath)shape).curveTo(48.0, 79.0, 48.4, 77.2, 49.3, 75.6);
((GeneralPath)shape).curveTo(50.199997, 74.0, 51.5, 72.799995, 53.1, 71.9);
((GeneralPath)shape).curveTo(54.399998, 71.200005, 56.0, 70.9, 57.899998, 70.9);
((GeneralPath)shape).curveTo(60.399998, 70.9, 62.3, 71.4, 63.699997, 72.4);
((GeneralPath)shape).curveTo(65.09999, 73.4, 66.0, 74.9, 66.399994, 76.700005);
((GeneralPath)shape).lineTo(62.399994, 77.4);
((GeneralPath)shape).curveTo(62.099995, 76.4, 61.599995, 75.700005, 60.799995, 75.1);
((GeneralPath)shape).curveTo(59.999996, 74.5, 58.999996, 74.299995, 57.899994, 74.299995);
((GeneralPath)shape).curveTo(56.099995, 74.299995, 54.699993, 74.899994, 53.699993, 75.99999);
((GeneralPath)shape).curveTo(52.699993, 77.09999, 52.099995, 78.799995, 52.099995, 80.899994);
((GeneralPath)shape).curveTo(52.099995, 83.299995, 52.599995, 84.99999, 53.699993, 86.2);
((GeneralPath)shape).curveTo(54.79999, 87.399994, 56.099995, 88.0, 57.899994, 88.0);
((GeneralPath)shape).curveTo(58.699993, 88.0, 59.599995, 87.8, 60.399994, 87.5);
((GeneralPath)shape).curveTo(61.299995, 87.2, 61.999992, 86.8, 62.599995, 86.3);
((GeneralPath)shape).lineTo(62.599995, 83.8);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mpg());
    }
}
