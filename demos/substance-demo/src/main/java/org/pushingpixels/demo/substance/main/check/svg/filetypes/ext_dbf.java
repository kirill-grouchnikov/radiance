 ...
 */
public class ext_dbf implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(13.4, 74.600006);
((GeneralPath)shape).lineTo(13.4, 87.700005);
((GeneralPath)shape).lineTo(16.4, 87.700005);
((GeneralPath)shape).curveTo(17.5, 87.700005, 18.3, 87.600006, 18.8, 87.50001);
((GeneralPath)shape).curveTo(19.5, 87.30001, 20.0, 87.100006, 20.4, 86.700005);
((GeneralPath)shape).curveTo(20.8, 86.3, 21.199999, 85.700005, 21.5, 84.8);
((GeneralPath)shape).curveTo(21.800001, 83.9, 21.9, 82.700005, 21.9, 81.200005);
((GeneralPath)shape).curveTo(21.9, 79.700005, 21.8, 78.50001, 21.5, 77.700005);
((GeneralPath)shape).curveTo(21.2, 76.9, 20.8, 76.200005, 20.4, 75.8);
((GeneralPath)shape).curveTo(20.0, 75.4, 19.3, 75.0, 18.5, 74.9);
((GeneralPath)shape).curveTo(17.9, 74.8, 16.8, 74.700005, 15.2, 74.700005);
((GeneralPath)shape).lineTo(13.4, 74.700005);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(43.999996, 79.7, 43.299995, 80.3, 42.399998, 80.6);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(33.7, 74.600006);
((GeneralPath)shape).lineTo(33.7, 79.200005);
((GeneralPath)shape).lineTo(36.4, 79.200005);
((GeneralPath)shape).curveTo(38.0, 79.200005, 39.0, 79.200005, 39.300003, 79.100006);
((GeneralPath)shape).curveTo(40.000004, 79.00001, 40.500004, 78.8, 40.9, 78.40001);
((GeneralPath)shape).curveTo(41.300003, 78.00001, 41.5, 77.50001, 41.5, 76.90001);
((GeneralPath)shape).curveTo(41.5, 76.30001, 41.3, 75.80001, 41.0, 75.40001);
((GeneralPath)shape).curveTo(40.7, 75.00001, 40.1, 74.80001, 39.5, 74.70001);
((GeneralPath)shape).curveTo(39.1, 74.70001, 37.9, 74.60001, 36.0, 74.60001);
((GeneralPath)shape).lineTo(33.7, 74.60001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(33.7, 82.50001);
((GeneralPath)shape).lineTo(33.7, 87.80001);
((GeneralPath)shape).lineTo(37.4, 87.80001);
((GeneralPath)shape).curveTo(38.9, 87.80001, 39.800003, 87.80001, 40.2, 87.70001);
((GeneralPath)shape).curveTo(40.8, 87.60001, 41.3, 87.30001, 41.7, 86.90001);
((GeneralPath)shape).curveTo(42.100002, 86.50001, 42.3, 85.90001, 42.3, 85.20001);
((GeneralPath)shape).curveTo(42.3, 84.60001, 42.2, 84.10001, 41.899998, 83.70001);
((GeneralPath)shape).curveTo(41.6, 83.30001, 41.199997, 83.000015, 40.6, 82.80001);
((GeneralPath)shape).curveTo(40.0, 82.60001, 38.899998, 82.50001, 37.0, 82.50001);
((GeneralPath)shape).lineTo(33.7, 82.50001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(49.9, 91.100006);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_dbf());
    }
}
