 ...
 */
public class ext_el implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(20.3, 91.1);
((GeneralPath)shape).lineTo(20.3, 71.0);
((GeneralPath)shape).lineTo(35.3, 71.0);
((GeneralPath)shape).lineTo(35.3, 74.4);
((GeneralPath)shape).lineTo(24.4, 74.4);
((GeneralPath)shape).lineTo(24.4, 78.8);
((GeneralPath)shape).lineTo(34.5, 78.8);
((GeneralPath)shape).lineTo(34.5, 82.200005);
((GeneralPath)shape).lineTo(24.4, 82.200005);
((GeneralPath)shape).lineTo(24.4, 87.700005);
((GeneralPath)shape).lineTo(35.7, 87.700005);
((GeneralPath)shape).lineTo(35.7, 91.100006);
((GeneralPath)shape).lineTo(20.3, 91.100006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(39.199997, 91.1);
((GeneralPath)shape).lineTo(39.199997, 71.2);
((GeneralPath)shape).lineTo(43.299995, 71.2);
((GeneralPath)shape).lineTo(43.299995, 87.7);
((GeneralPath)shape).lineTo(53.399994, 87.7);
((GeneralPath)shape).lineTo(53.399994, 91.1);
((GeneralPath)shape).lineTo(39.2, 91.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_el());
    }
}
