 ...
 */
public class ext_fla implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(64.200005, 91.100006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(56.699997, 83.2);
((GeneralPath)shape).lineTo(53.899998, 75.799995);
((GeneralPath)shape).lineTo(51.199997, 83.2);
((GeneralPath)shape).lineTo(56.699997, 83.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_fla());
    }
}
