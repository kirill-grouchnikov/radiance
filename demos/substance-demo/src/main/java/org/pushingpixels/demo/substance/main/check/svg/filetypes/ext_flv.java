 ...
 */
public class ext_flv implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(12.900002, 91.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(30.199999, 91.1);
((GeneralPath)shape).lineTo(30.199999, 71.4);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_flv());
    }
}
