...
// _0_0_1
shape = new GeneralPath();
((GeneralPath)shape).moveTo(6.5, 1.5);
((GeneralPath)shape).lineTo(6.5, 7.4962087);
((GeneralPath)shape).lineTo(21.625, 7.4962087);
((GeneralPath)shape).lineTo(6.53125, 25.5);
((GeneralPath)shape).lineTo(14.5, 25.5625);
((GeneralPath)shape).lineTo(14.5, 38.5);
((GeneralPath)shape).lineTo(32.46875, 38.5);
((GeneralPath)shape).lineTo(32.46875, 25.5625);
((GeneralPath)shape).lineTo(40.5, 25.5625);
((GeneralPath)shape).lineTo(25.125, 7.4962087);
((GeneralPath)shape).lineTo(40.498104, 7.4962087);
((GeneralPath)shape).lineTo(40.498104, 1.5);
((GeneralPath)shape).lineTo(6.5, 1.5);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(20.718035, 20.593878, 23.98445, 26.108685, 32.894203, 18.087994);
((GeneralPath)shape).curveTo(32.894203, 18.087994, 25.110422, 7.9689126, 24.086803, 7.0621667);
((GeneralPath)shape).lineTo(22.681929, 7.018591);
...
((GeneralPath)shape).lineTo(23.809519, 7.4800653);
((GeneralPath)shape).lineTo(22.919266, 7.5120316);
