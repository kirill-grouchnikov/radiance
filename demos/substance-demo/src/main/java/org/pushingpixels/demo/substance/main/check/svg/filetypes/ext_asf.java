 ...
 */
public class ext_asf implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(28.8, 91.100006);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(31.000008, 88.499985, 30.200006, 86.79999, 29.900007, 84.59998);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_asf());
    }
}
