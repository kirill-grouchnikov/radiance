 ...
 */
public class text_input implements ResizableIcon {
...
generalPath.curveTo(0.39999998f, 0.0f, 0.0f, 0.4f, 0.0f, 1.0f);
generalPath.lineTo(0.0f, 15.0f);
generalPath.curveTo(0.0f, 15.6f, 0.4f, 16.0f, 1.0f, 16.0f);
...
g.setTransform(transformsStack.pop());
    ...
    public static ResizableIcon of(int width, int height) {
       text_input base = new text_input();
       base.width = width;
       base.height = height;
       return base;
    }
