 ...
 */
public class ext_m4a implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(39.3, 83.799995);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(58.9, 83.299995);
((GeneralPath)shape).lineTo(56.100002, 75.899994);
((GeneralPath)shape).lineTo(53.4, 83.299995);
((GeneralPath)shape).lineTo(58.9, 83.299995);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_m4a());
    }
}
