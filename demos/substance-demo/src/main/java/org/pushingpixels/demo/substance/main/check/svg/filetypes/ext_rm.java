 ...
 */
public class ext_rm implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(31.100002, 81.399994, 29.8, 81.99999, 28.0, 82.2);
...
((GeneralPath)shape).lineTo(37.09999, 91.0);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_rm());
    }
}
