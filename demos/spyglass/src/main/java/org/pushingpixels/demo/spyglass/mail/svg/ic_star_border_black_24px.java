 ...
 */
public class ic_star_border_black_24px implements ResizableIcon, IsHiDpiAware {
...
g.setTransform(defaultTransform_);
	 ...
	 */
	public ic_star_border_black_24px() {
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ic_star_border_black_24px());
    }
}
