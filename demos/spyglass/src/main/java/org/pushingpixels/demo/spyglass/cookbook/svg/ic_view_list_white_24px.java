 ...
 */
public class ic_view_list_white_24px implements ResizableIcon, IsHiDpiAware {
...
g.setTransform(defaultTransform_);
	 ...
	 */
	public ic_view_list_white_24px() {
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ic_view_list_white_24px());
    }
}
