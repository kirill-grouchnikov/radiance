...
shape = generalPath
paint = RadialGradientPaint(Point2D.Double(25.125, 36.75), 15.75f, Point2D.Double(25.125, 36.75), floatArrayOf(0.0f,1.0f), arrayOf((colorFilter?.filter(Color(0, 0, 0, 255)) ?: Color(0, 0, 0, 255)),(colorFilter?.filter(Color(0, 0, 0, 0)) ?: Color(0, 0, 0, 0))), MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, AffineTransform(1.0f, 0.0f, 0.0f, 0.5952379703521729f, 3.369686058403963E-16f, 14.875f))
g.paint = paint
g.fill(shape)
...
generalPath!!.closePath()
shape = generalPath
paint = RadialGradientPaint(Point2D.Double(26.544321060180664, 28.458724975585938), 22.376116f, Point2D.Double(26.544321060180664, 28.458724975585938), floatArrayOf(0.0f,1.0f), arrayOf((colorFilter?.filter(Color(156, 188, 222, 255)) ?: Color(156, 188, 222, 255)),(colorFilter?.filter(Color(32, 74, 135, 255)) ?: Color(32, 74, 135, 255))), MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, AffineTransform(1.238342046737671f, 0.005954845808446407f, -0.006507761776447296f, 1.3512719869613647f, -6.992513179779053f, -9.744841575622559f))
g.paint = paint
g.fill(shape)
...
generalPath!!.closePath()
shape = generalPath
paint = RadialGradientPaint(Point2D.Double(-19.51563835144043, 16.855663299560547), 8.753643f, Point2D.Double(-19.51563835144043, 16.855663299560547), floatArrayOf(0.0f,1.0f), arrayOf((colorFilter?.filter(Color(255, 255, 255, 255)) ?: Color(255, 255, 255, 255)),(colorFilter?.filter(Color(184, 184, 184, 255)) ?: Color(184, 184, 184, 255))), MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, AffineTransform(4.445991039276123f, -8.852599147408013E-16f, 1.3672169501077291E-15f, 6.866499900817871f, 67.2507095336914f, -104.66790008544922f))
g.paint = paint
g.fill(shape)
paint = colorFilter?.filter(Color(255, 255, 255, 200)) ?: Color(255, 255, 255, 200)
...
g.transform = transformsStack.pop()
    ...
    companion object {
        ...
        fun uiResourceOf(width: Int, height: Int): RadianceIconUIResource {
            return RadianceIconUIResource(Help_browser(width, height))
        }
