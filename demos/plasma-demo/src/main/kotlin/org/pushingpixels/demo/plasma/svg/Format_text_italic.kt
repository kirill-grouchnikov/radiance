...
// _0_1_0
shape = GeneralPath()
(shape as GeneralPath).moveTo(34.0, 4.5)
(shape as GeneralPath).lineTo(4.0, 41.5)
(shape as GeneralPath).lineTo(10.500004, 41.5)
(shape as GeneralPath).lineTo(16.990517, 33.5)
(shape as GeneralPath).lineTo(36.5, 33.5)
(shape as GeneralPath).lineTo(36.500004, 41.5)
(shape as GeneralPath).lineTo(41.5, 41.5)
(shape as GeneralPath).lineTo(41.5, 4.5)
(shape as GeneralPath).lineTo(34.0, 4.5)
(shape as GeneralPath).closePath()
(shape as GeneralPath).moveTo(36.5, 9.5)
(shape as GeneralPath).lineTo(36.5, 28.5)
(shape as GeneralPath).lineTo(21.047087, 28.5)
(shape as GeneralPath).lineTo(36.5, 9.5)
(shape as GeneralPath).closePath()
...
stroke = BasicStroke(1.0f,0,0,4.0f,null,0.0f)
shape = GeneralPath()
(shape as GeneralPath).moveTo(6.1325827, 40.5)
(shape as GeneralPath).lineTo(34.5, 5.5)
(shape as GeneralPath).lineTo(40.5, 5.5)
(shape as GeneralPath).lineTo(40.5, 40.5)
(shape as GeneralPath).lineTo(37.38827, 40.48699)
(shape as GeneralPath).lineTo(37.38827, 32.490986)
(shape as GeneralPath).lineTo(16.793787, 32.490986)
(shape as GeneralPath).lineTo(9.899495, 40.5)
(shape as GeneralPath).lineTo(6.1325827, 40.5)
(shape as GeneralPath).closePath()
g.paint = paint
g.stroke = stroke
g.draw(shape)
...
stroke = BasicStroke(1.0f,0,0,4.0f,null,0.0f)
shape = GeneralPath()
(shape as GeneralPath).moveTo(18.976889, 29.411612)
(shape as GeneralPath).lineTo(37.47949, 29.5)
(shape as GeneralPath).lineTo(37.38827, 6.8994164)
(shape as GeneralPath).lineTo(18.976889, 29.411612)
(shape as GeneralPath).closePath()
g.paint = paint
g.stroke = stroke
g.draw(shape)
...
g.transform = transformsStack.pop()
    ...
    companion object {
        ...
        fun uiResourceOf(width: Int, height: Int): ResizableIconUIResource {
            return ResizableIconUIResource(Format_text_italic(width, height))
        }
