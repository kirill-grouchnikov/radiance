 ...
 */
class Format_justify_fill private constructor(private var width: Int, private var height: Int)
       : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): ResizableIcon {
            return Format_justify_fill(width, height)
        }
        ...
        fun uiResourceOf(width: Int, height: Int): ResizableIconUIResource {
            return ResizableIconUIResource(Format_justify_fill(width, height))
        }
         ...
         */
        fun factory(): Factory {
            return Factory { Format_justify_fill(getOrigWidth().toInt(), getOrigHeight().toInt()) }
        }
    }
