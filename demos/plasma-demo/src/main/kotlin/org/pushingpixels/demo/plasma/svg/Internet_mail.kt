...
// _0_0_1
shape = GeneralPath()
(shape as GeneralPath).moveTo(6.3334, 16.972)
(shape as GeneralPath).lineTo(6.3334, 41.482002)
(shape as GeneralPath).lineTo(43.3064, 41.482002)
(shape as GeneralPath).lineTo(43.2444, 17.090002)
(shape as GeneralPath).curveTo(43.2414, 15.712002, 31.3964, 2.4120016, 29.2114, 2.4120016)
(shape as GeneralPath).lineTo(20.659399, 2.4121015)
(shape as GeneralPath).curveTo(18.3624, 2.4121015, 6.333399, 15.674102, 6.333399, 16.972101)
(shape as GeneralPath).closePath()
...
// _0_0_2
shape = GeneralPath()
(shape as GeneralPath).moveTo(6.9231, 16.787)
(shape as GeneralPath).curveTo(6.525, 16.357, 18.8101, 3.0930004, 20.6671, 3.0930004)
(shape as GeneralPath).lineTo(29.043102, 3.0935004)
(shape as GeneralPath).curveTo(30.790102, 3.0935004, 43.0801, 16.2215, 42.4701, 16.9795)
(shape as GeneralPath).lineTo(31.6091, 30.474499)
(shape as GeneralPath).lineTo(19.295101, 30.156498)
(shape as GeneralPath).lineTo(6.9231014, 16.786499)
(shape as GeneralPath).closePath()
...
// _0_0_3
shape = GeneralPath()
(shape as GeneralPath).moveTo(19.078, 30.018)
(shape as GeneralPath).lineTo(11.744999, 21.272)
(shape as GeneralPath).lineTo(36.563, 14.3359995)
(shape as GeneralPath).lineTo(39.592, 20.552)
(shape as GeneralPath).lineTo(32.176, 29.992)
...
(shape as GeneralPath).lineTo(36.068, 14.232)
(shape as GeneralPath).lineTo(39.354, 20.825)
(shape as GeneralPath).lineTo(31.874, 29.932001)
paint = Color(0, 0, 0, 37)
g.paint = paint
g.fill(shape)
g.transform = transformsStack.pop()
...
// _0_0_7
shape = GeneralPath()
(shape as GeneralPath).moveTo(20.488, 29.064)
(shape as GeneralPath).lineTo(7.092001, 40.036)
(shape as GeneralPath).lineTo(21.001001, 30.432)
(shape as GeneralPath).lineTo(30.019001, 30.432)
(shape as GeneralPath).lineTo(42.439003, 39.914)
(shape as GeneralPath).lineTo(30.575003, 29.064001)
(shape as GeneralPath).lineTo(20.488003, 29.064001)
(shape as GeneralPath).closePath()
...
// _0_0_8
shape = GeneralPath()
(shape as GeneralPath).moveTo(6.9635, 16.885)
(shape as GeneralPath).lineTo(18.4795, 31.201)
(shape as GeneralPath).lineTo(19.5475, 30.347)
(shape as GeneralPath).lineTo(6.963501, 16.885)
(shape as GeneralPath).closePath()
paint = LinearGradientPaint(Point2D.Double(8.915599822998047, 37.196998596191406), Point2D.Double(9.885499954223633, 52.090999603271484), floatArrayOf(0.0f,1.0f), arrayOf(Color(154, 162, 154, 255),Color(181, 190, 181, 255)), MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, AffineTransform(2.4547998905181885f, 0.0f, 0.0f, 0.7620000243186951f, 2.879499912261963f, 0.34299999475479126f))
g.paint = paint
g.fill(shape)
...
shape = GeneralPath()
(shape as GeneralPath).moveTo(7.3077, 17.131)
(shape as GeneralPath).lineTo(7.3389, 40.342003)
(shape as GeneralPath).lineTo(42.2839, 40.342003)
(shape as GeneralPath).lineTo(42.2209, 17.258003)
(shape as GeneralPath).curveTo(42.218903, 16.508003, 31.004902, 3.4590034, 28.836903, 3.4590034)
(shape as GeneralPath).lineTo(20.941902, 3.4592035)
(shape as GeneralPath).curveTo(18.688902, 3.4592035, 7.306902, 16.351204, 7.3079023, 17.131203)
(shape as GeneralPath).closePath()
g.paint = paint
g.stroke = stroke
g.draw(shape)
...
(shape as GeneralPath).lineTo(20.957, 30.453)
(shape as GeneralPath).closePath()
...
(shape as GeneralPath).lineTo(19.334, 30.09)
(shape as GeneralPath).lineTo(20.531, 29.064)
(shape as GeneralPath).lineTo(30.618, 29.106998)
(shape as GeneralPath).lineTo(31.43, 29.833998)
(shape as GeneralPath).lineTo(35.405, 25.089998)
(shape as GeneralPath).curveTo(34.251, 23.678999, 13.307999, 23.635998, 13.307999, 23.635998)
(shape as GeneralPath).closePath()
