 ...
 */
class Preferences_desktop_locale(private var width: Int, private var height: Int) : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { Preferences_desktop_locale(16, 16) }
        }
    }
