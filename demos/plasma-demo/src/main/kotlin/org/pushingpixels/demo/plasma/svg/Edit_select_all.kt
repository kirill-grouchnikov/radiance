 ...
 */
class Edit_select_all(private var width: Int, private var height: Int) : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun of(width: Int, height: Int): ResizableIcon {
            return Edit_select_all(width, height)
        }
        ...
        fun uiResourceOf(width: Int, height: Int): ResizableIconUIResource {
            return ResizableIconUIResource(Edit_select_all(width, height))
        }
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { Edit_select_all(16, 16) }
        }
    }
