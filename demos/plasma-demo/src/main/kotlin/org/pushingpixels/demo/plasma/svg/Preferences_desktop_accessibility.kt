 ...
 */
class Preferences_desktop_accessibility(private var width: Int, private var height: Int) : ResizableIcon {
...
g.transform = defaultTransform_
    ...
    companion object {
        ...
        fun factory(): ResizableIconFactory {
            return ResizableIconFactory { Preferences_desktop_accessibility(16, 16) }
        }
    }
