 ...
 */
public class Format_indent_less implements RadianceIcon {
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       Format_indent_less base = new Format_indent_less();
       base.width = width;
       base.height = height;
       return base;
    }
