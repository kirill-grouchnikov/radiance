 ...
 */
public class Preferences_desktop_keyboard_shortcuts implements RadianceIcon {
...
generalPath.closePath();
shape = generalPath;
paint = new LinearGradientPaint(new Point2D.Double(38.29299545288086, 6.717449188232422), new Point2D.Double(39.4375, 8.161993026733398), new float[] {0.0f,0.5f,1.0f}, new Color[] {((colorFilter != null) ? colorFilter.filter(new Color(255, 255, 255, 0)) : new Color(255, 255, 255, 0)),((colorFilter != null) ? colorFilter.filter(new Color(255, 255, 255, 255)) : new Color(255, 255, 255, 255)),((colorFilter != null) ? colorFilter.filter(new Color(255, 255, 255, 0)) : new Color(255, 255, 255, 0))}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(0.5241569876670837f, 0.0f, 0.0f, 0.5241569876670837f, 2.4096200466156006f, 3.2809340953826904f));
g.setPaint(paint);
g.fill(shape);
g.setTransform(transformsStack.pop());
g.setComposite(AlphaComposite.getInstance(3, 1.0f * origAlpha));
...
g.setTransform(transformsStack.pop());
	 ...
	 */
	private Preferences_desktop_keyboard_shortcuts() {
    ...
    public static RadianceIcon of(int width, int height) {
       Preferences_desktop_keyboard_shortcuts base = new Preferences_desktop_keyboard_shortcuts();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return Preferences_desktop_keyboard_shortcuts::new;
    }
}
