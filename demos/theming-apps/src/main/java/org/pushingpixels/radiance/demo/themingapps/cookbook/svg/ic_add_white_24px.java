 ...
 */
public class ic_add_white_24px implements RadianceIcon {
...
// _0_1
    ...
    public static RadianceIcon of(int width, int height) {
       ic_add_white_24px base = new ic_add_white_24px();
       base.width = width;
       base.height = height;
       return base;
    }
