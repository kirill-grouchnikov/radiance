 ...
 */
public class ext_iso implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(21.499996, 89.499985, 20.699997, 87.79999, 20.399998, 85.59998);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(39.3, 82.299995);
((GeneralPath)shape).curveTo(39.3, 80.299995, 39.6, 78.6, 40.2, 77.2);
((GeneralPath)shape).curveTo(40.7, 76.2, 41.3, 75.299995, 42.100002, 74.5);
((GeneralPath)shape).curveTo(42.900005, 73.700005, 43.800003, 73.1, 44.7, 72.7);
((GeneralPath)shape).curveTo(45.9, 72.2, 47.4, 71.899994, 49.0, 71.899994);
((GeneralPath)shape).curveTo(52.0, 71.899994, 54.3, 72.799995, 56.1, 74.59999);
((GeneralPath)shape).curveTo(57.899998, 76.399994, 58.8, 78.899994, 58.8, 82.19999);
((GeneralPath)shape).curveTo(58.8, 85.39999, 57.899998, 87.89999, 56.2, 89.69999);
((GeneralPath)shape).curveTo(54.4, 91.49999, 52.100002, 92.39999, 49.100002, 92.39999);
((GeneralPath)shape).curveTo(46.100002, 92.39999, 43.7, 91.499985, 42.000004, 89.69999);
((GeneralPath)shape).curveTo(40.200005, 87.89999, 39.300003, 85.39999, 39.300003, 82.29999);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(43.999996, 78.1, 43.499996, 79.8, 43.499996, 82.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_iso());
    }
}
