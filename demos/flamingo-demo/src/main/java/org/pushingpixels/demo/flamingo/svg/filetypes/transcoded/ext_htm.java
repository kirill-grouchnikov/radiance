 ...
 */
public class ext_htm implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(8.5, 91.5);
((GeneralPath)shape).lineTo(8.5, 72.2);
((GeneralPath)shape).lineTo(12.4, 72.2);
((GeneralPath)shape).lineTo(12.4, 79.799995);
((GeneralPath)shape).lineTo(20.099998, 79.799995);
((GeneralPath)shape).lineTo(20.099998, 72.2);
...
((GeneralPath)shape).lineTo(8.5, 91.5);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(44.8, 91.5);
((GeneralPath)shape).lineTo(44.8, 72.2);
((GeneralPath)shape).lineTo(50.7, 72.2);
((GeneralPath)shape).lineTo(54.2, 85.399994);
((GeneralPath)shape).lineTo(57.7, 72.2);
((GeneralPath)shape).lineTo(63.600002, 72.2);
((GeneralPath)shape).lineTo(63.600002, 91.5);
((GeneralPath)shape).lineTo(59.9, 91.5);
((GeneralPath)shape).lineTo(59.9, 76.3);
...
((GeneralPath)shape).lineTo(44.8, 91.5);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_htm());
    }
}
