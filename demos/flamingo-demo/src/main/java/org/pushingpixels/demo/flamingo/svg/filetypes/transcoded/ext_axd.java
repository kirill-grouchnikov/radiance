 ...
 */
public class ext_axd implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(26.400002, 89.8);
((GeneralPath)shape).lineTo(33.300003, 79.3);
((GeneralPath)shape).lineTo(27.000004, 69.8);
((GeneralPath)shape).lineTo(31.800003, 69.8);
((GeneralPath)shape).lineTo(35.9, 76.200005);
((GeneralPath)shape).lineTo(39.9, 69.8);
((GeneralPath)shape).lineTo(44.600002, 69.8);
((GeneralPath)shape).lineTo(38.300003, 79.5);
((GeneralPath)shape).lineTo(45.200005, 89.8);
((GeneralPath)shape).lineTo(40.300003, 89.8);
((GeneralPath)shape).lineTo(35.800003, 82.9);
((GeneralPath)shape).lineTo(31.300003, 89.8);
((GeneralPath)shape).lineTo(26.400003, 89.8);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(47.300003, 69.8);
((GeneralPath)shape).lineTo(54.800003, 69.8);
((GeneralPath)shape).curveTo(56.500004, 69.8, 57.800003, 69.9, 58.700005, 70.200005);
((GeneralPath)shape).curveTo(59.900005, 70.50001, 60.900005, 71.200005, 61.800003, 72.00001);
((GeneralPath)shape).curveTo(62.600002, 72.90001, 63.300003, 74.00001, 63.700005, 75.200005);
((GeneralPath)shape).curveTo(64.100006, 76.50001, 64.4, 78.100006, 64.4, 79.9);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(51.4, 73.200005);
((GeneralPath)shape).lineTo(51.4, 86.50001);
((GeneralPath)shape).lineTo(54.5, 86.50001);
((GeneralPath)shape).curveTo(55.6, 86.50001, 56.5, 86.40001, 57.0, 86.30001);
((GeneralPath)shape).curveTo(57.7, 86.10001, 58.2, 85.90001, 58.7, 85.50001);
((GeneralPath)shape).curveTo(59.100002, 85.100006, 59.5, 84.50001, 59.8, 83.600006);
((GeneralPath)shape).curveTo(60.1, 82.700005, 60.2, 81.50001, 60.2, 79.90001);
((GeneralPath)shape).curveTo(60.2, 78.30001, 60.100002, 77.20001, 59.8, 76.30001);
((GeneralPath)shape).curveTo(59.499996, 75.40001, 59.1, 74.80001, 58.6, 74.40001);
((GeneralPath)shape).curveTo(58.1, 74.00001, 57.5, 73.600006, 56.699997, 73.50001);
((GeneralPath)shape).curveTo(56.1, 73.40001, 54.999996, 73.30001, 53.299995, 73.30001);
((GeneralPath)shape).lineTo(51.399994, 73.30001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_axd());
    }
}
