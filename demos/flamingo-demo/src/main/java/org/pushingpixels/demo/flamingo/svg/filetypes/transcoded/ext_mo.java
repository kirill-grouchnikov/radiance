 ...
 */
public class ext_mo implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(20.4, 91.6);
((GeneralPath)shape).lineTo(20.4, 76.0);
((GeneralPath)shape).lineTo(25.2, 76.0);
((GeneralPath)shape).lineTo(28.1, 86.6);
((GeneralPath)shape).lineTo(30.9, 76.0);
((GeneralPath)shape).lineTo(35.7, 76.0);
((GeneralPath)shape).lineTo(35.7, 91.6);
((GeneralPath)shape).lineTo(32.7, 91.6);
((GeneralPath)shape).lineTo(32.7, 79.3);
((GeneralPath)shape).lineTo(29.6, 91.600006);
((GeneralPath)shape).lineTo(26.5, 91.600006);
((GeneralPath)shape).lineTo(23.4, 79.3);
((GeneralPath)shape).lineTo(23.4, 91.600006);
((GeneralPath)shape).lineTo(20.4, 91.600006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(38.199997, 83.9);
((GeneralPath)shape).curveTo(38.199997, 82.3, 38.399998, 81.0, 38.899998, 79.9);
((GeneralPath)shape).curveTo(39.3, 79.1, 39.699997, 78.4, 40.399998, 77.8);
((GeneralPath)shape).curveTo(40.999996, 77.200005, 41.699997, 76.700005, 42.399998, 76.4);
((GeneralPath)shape).curveTo(43.399998, 76.0, 44.499996, 75.8, 45.8, 75.8);
((GeneralPath)shape).curveTo(48.1, 75.8, 50.0, 76.5, 51.399998, 77.9);
((GeneralPath)shape).curveTo(52.8, 79.3, 53.499996, 81.3, 53.499996, 83.8);
((GeneralPath)shape).curveTo(53.499996, 86.3, 52.799995, 88.3, 51.399998, 89.700005);
((GeneralPath)shape).curveTo(50.0, 91.100006, 48.199997, 91.8, 45.8, 91.8);
((GeneralPath)shape).curveTo(43.5, 91.8, 41.6, 91.100006, 40.2, 89.700005);
((GeneralPath)shape).curveTo(38.9, 88.3, 38.2, 86.4, 38.2, 83.9);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(41.499996, 83.8);
((GeneralPath)shape).curveTo(41.499996, 85.600006, 41.899998, 86.9, 42.699997, 87.8);
((GeneralPath)shape).curveTo(43.499996, 88.700005, 44.6, 89.200005, 45.799995, 89.200005);
((GeneralPath)shape).curveTo(47.099995, 89.200005, 48.099995, 88.700005, 48.899994, 87.8);
((GeneralPath)shape).curveTo(49.699993, 86.9, 50.099995, 85.5, 50.099995, 83.700005);
((GeneralPath)shape).curveTo(50.099995, 81.9, 49.699993, 80.600006, 48.899994, 79.700005);
((GeneralPath)shape).curveTo(48.099995, 78.8, 47.099995, 78.4, 45.699993, 78.4);
((GeneralPath)shape).curveTo(44.399994, 78.4, 43.29999, 78.8, 42.499992, 79.700005);
((GeneralPath)shape).curveTo(41.899994, 80.600006, 41.499992, 82.00001, 41.499992, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mo());
    }
}
