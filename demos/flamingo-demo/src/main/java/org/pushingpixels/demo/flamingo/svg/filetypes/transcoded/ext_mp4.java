 ...
 */
public class ext_mp4 implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(57.399998, 91.1);
((GeneralPath)shape).lineTo(57.399998, 87.1);
((GeneralPath)shape).lineTo(49.199997, 87.1);
((GeneralPath)shape).lineTo(49.199997, 83.799995);
((GeneralPath)shape).lineTo(57.899998, 71.2);
((GeneralPath)shape).lineTo(61.1, 71.2);
((GeneralPath)shape).lineTo(61.1, 83.799995);
((GeneralPath)shape).lineTo(63.6, 83.799995);
((GeneralPath)shape).lineTo(63.6, 87.1);
((GeneralPath)shape).lineTo(61.1, 87.1);
((GeneralPath)shape).lineTo(61.1, 91.1);
((GeneralPath)shape).lineTo(57.399998, 91.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(57.399998, 83.7);
((GeneralPath)shape).lineTo(57.399998, 77.0);
((GeneralPath)shape).lineTo(52.8, 83.8);
((GeneralPath)shape).lineTo(57.399998, 83.8);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mp4());
    }
}
