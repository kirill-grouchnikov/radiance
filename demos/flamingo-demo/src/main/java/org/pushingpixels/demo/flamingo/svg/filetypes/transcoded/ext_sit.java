 ...
 */
public class ext_sit implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(15.5, 85.7);
((GeneralPath)shape).lineTo(19.4, 85.299995);
((GeneralPath)shape).curveTo(19.6, 86.6, 20.1, 87.6, 20.8, 88.2);
((GeneralPath)shape).curveTo(21.499998, 88.799995, 22.5, 89.1, 23.699999, 89.1);
((GeneralPath)shape).curveTo(24.999998, 89.1, 25.999998, 88.799995, 26.599998, 88.299995);
((GeneralPath)shape).curveTo(27.3, 87.799995, 27.599998, 87.1, 27.599998, 86.399994);
((GeneralPath)shape).curveTo(27.599998, 85.899994, 27.499998, 85.49999, 27.199999, 85.2);
((GeneralPath)shape).curveTo(26.9, 84.9, 26.4, 84.6, 25.8, 84.299995);
((GeneralPath)shape).curveTo(25.3, 84.1, 24.3, 83.799995, 22.599998, 83.399994);
((GeneralPath)shape).curveTo(20.399998, 82.899994, 18.899998, 82.2, 18.099998, 81.399994);
((GeneralPath)shape).curveTo(16.899998, 80.299995, 16.3, 78.99999, 16.3, 77.399994);
((GeneralPath)shape).curveTo(16.3, 76.399994, 16.599998, 75.399994, 17.199999, 74.59999);
((GeneralPath)shape).curveTo(17.8, 73.79999, 18.599998, 72.99999, 19.699999, 72.59999);
((GeneralPath)shape).curveTo(20.8, 72.09999, 22.099998, 71.899994, 23.599998, 71.899994);
((GeneralPath)shape).curveTo(26.099998, 71.899994, 27.999998, 72.399994, 29.199999, 73.49999);
((GeneralPath)shape).curveTo(30.499998, 74.59999, 31.099998, 76.09999, 31.199999, 77.899994);
((GeneralPath)shape).lineTo(27.199999, 78.09999);
((GeneralPath)shape).curveTo(26.999998, 77.09999, 26.699999, 76.29999, 26.099998, 75.899994);
((GeneralPath)shape).curveTo(25.499998, 75.49999, 24.699999, 75.2, 23.599998, 75.2);
((GeneralPath)shape).curveTo(22.399998, 75.2, 21.499998, 75.399994, 20.899998, 75.899994);
((GeneralPath)shape).curveTo(20.499998, 76.2, 20.299997, 76.59999, 20.299997, 77.09999);
((GeneralPath)shape).curveTo(20.299997, 77.59999, 20.499998, 77.99999, 20.899998, 78.29999);
((GeneralPath)shape).curveTo(21.399998, 78.69999, 22.599998, 79.19999, 24.599998, 79.59999);
((GeneralPath)shape).curveTo(26.599998, 80.09999, 27.999998, 80.49999, 28.899998, 80.99999);
((GeneralPath)shape).curveTo(29.799997, 81.49999, 30.599998, 82.19999, 31.099998, 82.99999);
((GeneralPath)shape).curveTo(31.599998, 83.899994, 31.899998, 84.899994, 31.899998, 86.19999);
((GeneralPath)shape).curveTo(31.899998, 87.29999, 31.599998, 88.39999, 30.899998, 89.39999);
((GeneralPath)shape).curveTo(30.299997, 90.39999, 29.399998, 91.09998, 28.199997, 91.59998);
((GeneralPath)shape).curveTo(26.999996, 92.09998, 25.599997, 92.29998, 23.899998, 92.29998);
((GeneralPath)shape).curveTo(21.399998, 92.29998, 19.499998, 91.69998, 18.099998, 90.59998);
((GeneralPath)shape).curveTo(16.699999, 89.499985, 15.699999, 87.89999, 15.499998, 85.69998);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(34.9, 92.2);
((GeneralPath)shape).lineTo(34.9, 72.3);
((GeneralPath)shape).lineTo(38.9, 72.3);
((GeneralPath)shape).lineTo(38.9, 92.200005);
((GeneralPath)shape).lineTo(34.9, 92.200005);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(47.2, 92.2);
((GeneralPath)shape).lineTo(47.2, 75.6);
((GeneralPath)shape).lineTo(41.3, 75.6);
((GeneralPath)shape).lineTo(41.3, 72.2);
((GeneralPath)shape).lineTo(57.1, 72.2);
((GeneralPath)shape).lineTo(57.1, 75.6);
((GeneralPath)shape).lineTo(51.199997, 75.6);
((GeneralPath)shape).lineTo(51.199997, 92.1);
((GeneralPath)shape).lineTo(47.199997, 92.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_sit());
    }
}
