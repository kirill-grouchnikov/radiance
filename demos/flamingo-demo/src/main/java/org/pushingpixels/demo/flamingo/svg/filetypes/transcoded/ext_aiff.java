 ...
 */
public class ext_aiff implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(25.300001, 91.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(17.8, 83.299995);
...
((GeneralPath)shape).lineTo(35.299995, 91.3);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_aiff());
    }
}
