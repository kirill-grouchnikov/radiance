 ...
 */
public class ext_aac implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(18.6, 83.299995);
((GeneralPath)shape).lineTo(15.8, 75.899994);
((GeneralPath)shape).lineTo(13.1, 83.299995);
((GeneralPath)shape).lineTo(18.6, 83.299995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(46.300003, 91.2);
((GeneralPath)shape).lineTo(41.9, 91.2);
((GeneralPath)shape).lineTo(40.100002, 86.7);
((GeneralPath)shape).lineTo(32.100002, 86.7);
((GeneralPath)shape).lineTo(30.400002, 91.2);
((GeneralPath)shape).lineTo(26.100002, 91.2);
((GeneralPath)shape).lineTo(34.0, 71.3);
((GeneralPath)shape).lineTo(38.3, 71.3);
((GeneralPath)shape).lineTo(46.3, 91.200005);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(38.9, 83.299995);
((GeneralPath)shape).lineTo(36.100002, 75.899994);
((GeneralPath)shape).lineTo(33.4, 83.299995);
((GeneralPath)shape).lineTo(38.9, 83.299995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(61.4, 83.899994);
((GeneralPath)shape).lineTo(65.3, 85.09999);
((GeneralPath)shape).curveTo(64.700005, 87.29999, 63.700005, 88.899994, 62.300003, 89.899994);
((GeneralPath)shape).curveTo(60.9, 90.99999, 59.100002, 91.49999, 57.000004, 91.49999);
((GeneralPath)shape).curveTo(54.300003, 91.49999, 52.100002, 90.59999, 50.400005, 88.799995);
((GeneralPath)shape).curveTo(48.700005, 86.99999, 47.800007, 84.49999, 47.800007, 81.399994);
((GeneralPath)shape).curveTo(47.800007, 78.09999, 48.70001, 75.49999, 50.400005, 73.7);
((GeneralPath)shape).curveTo(52.100006, 71.899994, 54.400005, 71.0, 57.200005, 71.0);
((GeneralPath)shape).curveTo(59.700005, 71.0, 61.700005, 71.7, 63.200005, 73.2);
((GeneralPath)shape).curveTo(64.100006, 74.1, 64.8, 75.299995, 65.3, 76.899994);
((GeneralPath)shape).lineTo(61.300003, 77.899994);
((GeneralPath)shape).curveTo(61.100002, 76.899994, 60.600002, 76.09999, 59.800003, 75.49999);
((GeneralPath)shape).curveTo(59.000004, 74.899994, 58.100002, 74.59999, 57.000004, 74.59999);
((GeneralPath)shape).curveTo(55.500004, 74.59999, 54.300003, 75.09999, 53.400005, 76.19999);
((GeneralPath)shape).curveTo(52.400005, 76.99999, 52.000004, 78.69999, 52.000004, 81.09999);
((GeneralPath)shape).curveTo(52.000004, 83.59999, 52.500004, 85.399994, 53.400005, 86.49999);
((GeneralPath)shape).curveTo(54.300007, 87.59999, 55.500004, 88.09999, 57.000004, 88.09999);
((GeneralPath)shape).curveTo(58.100002, 88.09999, 59.000004, 87.79999, 59.800003, 87.09999);
((GeneralPath)shape).curveTo(60.500004, 86.399994, 61.000004, 85.29999, 61.4, 83.899994);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_aac());
    }
}
