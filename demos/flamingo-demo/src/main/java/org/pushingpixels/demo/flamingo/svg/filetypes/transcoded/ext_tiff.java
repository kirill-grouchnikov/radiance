 ...
 */
public class ext_tiff implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(34.100002, 91.09999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(47.699997, 91.1);
((GeneralPath)shape).lineTo(47.699997, 75.3);
...
((GeneralPath)shape).lineTo(47.699997, 91.09999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_tiff());
    }
}
