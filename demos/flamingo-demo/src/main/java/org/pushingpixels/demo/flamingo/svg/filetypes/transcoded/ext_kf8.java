 ...
 */
public class ext_kf8 implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(46.8, 84.100006, 47.4, 83.600006, 48.3, 83.200005);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(48.7, 86.799995);
((GeneralPath)shape).curveTo(48.7, 87.6, 48.9, 88.299995, 49.3, 88.7);
((GeneralPath)shape).curveTo(49.7, 89.2, 50.3, 89.399994, 50.899998, 89.399994);
((GeneralPath)shape).curveTo(51.499996, 89.399994, 51.999996, 89.2, 52.499996, 88.7);
((GeneralPath)shape).curveTo(52.899998, 88.299995, 53.099995, 87.6, 53.099995, 86.799995);
((GeneralPath)shape).curveTo(53.099995, 86.1, 52.899994, 85.49999, 52.499996, 84.99999);
((GeneralPath)shape).curveTo(52.099995, 84.59999, 51.599995, 84.299995, 50.899998, 84.299995);
((GeneralPath)shape).curveTo(50.199997, 84.299995, 49.6, 84.6, 49.199997, 85.1);
((GeneralPath)shape).curveTo(48.899998, 85.7, 48.699997, 86.2, 48.699997, 86.799995);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(49.1, 79.2, 49.0, 79.59999, 49.0, 80.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_kf8());
    }
}
