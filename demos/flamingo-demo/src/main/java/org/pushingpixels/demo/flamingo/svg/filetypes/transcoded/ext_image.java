 ...
 */
public class ext_image implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(34.0, 29.199999);
((GeneralPath)shape).curveTo(32.0, 28.999998, 29.5, 28.3, 28.0, 28.199999);
((GeneralPath)shape).curveTo(26.2, 25.3, 23.2, 20.699999, 20.7, 18.199999);
((GeneralPath)shape).lineTo(27.6, 18.599998);
((GeneralPath)shape).curveTo(25.7, 14.199999, 21.0, 15.799998, 21.0, 15.799998);
((GeneralPath)shape).lineTo(24.2, 13.099998);
((GeneralPath)shape).curveTo(23.5, 12.799998, 22.900002, 12.699999, 22.300001, 12.699999);
((GeneralPath)shape).curveTo(19.6, 12.699999, 18.400002, 15.499999, 18.400002, 15.499999);
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_image());
    }
}
