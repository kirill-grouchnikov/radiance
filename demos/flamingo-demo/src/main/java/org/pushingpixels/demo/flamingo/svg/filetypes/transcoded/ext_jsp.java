 ...
 */
public class ext_jsp implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(19.0, 71.1);
((GeneralPath)shape).lineTo(23.0, 71.1);
((GeneralPath)shape).lineTo(23.0, 83.7);
((GeneralPath)shape).curveTo(23.0, 85.299995, 22.9, 86.6, 22.6, 87.5);
((GeneralPath)shape).curveTo(22.2, 88.7, 21.5, 89.6, 20.5, 90.3);
((GeneralPath)shape).curveTo(19.5, 91.0, 18.1, 91.3, 16.4, 91.3);
((GeneralPath)shape).curveTo(14.4, 91.3, 12.9, 90.8, 11.799999, 89.700005);
((GeneralPath)shape).curveTo(10.699999, 88.600006, 10.199999, 87.00001, 10.199999, 84.9);
((GeneralPath)shape).lineTo(13.999999, 84.5);
((GeneralPath)shape).curveTo(13.999999, 85.6, 14.199999, 86.4, 14.499999, 86.9);
((GeneralPath)shape).curveTo(14.899999, 87.6, 15.599999, 88.0, 16.5, 88.0);
((GeneralPath)shape).curveTo(17.4, 88.0, 18.0, 87.7, 18.4, 87.2);
((GeneralPath)shape).curveTo(18.8, 86.7, 19.0, 85.6, 19.0, 84.0);
((GeneralPath)shape).lineTo(19.0, 71.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(26.3, 84.5);
((GeneralPath)shape).lineTo(30.199999, 84.1);
((GeneralPath)shape).curveTo(30.4, 85.4, 30.9, 86.4, 31.599998, 87.0);
((GeneralPath)shape).curveTo(32.299995, 87.6, 33.3, 87.9, 34.5, 87.9);
((GeneralPath)shape).curveTo(35.8, 87.9, 36.8, 87.6, 37.5, 87.1);
((GeneralPath)shape).curveTo(38.2, 86.6, 38.5, 85.9, 38.5, 85.2);
((GeneralPath)shape).curveTo(38.5, 84.7, 38.4, 84.299995, 38.1, 84.0);
((GeneralPath)shape).curveTo(37.8, 83.7, 37.3, 83.4, 36.6, 83.1);
((GeneralPath)shape).curveTo(36.1, 82.9, 35.0, 82.6, 33.399998, 82.2);
((GeneralPath)shape).curveTo(31.199997, 81.7, 29.699997, 81.0, 28.799997, 80.2);
((GeneralPath)shape).curveTo(27.599997, 79.1, 26.899998, 77.799995, 26.899998, 76.2);
((GeneralPath)shape).curveTo(26.899998, 75.2, 27.199997, 74.2, 27.799997, 73.399994);
((GeneralPath)shape).curveTo(28.399998, 72.59999, 29.199997, 71.899994, 30.299997, 71.399994);
((GeneralPath)shape).curveTo(31.399998, 70.899994, 32.699997, 70.7, 34.299995, 70.7);
((GeneralPath)shape).curveTo(36.799995, 70.7, 38.699997, 71.2, 39.999996, 72.299995);
((GeneralPath)shape).curveTo(41.299995, 73.399994, 41.899998, 74.799995, 41.999996, 76.7);
((GeneralPath)shape).lineTo(37.999996, 77.0);
((GeneralPath)shape).curveTo(37.799995, 76.0, 37.499996, 75.2, 36.899998, 74.8);
((GeneralPath)shape).curveTo(36.3, 74.4, 35.499996, 74.100006, 34.3, 74.100006);
((GeneralPath)shape).curveTo(33.1, 74.100006, 32.2, 74.3, 31.5, 74.8);
((GeneralPath)shape).curveTo(31.1, 75.100006, 30.9, 75.5, 30.9, 76.0);
((GeneralPath)shape).curveTo(30.9, 76.5, 31.1, 76.9, 31.5, 77.2);
((GeneralPath)shape).curveTo(32.0, 77.6, 33.3, 78.1, 35.2, 78.5);
((GeneralPath)shape).curveTo(37.100002, 78.9, 38.600002, 79.4, 39.600002, 79.9);
((GeneralPath)shape).curveTo(40.500004, 80.4, 41.300003, 81.1, 41.800003, 81.9);
((GeneralPath)shape).curveTo(42.300003, 82.8, 42.600002, 83.8, 42.600002, 85.1);
((GeneralPath)shape).curveTo(42.600002, 86.2, 42.300003, 87.299995, 41.600002, 88.299995);
((GeneralPath)shape).curveTo(41.000004, 89.299995, 40.100002, 89.99999, 38.9, 90.49999);
((GeneralPath)shape).curveTo(37.7, 90.99999, 36.300003, 91.19999, 34.5, 91.19999);
((GeneralPath)shape).curveTo(32.0, 91.19999, 30.0, 90.59999, 28.6, 89.49999);
((GeneralPath)shape).curveTo(27.4, 88.399994, 26.6, 86.69999, 26.300001, 84.49999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(46.1, 91.0);
((GeneralPath)shape).lineTo(46.1, 71.1);
((GeneralPath)shape).lineTo(52.6, 71.1);
((GeneralPath)shape).curveTo(55.1, 71.1, 56.699997, 71.2, 57.399998, 71.4);
((GeneralPath)shape).curveTo(58.6, 71.700005, 59.499996, 72.3, 60.3, 73.3);
((GeneralPath)shape).curveTo(61.1, 74.3, 61.5, 75.600006, 61.5, 77.200005);
((GeneralPath)shape).curveTo(61.5, 78.4, 61.3, 79.4, 60.8, 80.3);
((GeneralPath)shape).curveTo(60.399998, 81.100006, 59.8, 81.8, 59.1, 82.3);
((GeneralPath)shape).curveTo(58.399998, 82.8, 57.699997, 83.100006, 57.0, 83.200005);
((GeneralPath)shape).curveTo(56.0, 83.4, 54.6, 83.50001, 52.8, 83.50001);
((GeneralPath)shape).lineTo(50.2, 83.50001);
((GeneralPath)shape).lineTo(50.2, 91.0);
((GeneralPath)shape).lineTo(46.100002, 91.0);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(50.1, 74.5);
((GeneralPath)shape).lineTo(50.1, 80.1);
((GeneralPath)shape).lineTo(52.3, 80.1);
((GeneralPath)shape).curveTo(53.899998, 80.1, 55.0, 80.0, 55.5, 79.799995);
((GeneralPath)shape).curveTo(56.0, 79.6, 56.5, 79.299995, 56.8, 78.799995);
((GeneralPath)shape).curveTo(57.1, 78.399994, 57.3, 77.799995, 57.3, 77.299995);
((GeneralPath)shape).curveTo(57.3, 76.6, 57.1, 75.99999, 56.7, 75.49999);
((GeneralPath)shape).curveTo(56.3, 74.99999, 55.7, 74.69999, 55.100002, 74.59999);
((GeneralPath)shape).curveTo(54.600002, 74.49999, 53.600002, 74.49999, 52.2, 74.49999);
((GeneralPath)shape).lineTo(50.100002, 74.49999);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_jsp());
    }
}
