 ...
 */
public class ext_csh implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(23.4, 85.6);
((GeneralPath)shape).lineTo(26.8, 86.7);
((GeneralPath)shape).curveTo(26.3, 88.6, 25.4, 90.0, 24.199999, 90.899994);
((GeneralPath)shape).curveTo(22.999998, 91.79999, 21.499998, 92.299995, 19.599998, 92.299995);
((GeneralPath)shape).curveTo(17.3, 92.299995, 15.399999, 91.49999, 13.999998, 89.99999);
((GeneralPath)shape).curveTo(12.5999975, 88.49999, 11.799998, 86.299995, 11.799998, 83.59999);
((GeneralPath)shape).curveTo(11.799998, 80.69999, 12.499998, 78.49999, 13.999998, 76.899994);
((GeneralPath)shape).curveTo(15.499998, 75.299995, 17.399998, 74.49999, 19.8, 74.49999);
((GeneralPath)shape).curveTo(21.9, 74.49999, 23.599998, 75.09999, 24.9, 76.399994);
((GeneralPath)shape).curveTo(25.699999, 77.09999, 26.3, 78.2, 26.699999, 79.59999);
((GeneralPath)shape).lineTo(23.3, 80.399994);
((GeneralPath)shape).curveTo(23.099998, 79.49999, 22.699999, 78.799995, 22.0, 78.299995);
((GeneralPath)shape).curveTo(21.300001, 77.799995, 20.6, 77.49999, 19.7, 77.49999);
((GeneralPath)shape).curveTo(18.400002, 77.49999, 17.400002, 77.99999, 16.6, 78.899994);
((GeneralPath)shape).curveTo(15.799999, 79.799995, 15.400001, 81.299995, 15.400001, 83.299995);
((GeneralPath)shape).curveTo(15.400001, 85.49999, 15.8, 86.99999, 16.6, 87.899994);
((GeneralPath)shape).curveTo(17.400002, 88.799995, 18.4, 89.299995, 19.6, 89.299995);
((GeneralPath)shape).curveTo(20.5, 89.299995, 21.300001, 88.99999, 22.0, 88.399994);
((GeneralPath)shape).curveTo(22.699999, 87.799995, 23.1, 86.799995, 23.4, 85.59999);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_csh());
    }
}
