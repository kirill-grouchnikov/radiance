 ...
 */
public class ext_vb implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(52.899998, 78.2, 52.199997, 78.8, 51.3, 79.200005);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(42.3, 73.100006);
((GeneralPath)shape).lineTo(42.3, 77.700005);
((GeneralPath)shape).lineTo(45.0, 77.700005);
((GeneralPath)shape).curveTo(46.6, 77.700005, 47.6, 77.700005, 48.0, 77.600006);
((GeneralPath)shape).curveTo(48.7, 77.50001, 49.2, 77.3, 49.7, 76.90001);
((GeneralPath)shape).curveTo(50.100002, 76.50001, 50.3, 76.00001, 50.3, 75.30001);
((GeneralPath)shape).curveTo(50.3, 74.70001, 50.1, 74.20001, 49.8, 73.80001);
((GeneralPath)shape).curveTo(49.5, 73.40001, 48.899998, 73.20001, 48.3, 73.10001);
((GeneralPath)shape).curveTo(47.899998, 73.10001, 46.7, 73.000015, 44.8, 73.000015);
((GeneralPath)shape).lineTo(42.3, 73.000015);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(42.3, 81.100006);
((GeneralPath)shape).lineTo(42.3, 86.50001);
((GeneralPath)shape).lineTo(46.1, 86.50001);
((GeneralPath)shape).curveTo(47.6, 86.50001, 48.5, 86.50001, 48.899998, 86.40001);
((GeneralPath)shape).curveTo(49.499996, 86.30001, 49.999996, 86.00001, 50.399998, 85.600006);
((GeneralPath)shape).curveTo(50.8, 85.200005, 50.999996, 84.600006, 50.999996, 83.90001);
((GeneralPath)shape).curveTo(50.999996, 83.30001, 50.899998, 82.80001, 50.599995, 82.40001);
((GeneralPath)shape).curveTo(50.29999, 82.00001, 49.899994, 81.70001, 49.299995, 81.50001);
((GeneralPath)shape).curveTo(48.699997, 81.30001, 47.499996, 81.200005, 45.699997, 81.200005);
((GeneralPath)shape).lineTo(42.299995, 81.200005);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_vb());
    }
}
