 ...
 */
public class ext_mpa implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(32.100002, 91.20001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(36.199997, 74.6);
((GeneralPath)shape).lineTo(36.199997, 80.2);
((GeneralPath)shape).lineTo(38.399998, 80.2);
((GeneralPath)shape).curveTo(39.999996, 80.2, 41.1, 80.1, 41.6, 79.899994);
((GeneralPath)shape).curveTo(42.1, 79.7, 42.6, 79.399994, 42.899998, 78.899994);
((GeneralPath)shape).curveTo(43.199997, 78.49999, 43.399998, 77.899994, 43.399998, 77.399994);
((GeneralPath)shape).curveTo(43.399998, 76.7, 43.199997, 76.09999, 42.8, 75.59999);
((GeneralPath)shape).curveTo(42.399998, 75.09999, 41.8, 74.79999, 41.2, 74.69999);
((GeneralPath)shape).curveTo(40.7, 74.59999, 39.7, 74.59999, 38.3, 74.59999);
((GeneralPath)shape).lineTo(36.2, 74.59999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(66.899994, 91.2);
((GeneralPath)shape).lineTo(62.499992, 91.2);
((GeneralPath)shape).lineTo(60.699993, 86.7);
((GeneralPath)shape).lineTo(52.699993, 86.7);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(59.399994, 83.299995);
((GeneralPath)shape).lineTo(56.599995, 75.899994);
((GeneralPath)shape).lineTo(53.899994, 83.299995);
((GeneralPath)shape).lineTo(59.399994, 83.299995);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mpa());
    }
}
