 ...
 */
public class ext_flac implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(49.800003, 91.200005);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(43.899998, 84.899994);
((GeneralPath)shape).lineTo(41.699997, 79.09999);
((GeneralPath)shape).lineTo(39.499996, 84.899994);
((GeneralPath)shape).lineTo(43.899998, 84.899994);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(61.699997, 85.399994);
((GeneralPath)shape).lineTo(64.799995, 86.399994);
((GeneralPath)shape).curveTo(64.299995, 88.09999, 63.499996, 89.399994, 62.399994, 90.2);
((GeneralPath)shape).curveTo(61.299995, 91.0, 59.899994, 91.5, 58.199993, 91.5);
((GeneralPath)shape).curveTo(56.099995, 91.5, 54.29999, 90.8, 52.999992, 89.4);
((GeneralPath)shape).curveTo(51.59999, 88.0, 50.999992, 86.0, 50.999992, 83.5);
((GeneralPath)shape).curveTo(50.999992, 80.9, 51.699993, 78.8, 53.09999, 77.4);
((GeneralPath)shape).curveTo(54.499992, 76.0, 56.29999, 75.200005, 58.499992, 75.200005);
((GeneralPath)shape).curveTo(60.399994, 75.200005, 61.999992, 75.8, 63.199993, 76.9);
((GeneralPath)shape).curveTo(63.899994, 77.6, 64.49999, 78.5, 64.799995, 79.8);
((GeneralPath)shape).lineTo(61.599995, 80.600006);
((GeneralPath)shape).curveTo(61.399994, 79.8, 60.999996, 79.100006, 60.399994, 78.700005);
((GeneralPath)shape).curveTo(59.799995, 78.200005, 59.099995, 78.00001, 58.199993, 78.00001);
((GeneralPath)shape).curveTo(56.999992, 78.00001, 56.099995, 78.40001, 55.29999, 79.30001);
((GeneralPath)shape).curveTo(54.59999, 80.10001, 54.199993, 81.50001, 54.199993, 83.40001);
((GeneralPath)shape).curveTo(54.199993, 85.40001, 54.599995, 86.80001, 55.29999, 87.70001);
((GeneralPath)shape).curveTo(55.999992, 88.500015, 56.999992, 89.000015, 58.09999, 89.000015);
((GeneralPath)shape).curveTo(58.999992, 89.000015, 59.69999, 88.70001, 60.29999, 88.20001);
((GeneralPath)shape).curveTo(60.899994, 87.70001, 61.39999, 86.500015, 61.699993, 85.40001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_flac());
    }
}
