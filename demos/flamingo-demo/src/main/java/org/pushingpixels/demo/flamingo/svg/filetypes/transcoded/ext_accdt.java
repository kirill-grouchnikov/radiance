 ...
 */
public class ext_accdt implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(25.599997, 80.2, 25.0, 80.0, 24.3, 80.0);
((GeneralPath)shape).curveTo(23.3, 80.0, 22.5, 80.3, 21.9, 81.0);
((GeneralPath)shape).curveTo(21.3, 81.7, 21.0, 82.8, 21.0, 84.3);
((GeneralPath)shape).curveTo(21.0, 85.9, 21.3, 87.100006, 21.9, 87.8);
((GeneralPath)shape).curveTo(22.5, 88.5, 23.3, 88.8, 24.199999, 88.8);
((GeneralPath)shape).curveTo(24.9, 88.8, 25.499998, 88.600006, 25.999998, 88.100006);
((GeneralPath)shape).curveTo(26.699999, 88.00001, 27.099998, 87.3, 27.299997, 86.3);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(39.9, 88.00001, 40.3, 87.3, 40.5, 86.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(45.3, 78.200005);
((GeneralPath)shape).lineTo(50.1, 78.200005);
((GeneralPath)shape).curveTo(51.199997, 78.200005, 52.0, 78.3, 52.6, 78.4);
((GeneralPath)shape).curveTo(53.399998, 78.6, 54.0, 79.0, 54.6, 79.6);
((GeneralPath)shape).curveTo(55.1, 80.2, 55.6, 80.9, 55.899998, 81.7);
((GeneralPath)shape).curveTo(56.199997, 82.5, 56.3, 83.5, 56.3, 84.7);
((GeneralPath)shape).curveTo(56.3, 85.799995, 56.2, 86.7, 55.899998, 87.399994);
((GeneralPath)shape).curveTo(55.6, 88.299995, 55.1, 89.09999, 54.499996, 89.7);
((GeneralPath)shape).curveTo(53.999996, 90.1, 53.399998, 90.5, 52.599995, 90.7);
((GeneralPath)shape).curveTo(51.999996, 90.899994, 51.199993, 91.0, 50.299995, 91.0);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_accdt());
    }
}
