 ...
 */
public class ext_aif implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(26.400002, 83.299995);
((GeneralPath)shape).lineTo(23.600002, 75.899994);
((GeneralPath)shape).lineTo(20.900002, 83.299995);
((GeneralPath)shape).lineTo(26.400002, 83.299995);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_aif());
    }
}
