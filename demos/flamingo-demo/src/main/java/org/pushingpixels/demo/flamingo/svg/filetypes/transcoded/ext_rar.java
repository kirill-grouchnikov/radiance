 ...
 */
public class ext_rar implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(38.699997, 84.299995);
((GeneralPath)shape).lineTo(36.0, 76.9);
((GeneralPath)shape).lineTo(33.3, 84.3);
((GeneralPath)shape).lineTo(38.7, 84.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(48.299995, 92.2);
((GeneralPath)shape).lineTo(48.299995, 72.3);
((GeneralPath)shape).lineTo(56.799995, 72.3);
((GeneralPath)shape).curveTo(58.899994, 72.3, 60.499996, 72.5, 61.399994, 72.8);
((GeneralPath)shape).curveTo(62.29999, 73.100006, 63.099995, 73.8, 63.699993, 74.700005);
((GeneralPath)shape).curveTo(64.299995, 75.600006, 64.59999, 76.700005, 64.59999, 77.8);
((GeneralPath)shape).curveTo(64.59999, 79.3, 64.19999, 80.5, 63.29999, 81.5);
((GeneralPath)shape).curveTo(62.399994, 82.5, 61.09999, 83.1, 59.39999, 83.3);
((GeneralPath)shape).curveTo(60.29999, 83.8, 60.99999, 84.4, 61.59999, 85.0);
((GeneralPath)shape).curveTo(62.199993, 85.6, 62.89999, 86.7, 63.89999, 88.2);
((GeneralPath)shape).lineTo(66.29999, 92.1);
((GeneralPath)shape).lineTo(61.49999, 92.1);
((GeneralPath)shape).lineTo(58.599987, 87.799995);
((GeneralPath)shape).curveTo(57.599987, 86.299995, 56.899986, 85.299995, 56.49999, 84.899994);
((GeneralPath)shape).curveTo(56.099987, 84.49999, 55.69999, 84.2, 55.299988, 84.09999);
((GeneralPath)shape).curveTo(54.899986, 83.99999, 54.19999, 83.899994, 53.299988, 83.899994);
((GeneralPath)shape).lineTo(52.49999, 83.899994);
((GeneralPath)shape).lineTo(52.49999, 92.2);
((GeneralPath)shape).lineTo(48.299988, 92.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(52.299995, 80.7);
((GeneralPath)shape).lineTo(55.299995, 80.7);
((GeneralPath)shape).curveTo(57.199997, 80.7, 58.399994, 80.6, 58.899994, 80.5);
((GeneralPath)shape).curveTo(59.399994, 80.3, 59.799995, 80.1, 59.999992, 79.7);
((GeneralPath)shape).curveTo(60.29999, 79.299995, 60.399994, 78.799995, 60.399994, 78.2);
((GeneralPath)shape).curveTo(60.399994, 77.5, 60.199993, 77.0, 59.899994, 76.6);
((GeneralPath)shape).curveTo(59.499992, 76.2, 58.999992, 75.9, 58.399994, 75.799995);
((GeneralPath)shape).curveTo(58.099995, 75.799995, 57.099995, 75.7, 55.499992, 75.7);
((GeneralPath)shape).lineTo(52.399994, 75.7);
((GeneralPath)shape).lineTo(52.399994, 80.7);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_rar());
    }
}
