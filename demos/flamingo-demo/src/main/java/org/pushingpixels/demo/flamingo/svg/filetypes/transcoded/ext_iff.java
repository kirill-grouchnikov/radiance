 ...
 */
public class ext_iff implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(25.099998, 91.3);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(42.300003, 91.2);
((GeneralPath)shape).lineTo(42.300003, 71.3);
((GeneralPath)shape).lineTo(56.100002, 71.3);
((GeneralPath)shape).lineTo(56.100002, 74.700005);
((GeneralPath)shape).lineTo(46.4, 74.700005);
((GeneralPath)shape).lineTo(46.4, 79.4);
((GeneralPath)shape).lineTo(54.800003, 79.4);
((GeneralPath)shape).lineTo(54.800003, 82.8);
((GeneralPath)shape).lineTo(46.4, 82.8);
((GeneralPath)shape).lineTo(46.4, 91.3);
((GeneralPath)shape).lineTo(42.300003, 91.3);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_iff());
    }
}
