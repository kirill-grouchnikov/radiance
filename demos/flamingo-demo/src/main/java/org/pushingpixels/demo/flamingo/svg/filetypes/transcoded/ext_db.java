 ...
 */
public class ext_db implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(22.0, 74.600006);
((GeneralPath)shape).lineTo(22.0, 87.700005);
((GeneralPath)shape).lineTo(25.0, 87.700005);
((GeneralPath)shape).curveTo(26.1, 87.700005, 26.9, 87.600006, 27.4, 87.50001);
((GeneralPath)shape).curveTo(28.1, 87.30001, 28.6, 87.100006, 29.0, 86.700005);
((GeneralPath)shape).curveTo(29.4, 86.3, 29.8, 85.700005, 30.1, 84.8);
((GeneralPath)shape).curveTo(30.400002, 83.9, 30.5, 82.700005, 30.5, 81.200005);
((GeneralPath)shape).curveTo(30.5, 79.700005, 30.4, 78.50001, 30.1, 77.700005);
((GeneralPath)shape).curveTo(29.800001, 76.9, 29.4, 76.200005, 29.0, 75.8);
((GeneralPath)shape).curveTo(28.6, 75.4, 27.9, 75.0, 27.1, 74.9);
((GeneralPath)shape).curveTo(26.5, 74.8, 25.4, 74.700005, 23.800001, 74.700005);
((GeneralPath)shape).lineTo(22.0, 74.700005);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(52.6, 79.7, 51.899998, 80.3, 51.0, 80.6);
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(42.3, 74.600006);
((GeneralPath)shape).lineTo(42.3, 79.200005);
((GeneralPath)shape).lineTo(45.0, 79.200005);
((GeneralPath)shape).curveTo(46.6, 79.200005, 47.6, 79.200005, 47.9, 79.100006);
((GeneralPath)shape).curveTo(48.600002, 79.00001, 49.100002, 78.8, 49.5, 78.40001);
((GeneralPath)shape).curveTo(49.9, 78.00001, 50.1, 77.50001, 50.1, 76.90001);
((GeneralPath)shape).curveTo(50.1, 76.30001, 49.899998, 75.80001, 49.6, 75.40001);
((GeneralPath)shape).curveTo(49.3, 75.00001, 48.8, 74.80001, 48.1, 74.70001);
((GeneralPath)shape).curveTo(47.699997, 74.70001, 46.5, 74.60001, 44.6, 74.60001);
((GeneralPath)shape).lineTo(42.3, 74.60001);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(42.3, 82.50001);
((GeneralPath)shape).lineTo(42.3, 87.80001);
((GeneralPath)shape).lineTo(46.0, 87.80001);
((GeneralPath)shape).curveTo(47.5, 87.80001, 48.4, 87.80001, 48.8, 87.70001);
((GeneralPath)shape).curveTo(49.399998, 87.60001, 49.899998, 87.30001, 50.3, 86.90001);
((GeneralPath)shape).curveTo(50.7, 86.50001, 50.899998, 85.90001, 50.899998, 85.20001);
((GeneralPath)shape).curveTo(50.899998, 84.60001, 50.8, 84.10001, 50.499996, 83.70001);
((GeneralPath)shape).curveTo(50.199997, 83.30001, 49.799995, 83.000015, 49.199997, 82.80001);
((GeneralPath)shape).curveTo(48.6, 82.60001, 47.499996, 82.50001, 45.6, 82.50001);
((GeneralPath)shape).lineTo(42.3, 82.50001);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_db());
    }
}
