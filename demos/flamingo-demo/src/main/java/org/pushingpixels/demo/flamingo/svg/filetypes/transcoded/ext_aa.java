 ...
 */
public class ext_aa implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(36.699997, 91.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(29.2, 83.299995);
((GeneralPath)shape).lineTo(26.400002, 75.899994);
((GeneralPath)shape).lineTo(23.7, 83.299995);
((GeneralPath)shape).lineTo(29.2, 83.299995);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(49.5, 83.299995);
((GeneralPath)shape).lineTo(46.7, 75.899994);
((GeneralPath)shape).lineTo(44.0, 83.299995);
((GeneralPath)shape).lineTo(49.5, 83.299995);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_aa());
    }
}
