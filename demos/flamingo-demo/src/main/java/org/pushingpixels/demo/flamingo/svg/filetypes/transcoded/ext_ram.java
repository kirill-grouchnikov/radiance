 ...
 */
public class ext_ram implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(44.800003, 91.2);
((GeneralPath)shape).lineTo(40.4, 91.2);
((GeneralPath)shape).lineTo(38.600002, 86.7);
((GeneralPath)shape).lineTo(30.600002, 86.7);
((GeneralPath)shape).lineTo(28.900002, 91.2);
((GeneralPath)shape).lineTo(24.600002, 91.2);
((GeneralPath)shape).lineTo(32.4, 71.299995);
((GeneralPath)shape).lineTo(36.7, 71.299995);
((GeneralPath)shape).lineTo(44.800003, 91.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(37.300003, 83.299995);
((GeneralPath)shape).lineTo(34.500004, 75.899994);
((GeneralPath)shape).lineTo(31.800003, 83.299995);
((GeneralPath)shape).lineTo(37.300003, 83.299995);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_ram());
    }
}
