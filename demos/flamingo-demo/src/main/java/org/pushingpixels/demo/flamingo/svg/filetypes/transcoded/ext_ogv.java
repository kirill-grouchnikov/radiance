 ...
 */
public class ext_ogv implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(7.6, 86.899994, 6.8, 84.399994, 6.8, 81.299995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(10.9, 81.100006);
((GeneralPath)shape).curveTo(10.9, 83.3, 11.4, 85.100006, 12.5, 86.200005);
((GeneralPath)shape).curveTo(13.5, 87.4, 14.9, 87.9, 16.5, 87.9);
((GeneralPath)shape).curveTo(18.1, 87.9, 19.4, 87.3, 20.5, 86.200005);
((GeneralPath)shape).curveTo(21.5, 85.00001, 22.1, 83.3, 22.1, 81.00001);
((GeneralPath)shape).curveTo(22.1, 78.700005, 21.6, 77.00001, 20.6, 75.90001);
((GeneralPath)shape).curveTo(19.6, 74.80001, 18.300001, 74.20001, 16.6, 74.20001);
((GeneralPath)shape).curveTo(14.9, 74.20001, 13.6, 74.80001, 12.6, 75.90001);
((GeneralPath)shape).curveTo(11.400001, 77.100006, 10.900001, 78.90001, 10.900001, 81.100006);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(38.699997, 83.8);
((GeneralPath)shape).lineTo(38.699997, 80.5);
((GeneralPath)shape).lineTo(47.399998, 80.5);
((GeneralPath)shape).lineTo(47.399998, 88.4);
((GeneralPath)shape).curveTo(46.6, 89.200005, 45.3, 89.9, 43.699997, 90.5);
((GeneralPath)shape).curveTo(42.1, 91.1, 40.499996, 91.4, 38.799995, 91.4);
((GeneralPath)shape).curveTo(36.699997, 91.4, 34.899994, 91.0, 33.299995, 90.1);
((GeneralPath)shape).curveTo(31.699997, 89.2, 30.599995, 88.0, 29.799995, 86.4);
((GeneralPath)shape).curveTo(28.999996, 84.8, 28.599995, 83.0, 28.599995, 81.1);
((GeneralPath)shape).curveTo(28.599995, 79.0, 28.999994, 77.2, 29.899994, 75.6);
((GeneralPath)shape).curveTo(30.799994, 74.0, 32.099995, 72.799995, 33.699993, 71.9);
((GeneralPath)shape).curveTo(34.999992, 71.200005, 36.599995, 70.9, 38.499992, 70.9);
((GeneralPath)shape).curveTo(40.999992, 70.9, 42.899994, 71.4, 44.29999, 72.4);
((GeneralPath)shape).curveTo(45.699993, 73.4, 46.59999, 74.9, 46.999992, 76.700005);
((GeneralPath)shape).lineTo(42.999992, 77.4);
((GeneralPath)shape).curveTo(42.699993, 76.4, 42.199993, 75.700005, 41.399994, 75.1);
((GeneralPath)shape).curveTo(40.599995, 74.5, 39.599995, 74.299995, 38.499992, 74.299995);
((GeneralPath)shape).curveTo(36.699993, 74.299995, 35.29999, 74.899994, 34.29999, 75.99999);
((GeneralPath)shape).curveTo(33.29999, 77.09999, 32.699993, 78.799995, 32.699993, 80.899994);
((GeneralPath)shape).curveTo(32.699993, 83.299995, 33.199993, 84.99999, 34.29999, 86.2);
((GeneralPath)shape).curveTo(35.39999, 87.399994, 36.699993, 88.0, 38.499992, 88.0);
((GeneralPath)shape).curveTo(39.29999, 88.0, 40.199993, 87.8, 40.999992, 87.5);
((GeneralPath)shape).curveTo(41.899994, 87.2, 42.59999, 86.8, 43.199993, 86.3);
((GeneralPath)shape).lineTo(43.199993, 83.8);
((GeneralPath)shape).lineTo(38.699993, 83.8);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(56.299995, 91.100006);
((GeneralPath)shape).lineTo(49.099995, 71.3);
((GeneralPath)shape).lineTo(53.499996, 71.3);
...
((GeneralPath)shape).lineTo(56.300003, 91.100006);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_ogv());
    }
}
