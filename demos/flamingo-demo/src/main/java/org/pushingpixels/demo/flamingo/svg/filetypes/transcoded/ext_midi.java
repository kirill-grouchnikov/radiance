 ...
 */
public class ext_midi implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(39.9, 71.299995);
((GeneralPath)shape).lineTo(47.300003, 71.299995);
((GeneralPath)shape).curveTo(49.000004, 71.299995, 50.200005, 71.399994, 51.100002, 71.7);
((GeneralPath)shape).curveTo(52.300003, 72.0, 53.300003, 72.7, 54.100002, 73.5);
((GeneralPath)shape).curveTo(54.9, 74.4, 55.600002, 75.5, 56.000004, 76.7);
((GeneralPath)shape).curveTo(56.400005, 78.0, 56.700005, 79.5, 56.700005, 81.399994);
((GeneralPath)shape).curveTo(56.700005, 82.99999, 56.500004, 84.399994, 56.100006, 85.59999);
((GeneralPath)shape).curveTo(55.600006, 86.99999, 54.900005, 88.19999, 53.900005, 89.09999);
((GeneralPath)shape).curveTo(53.200005, 89.79999, 52.200005, 90.29999, 51.000004, 90.69999);
((GeneralPath)shape).curveTo(50.100002, 90.99999, 48.900005, 91.09999, 47.400005, 91.09999);
((GeneralPath)shape).lineTo(39.800007, 91.09999);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_midi());
    }
}
