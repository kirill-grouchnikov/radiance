 ...
 */
public class ext_wma implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(24.0, 91.2);
((GeneralPath)shape).lineTo(20.0, 91.2);
((GeneralPath)shape).lineTo(16.3, 77.299995);
((GeneralPath)shape).lineTo(12.599999, 91.2);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_wma());
    }
}
