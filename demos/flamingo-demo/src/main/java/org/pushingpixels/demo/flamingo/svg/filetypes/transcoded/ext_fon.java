 ...
 */
public class ext_fon implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(57.7, 55.300003, 57.8, 55.4, 58.0, 55.4);
...
((GeneralPath)shape).curveTo(44.799995, 43.80001, 46.499996, 41.80001, 48.499996, 40.20001);
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(14.6, 92.1);
((GeneralPath)shape).lineTo(14.6, 76.3);
((GeneralPath)shape).lineTo(25.5, 76.3);
((GeneralPath)shape).lineTo(25.5, 79.0);
((GeneralPath)shape).lineTo(17.8, 79.0);
((GeneralPath)shape).lineTo(17.8, 82.7);
((GeneralPath)shape).lineTo(24.4, 82.7);
((GeneralPath)shape).lineTo(24.4, 85.399994);
((GeneralPath)shape).lineTo(17.8, 85.399994);
((GeneralPath)shape).lineTo(17.8, 92.09999);
((GeneralPath)shape).lineTo(14.599999, 92.09999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(27.5, 84.299995);
((GeneralPath)shape).curveTo(27.5, 82.7, 27.7, 81.299995, 28.2, 80.299995);
((GeneralPath)shape).curveTo(28.6, 79.49999, 29.1, 78.799995, 29.7, 78.1);
((GeneralPath)shape).curveTo(30.300001, 77.5, 31.0, 77.0, 31.7, 76.7);
((GeneralPath)shape).curveTo(32.7, 76.299995, 33.8, 76.1, 35.100002, 76.1);
((GeneralPath)shape).curveTo(37.4, 76.1, 39.300003, 76.799995, 40.7, 78.299995);
((GeneralPath)shape).curveTo(42.1, 79.799995, 42.8, 81.7, 42.8, 84.299995);
((GeneralPath)shape).curveTo(42.8, 86.799995, 42.1, 88.799995, 40.7, 90.299995);
((GeneralPath)shape).curveTo(39.3, 91.7, 37.5, 92.49999, 35.100002, 92.49999);
((GeneralPath)shape).curveTo(32.7, 92.49999, 30.900002, 91.799995, 29.500002, 90.399994);
((GeneralPath)shape).curveTo(28.200003, 88.799995, 27.500002, 86.799995, 27.500002, 84.299995);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(30.8, 84.2);
((GeneralPath)shape).curveTo(30.8, 86.0, 31.199999, 87.299995, 32.0, 88.299995);
((GeneralPath)shape).curveTo(32.8, 89.2, 33.9, 89.7, 35.2, 89.7);
((GeneralPath)shape).curveTo(36.5, 89.7, 37.5, 89.2, 38.3, 88.299995);
((GeneralPath)shape).curveTo(39.1, 87.399994, 39.5, 85.99999, 39.5, 84.2);
((GeneralPath)shape).curveTo(39.5, 82.399994, 39.1, 81.0, 38.3, 80.2);
((GeneralPath)shape).curveTo(37.5, 79.399994, 36.399998, 78.899994, 35.1, 78.899994);
((GeneralPath)shape).curveTo(33.8, 78.899994, 32.699997, 79.299995, 31.899998, 80.2);
((GeneralPath)shape).curveTo(31.199997, 81.0, 30.799997, 82.399994, 30.799997, 84.2);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(45.4, 92.1);
((GeneralPath)shape).lineTo(45.4, 76.3);
((GeneralPath)shape).lineTo(48.5, 76.3);
((GeneralPath)shape).lineTo(55.0, 86.8);
((GeneralPath)shape).lineTo(55.0, 76.3);
((GeneralPath)shape).lineTo(58.0, 76.3);
((GeneralPath)shape).lineTo(58.0, 92.0);
((GeneralPath)shape).lineTo(54.8, 92.0);
((GeneralPath)shape).lineTo(48.399998, 81.7);
((GeneralPath)shape).lineTo(48.399998, 92.0);
((GeneralPath)shape).lineTo(45.399998, 92.1);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_fon());
    }
}
