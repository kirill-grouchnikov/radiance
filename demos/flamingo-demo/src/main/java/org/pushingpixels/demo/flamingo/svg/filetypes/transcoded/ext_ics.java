 ...
 */
public class ext_ics implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(35.1, 82.799995);
...
((GeneralPath)shape).curveTo(34.199997, 85.3, 34.8, 84.2, 35.1, 82.8);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(42.500015, 87.39999, 41.800014, 85.79999, 41.500015, 83.59998);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_ics());
    }
}
