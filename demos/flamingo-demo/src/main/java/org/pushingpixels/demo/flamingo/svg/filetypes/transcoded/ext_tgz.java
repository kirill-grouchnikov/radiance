 ...
 */
public class ext_tgz implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(14.700001, 92.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(36.4, 84.899994);
((GeneralPath)shape).lineTo(36.4, 81.49999);
((GeneralPath)shape).lineTo(45.100002, 81.49999);
((GeneralPath)shape).lineTo(45.100002, 89.399994);
((GeneralPath)shape).curveTo(44.300003, 90.2, 43.000004, 90.899994, 41.4, 91.59999);
((GeneralPath)shape).curveTo(39.800003, 92.19999, 38.2, 92.49999, 36.5, 92.49999);
((GeneralPath)shape).curveTo(34.4, 92.49999, 32.6, 92.09999, 31.1, 91.19999);
((GeneralPath)shape).curveTo(29.600002, 90.29999, 28.4, 89.09999, 27.6, 87.49999);
((GeneralPath)shape).curveTo(26.800001, 85.899994, 26.4, 84.09999, 26.4, 82.19999);
((GeneralPath)shape).curveTo(26.4, 80.09999, 26.8, 78.29999, 27.699999, 76.69999);
((GeneralPath)shape).curveTo(28.599998, 75.09999, 29.8, 73.89999, 31.499998, 72.99999);
((GeneralPath)shape).curveTo(32.8, 72.299995, 34.399998, 71.99999, 36.3, 71.99999);
((GeneralPath)shape).curveTo(38.8, 71.99999, 40.7, 72.49999, 42.1, 73.59999);
((GeneralPath)shape).curveTo(43.5, 74.59999, 44.399998, 76.09999, 44.8, 77.899994);
((GeneralPath)shape).lineTo(40.8, 78.59999);
((GeneralPath)shape).curveTo(40.5, 77.59999, 40.0, 76.899994, 39.2, 76.29999);
((GeneralPath)shape).curveTo(38.4, 75.69999, 37.5, 75.499985, 36.3, 75.499985);
((GeneralPath)shape).curveTo(34.5, 75.499985, 33.1, 76.09998, 32.1, 77.19998);
((GeneralPath)shape).curveTo(31.099998, 78.29998, 30.499998, 79.999985, 30.499998, 82.19998);
((GeneralPath)shape).curveTo(30.499998, 84.59998, 30.999998, 86.29998, 32.1, 87.499985);
((GeneralPath)shape).curveTo(33.1, 88.69998, 34.5, 89.29999, 36.199997, 89.29999);
((GeneralPath)shape).curveTo(36.999996, 89.29999, 37.899998, 89.09999, 38.699997, 88.79999);
((GeneralPath)shape).curveTo(39.499996, 88.499985, 40.299995, 88.09999, 40.899998, 87.59999);
((GeneralPath)shape).lineTo(40.899998, 85.09999);
((GeneralPath)shape).lineTo(36.399998, 85.09999);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(47.100002, 92.2);
((GeneralPath)shape).lineTo(47.100002, 88.6);
((GeneralPath)shape).lineTo(57.600002, 75.7);
((GeneralPath)shape).lineTo(48.300003, 75.7);
((GeneralPath)shape).lineTo(48.300003, 72.299995);
((GeneralPath)shape).lineTo(62.9, 72.299995);
((GeneralPath)shape).lineTo(62.9, 75.399994);
((GeneralPath)shape).lineTo(51.9, 88.799995);
((GeneralPath)shape).lineTo(63.2, 88.799995);
((GeneralPath)shape).lineTo(63.2, 92.2);
((GeneralPath)shape).lineTo(47.1, 92.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_tgz());
    }
}
