 ...
 */
public class ext_mp3 implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(32.800003, 91.20001);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(36.800003, 74.59999);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_mp3());
    }
}
