 ...
 */
public class ext_asx implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(20.1, 83.299995);
((GeneralPath)shape).lineTo(17.300001, 75.899994);
((GeneralPath)shape).lineTo(14.600001, 83.299995);
((GeneralPath)shape).lineTo(20.100002, 83.299995);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).curveTo(29.500011, 88.499985, 29.000011, 86.89999, 28.70001, 84.69998);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).lineTo(58.3, 81.0);
((GeneralPath)shape).lineTo(65.2, 91.2);
((GeneralPath)shape).lineTo(60.299995, 91.2);
((GeneralPath)shape).lineTo(55.799995, 84.299995);
((GeneralPath)shape).lineTo(51.299995, 91.2);
((GeneralPath)shape).lineTo(46.499996, 91.2);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_asx());
    }
}
