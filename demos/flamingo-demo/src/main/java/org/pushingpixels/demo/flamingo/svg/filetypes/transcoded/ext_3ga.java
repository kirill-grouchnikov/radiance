 ...
 */
public class ext_3ga implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(9.899999, 88.9, 9.199999, 87.6, 8.999999, 85.9);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(65.6, 91.200005);
((GeneralPath)shape).lineTo(61.199997, 91.200005);
((GeneralPath)shape).lineTo(59.399998, 86.700005);
((GeneralPath)shape).lineTo(51.399998, 86.700005);
((GeneralPath)shape).lineTo(49.699997, 91.200005);
((GeneralPath)shape).lineTo(45.399998, 91.200005);
((GeneralPath)shape).lineTo(53.199997, 71.3);
((GeneralPath)shape).lineTo(57.499996, 71.3);
((GeneralPath)shape).lineTo(65.6, 91.200005);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_3ga());
    }
}
