 ...
 */
public class ext_lex implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(16.5, 91.6);
((GeneralPath)shape).lineTo(16.5, 76.1);
((GeneralPath)shape).lineTo(19.7, 76.1);
((GeneralPath)shape).lineTo(19.7, 89.0);
((GeneralPath)shape).lineTo(27.6, 89.0);
((GeneralPath)shape).lineTo(27.6, 91.6);
((GeneralPath)shape).lineTo(16.5, 91.6);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(29.9, 91.6);
((GeneralPath)shape).lineTo(29.9, 76.0);
((GeneralPath)shape).lineTo(41.6, 76.0);
((GeneralPath)shape).lineTo(41.6, 78.6);
((GeneralPath)shape).lineTo(33.1, 78.6);
((GeneralPath)shape).lineTo(33.1, 82.1);
((GeneralPath)shape).lineTo(41.0, 82.1);
((GeneralPath)shape).lineTo(41.0, 84.7);
((GeneralPath)shape).lineTo(33.1, 84.7);
((GeneralPath)shape).lineTo(33.1, 89.0);
((GeneralPath)shape).lineTo(41.899998, 89.0);
((GeneralPath)shape).lineTo(41.899998, 91.6);
((GeneralPath)shape).lineTo(29.899998, 91.6);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(43.0, 91.6);
((GeneralPath)shape).lineTo(48.4, 83.5);
((GeneralPath)shape).lineTo(43.5, 76.0);
((GeneralPath)shape).lineTo(47.2, 76.0);
((GeneralPath)shape).lineTo(50.4, 81.0);
((GeneralPath)shape).lineTo(53.5, 76.0);
((GeneralPath)shape).lineTo(57.2, 76.0);
((GeneralPath)shape).lineTo(52.3, 83.6);
((GeneralPath)shape).lineTo(57.7, 91.6);
((GeneralPath)shape).lineTo(53.9, 91.6);
((GeneralPath)shape).lineTo(50.4, 86.2);
((GeneralPath)shape).lineTo(46.9, 91.6);
((GeneralPath)shape).lineTo(43.0, 91.6);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_lex());
    }
}
