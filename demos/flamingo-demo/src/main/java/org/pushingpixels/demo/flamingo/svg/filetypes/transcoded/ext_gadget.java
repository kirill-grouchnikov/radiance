 ...
 */
public class ext_gadget implements ResizableIcon, IsHiDpiAware {
...
shape = new GeneralPath();
((GeneralPath)shape).moveTo(57.2, 1069.1);
((GeneralPath)shape).lineTo(37.9, 1071.7);
((GeneralPath)shape).lineTo(37.9, 1087.0);
((GeneralPath)shape).lineTo(57.2, 1087.0);
((GeneralPath)shape).lineTo(57.2, 1069.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(34.4, 1072.1);
((GeneralPath)shape).lineTo(15.100002, 1074.7);
((GeneralPath)shape).lineTo(15.100002, 1087.0);
((GeneralPath)shape).lineTo(34.4, 1087.0);
((GeneralPath)shape).lineTo(34.4, 1072.1);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(15.200001, 1090.5);
((GeneralPath)shape).lineTo(15.200001, 1102.8);
((GeneralPath)shape).lineTo(34.5, 1105.4);
((GeneralPath)shape).lineTo(34.5, 1090.6);
((GeneralPath)shape).lineTo(15.200001, 1090.5);
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(37.9, 1090.5);
((GeneralPath)shape).lineTo(37.9, 1105.8);
((GeneralPath)shape).lineTo(57.2, 1108.4);
((GeneralPath)shape).lineTo(57.2, 1090.5);
((GeneralPath)shape).lineTo(37.9, 1090.5);
((GeneralPath)shape).closePath();
g.setPaint(paint);
g.fill(shape);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_gadget());
    }
}
