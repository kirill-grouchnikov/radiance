 ...
 */
public class ext_ra implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).curveTo(32.800003, 81.5, 31.5, 82.1, 29.7, 82.3);
...
((GeneralPath)shape).lineTo(18.600002, 91.2);
((GeneralPath)shape).closePath();
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_ra());
    }
}
