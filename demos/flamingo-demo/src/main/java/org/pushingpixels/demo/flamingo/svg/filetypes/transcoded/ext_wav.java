 ...
 */
public class ext_wav implements ResizableIcon, IsHiDpiAware {
...
((GeneralPath)shape).lineTo(10.300001, 91.2);
((GeneralPath)shape).closePath();
...
((GeneralPath)shape).closePath();
((GeneralPath)shape).moveTo(55.7, 91.200005);
((GeneralPath)shape).lineTo(48.5, 71.3);
((GeneralPath)shape).lineTo(52.9, 71.3);
...
g.setTransform(defaultTransform_);
    ...
    public static ResizableIconFactory factory() {
        return () -> new NeonIcon(new ext_wav());
    }
}
