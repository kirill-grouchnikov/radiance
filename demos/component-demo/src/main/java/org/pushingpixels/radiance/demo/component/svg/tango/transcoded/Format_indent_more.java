 ...
 */
public class Format_indent_more implements RadianceIcon {
...
paint = new LinearGradientPaint(new Point2D.Double(20.794008255004883, 18.378812789916992), new Point2D.Double(35.59600067138672, 39.600460052490234), new float[] {0.0f,0.59928656f,1.0f}, new Color[] {((colorFilter != null) ? colorFilter.filter(new Color(248, 248, 247, 255)) : new Color(248, 248, 247, 255)),((colorFilter != null) ? colorFilter.filter(new Color(232, 232, 232, 255)) : new Color(232, 232, 232, 255)),((colorFilter != null) ? colorFilter.filter(new Color(226, 226, 222, 255)) : new Color(226, 226, 222, 255))}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.3427040576934814f, 0.0f, 0.0f, 1.2353780269622803f, -8.219611167907715f, -6.577188968658447f));
g.setPaint(paint);
g.fill(shape);
...
generalPath.moveTo(9.0f, 26.743532f);
generalPath.lineTo(9.0f, 38.610554f);
generalPath.lineTo(22.112421f, 38.610554f);
generalPath.lineTo(22.112421f, 44.458668f);
generalPath.lineTo(35.851425f, 32.65186f);
generalPath.lineTo(22.109863f, 21.0f);
generalPath.lineTo(22.109863f, 26.747164f);
generalPath.lineTo(9.0f, 26.743532f);
generalPath.closePath();
shape = generalPath;
paint = new LinearGradientPaint(new Point2D.Double(10.729690551757812, 26.422195434570312), new Point2D.Double(2.394106388092041, 26.422195434570312), new float[] {0.0f,1.0f}, new Color[] {((colorFilter != null) ? colorFilter.filter(new Color(85, 87, 83, 255)) : new Color(85, 87, 83, 255)),((colorFilter != null) ? colorFilter.filter(new Color(85, 87, 83, 0)) : new Color(85, 87, 83, 0))}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.187999963760376f, 0.0f, 0.0f, 1.187999963760376f, 6.6486592292785645f, 4.174915790557861f));
g.setPaint(paint);
g.fill(shape);
g.setTransform(transformsStack.pop());
g.setTransform(transformsStack.pop());
...
g.setTransform(transformsStack.pop());
    ...
    public static RadianceIcon of(int width, int height) {
       Format_indent_more base = new Format_indent_more();
       base.width = width;
       base.height = height;
       return base;
    }
