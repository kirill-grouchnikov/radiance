 ...
 */
public class Network_wireless implements RadianceIcon {
...
// _0_0_4
paint = new RadialGradientPaint(new Point2D.Double(27.577173233032227, 16.04913330078125), 3.8335035f, new Point2D.Double(27.577173233032227, 16.04913330078125), new float[] {0.0f,1.0f}, new Color[] {((colorFilter != null) ? colorFilter.filter(new Color(239, 41, 41, 255)) : new Color(239, 41, 41, 255)),((colorFilter != null) ? colorFilter.filter(new Color(239, 41, 41, 0)) : new Color(239, 41, 41, 0))}, MultipleGradientPaint.CycleMethod.NO_CYCLE, MultipleGradientPaint.ColorSpaceType.SRGB, new AffineTransform(1.243453025817871f, 2.1067840215472386E-16f, -2.1067840215472386E-16f, 1.243453025817871f, -6.713754177093506f, -3.742846965789795f));
