 ...
 */
public class add_circle_outline_24px implements RadianceIcon {
...
g.fill(shape);
	 ...
	 */
	private add_circle_outline_24px() {
    ...
    public static RadianceIcon of(int width, int height) {
       add_circle_outline_24px base = new add_circle_outline_24px();
       base.width = width;
       base.height = height;
       return base;
    }
    ...
    public static Factory factory() {
        return add_circle_outline_24px::new;
    }
}
